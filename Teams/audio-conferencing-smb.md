...
There are two types of numbers that you can use for your conferencing bridge. You can use **shared numbers** (discussed in the next section of this article) or **dedicated numbers**. Here's more information about each.
