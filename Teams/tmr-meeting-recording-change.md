...
> [!Note]
> The change of storing Teams meeting recordings from Microsoft Stream to OneDrive and SharePoint (ODSP) has been completed as of August 30th, 2020. All recordings are now stored in ODSP. This change overrides the RecordingStorageMode policy, and modifying the setting in PowerShell no longer has any impact.
