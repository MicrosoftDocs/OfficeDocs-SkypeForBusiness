...
|Rolling out starting July 7, 2021<br> *(Complete)*  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|**All customers (Enterprise, Education, and GCC)**<br> For a Teams meeting recording, a copy of the live transcript will be stored as metadata of the recorded file on Stream on Sharepoint and OneDrive and the transcript for the recording will be searchable in M365 search and via eDiscovery. |
