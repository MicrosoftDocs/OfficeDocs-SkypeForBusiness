...
description: Learn how to manage Teams apps like, org-level status, properties of apps, block or allow apps, upload new custom apps, and manage app settings.
appliesto: 
- Microsoft Teams
