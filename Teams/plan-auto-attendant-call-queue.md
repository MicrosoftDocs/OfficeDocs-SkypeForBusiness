...
Conference mode is enabled by default.  If you have agents who don't meet the requirements then confernce mode must be manually disabled during call queue configuration.
