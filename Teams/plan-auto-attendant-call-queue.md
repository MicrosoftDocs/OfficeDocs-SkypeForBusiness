...
- Calling Plan license, assign a [Calling Plan](calling-plans-for-office-365.md) license, or
- Direct Routing voice route, assign an [online voice routing policy](manage-voice-routing-policies.md).
