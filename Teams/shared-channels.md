...
|Members in a shared channel|5,000 direct members, including up to 50 teams. (Each team counts as one member for this limit.)|Real time updates are only available to 25,000 users at a time and only 25,000 users will appear in the channel list.|
