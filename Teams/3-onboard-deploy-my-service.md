...
**[!NOTE]** This article and the associated playbook aren’t intended to describe
...
![A screenshot of the playbook](media/ac4b8ae4bfddc00b0d2ea37b724ca346.png)
...
1.  Review each activity, take necessary actions, and update the status as you
    walk through the timeline. Status is represented graphically, as described
    below:

![](media/b029a6d29f2fd656b614621e6f102fb5.png)

![](media/668cf78bb38974c4348a76b525c90cea.png)

>   **Yes, or not applicable (green):** The activity has been completed, or it’s
>   not applicable for this site, and no further action is needed.

>   **The activity isn’t completed yet (yellow):** The activity hasn’t been
>   completed yet, and must be

![](media/be436ab1299215beaf930804de336b6d.png)

>   updated to Yes or No on its schedule.

>   **No (red):** The activity can’t be completed because of an issue and must
>   be carried to the project status meeting.

1.  The status is rolled up within each section, and the section heading is
    formatted with one of these status indicators. **Weekly status** is also
    updated automatically.

![Screenshot of the weekly status roll-ups in the playbook.](media/19bd40eaab03efaafd86b20f4aa2e5fa.png)

[!TIP] Repeat the steps above for all the locations you have.

[!IMPORTANT] Some steps might not be applicable to all locations and sites. If a
...
[!IMPORTANT] Pay attention to activities that might take more time than you
...
| [./media/image7.jpg](./media/image7.jpg) | Decision points | Decide if the Site Enablement Playbook is required for your deployment. |
|------------------------------------------|-----------------|-------------------------------------------------------------------------|


-   Decide who will be responsible for customizing the Site Enablement Playbook
    for Microsoft Teams for every site you will deploy.

| [./media/image8.jpg](./media/image8.jpg) | Next steps | Download the Site Enablement Playbook. |   |
|------------------------------------------|------------|----------------------------------------|---|


-   Customize the Site Enablement Playbook for your first site.
