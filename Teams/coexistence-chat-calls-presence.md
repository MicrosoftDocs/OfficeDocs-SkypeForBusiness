...
| <br/><br/> Mode | Originator <br/><br/> Client | <br/><br/> SfB&nbsp;homed |Route-->| Recipient <br/><br/> Islands  |
|--- |--- |--- |--- |--- |
...
| <br/><br/> Mode   | Originator <br/><br/> Client | <br/><br/> SfB&nbsp;homed |Route--> |   Recipient <br/><br/> SfB\*   |
|--- |--- |--- |---   |--- |
...
| <br/><br/> Mode   | Originator <br/><br/> Client | <br/><br/> SfB&nbsp;homed |Route-->|   Recipient <br/><br/> TeamsOnly  |
|--- |--- |--- |--- | --- |
...
|Watcher <br/><br/>Client|Route--> |<br/><br/>Islands |Publisher <br/><br/>SfB\* |<br/>Teams Only|
|--- |--- |--- |--- |---|
...
|Watcher <br/><br/> Client |Route-->|<br/><br/> Islands  |Publisher <br/><br/> SfB\* |<br/><br/> Teams Only |
|--- |--- |--- |--- |---|
|Skype for Business |&boxv; |Skype for Business  | Skype for Business  | Teams  |
