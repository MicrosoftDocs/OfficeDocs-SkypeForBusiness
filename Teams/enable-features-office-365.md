...
ms.topic: article
ms.service: msteams
description: Learn all the Microsoft Teams features you can turn on in your Office 365 organization, including tenant-wide settings, email integration, apps, cloud storage, and more.
