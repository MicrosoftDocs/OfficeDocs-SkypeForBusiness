...
When you do see opportunities to enhance your service, take the time to do it right. Revisit our implementation phases (https://docs.microsoft.com/MicrosoftTeams/quick-start-enable-teams) and apply the same guidance end to end. When making small, incremental changes, it’s unlikely that you’ll need to complete all activities and tasks in full, but you should be sure to evaluate each activity and task along the way to give yourself the best chance at a successful outcome.
