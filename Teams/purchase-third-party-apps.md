...
2. Search for the app that you want. Look in the **Licenses** column to identify apps that have a paid SaaS subscription. Each app will have one of the following values: 
...
5. Select the plan that you want. By default, the plan that's displayed on this page is the first plan that's listed in on the **Plans and pricing** tab. If the app offers more than one plan, click **Change** to see the list of available plans.
...
## Have an app that you want to sell on AppSource?
