...
6. Click **Save**.
    > [!NOTE]
    > Because of the latency between Office 365 and Teams, it can possibly take a couple of hours for users to be enabled. If the phone number isn't assigned correctly after a couple of hours, [contact support for business products - Admin Help](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products). We're here to help!
