...
5. If you want to send an email to the user with their phone number information, turn on **Email user with telephone number information**. By default, this is on. 
6. Click **Save**.
    > [!NOTE]
