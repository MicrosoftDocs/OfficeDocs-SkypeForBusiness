...
To see which region houses data for your tenant, go to the [Microsoft 365 admin center](https://portal.office.com/adminportal/home) > **Settings** > **Settings** > **Organization profile**. Scroll down to **Data location**. 

For example, if your data is located in North America, you will see:
