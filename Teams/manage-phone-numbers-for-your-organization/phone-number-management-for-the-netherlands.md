...
|Get phone numbers transferred to us.  <br/> |Download one of these forms: <br/> [Letter of Authorization (LOA) for the Netherlands (all numbers) (v.5.0) (nl-nl)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/loa-forms/letter-of-authorization-(loa)-for-the-netherlands-(all-numbers)-(v.5.0)-(nl-nl).pdf?raw=true) <br/> <br/>  Fill it out and [send it to us](mailto:ptneu@microsoft.com).  <br/> |
