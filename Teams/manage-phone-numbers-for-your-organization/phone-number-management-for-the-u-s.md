...
|Change a user's number to a service number or a service number to a user's number  <br/> |[Send us](mailto:ptn@microsoft.com) your PIN and the list of numbers you want to convert. To set up a PIN, go [here](/skypeforbusiness/what-are-calling-plans-in-office-365/set-your-pin-for-transferring-numbers-to-a-new-service-provider).  <br/> |
