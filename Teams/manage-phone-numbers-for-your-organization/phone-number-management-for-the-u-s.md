...
|:-----|:-----|
|Get new user or service phone numbers that aren't listed in the Microsoft Teams admin center.  <br/> |Download this form.<br/>  [New phone number request for the U.S. (v.5.0) (en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-the-u.s.-(v.5.0)-(en-us).pdf?raw=true) <br/><br/> Fill it out and [send it to us](mailto:gcstnmsd@microsoft.com). |
