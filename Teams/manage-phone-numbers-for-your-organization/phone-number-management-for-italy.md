...
|Get phone numbers transferred to us.  <br/> | Download this form. <br/>[Letter of Authorization (LOA) for Italy (resellers) (v.5.0) (it-it)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-italy-(resellers)-(v.5.0)-(it-it).pdf?raw=true) <br/> <br/>Fill it out and [send it to us](mailto:ptneu@microsoft.com). |
