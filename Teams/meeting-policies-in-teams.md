...
|**Invited users only**    |Only the participants invited by the organizer in the meeting invite join the meeting directly without waiting in the lobby. Everyone else must wait in the lobby. On the Teams client meeting options page, it appears as "People I invite".         |
