...
Meeting participants who don't have any policies assigned (for example, anonymous participants) have the **Outgoing and incoming audio enabled** setting by default.
