...
This is a per-user policy. Breakout rooms are used to split the main meeting into separate, smaller meeting rooms. This setting controls whether meeting organizers have the option to create breakout rooms in meetings they schedule or start, assign attendees to rooms, and remove attendees from rooms. This policy setting affects all meetings, including Meet Now meetings.
