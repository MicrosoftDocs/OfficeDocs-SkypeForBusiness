...
As an admin, you can set a per-user policy to control which users can create private channels.  
...
By default, all Teams users in your organization can create private channels. For example, you might want to allow only certain users the ability to create private channels and turn off the ability for all other users in your organization.
