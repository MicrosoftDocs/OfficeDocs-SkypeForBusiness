...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="https://docs.microsoft.com/teams/room-systems/skype-room-systems-v2-0">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="https://docs.microsoft.com/teams/room-systems/room-systems-v2">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="https://docs.microsoft.com/teams/room-systems/skype-room-systems-v2">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
