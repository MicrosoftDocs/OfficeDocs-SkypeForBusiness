...
You can deploy Microsoft Teams Rooms with Microsoft Teams, Skype for Business Online, or Skype for Business hybrid or on-premises deployments.  See [Microsoft Teams Rooms Licensing](https://docs.microsoft.com/en-us/microsoftteams/room-systems/skype-room-systems-v2) for information on the needed licenses.
