...
- **Deleted Teams:** Export API supports [capturing messages from deleted Teams and deleted Private Channels](/graph/api/deletedteam-getallmessages?view=graph-rest-1.0&tabs=http) for more information.
