...
|:::image type="content" source="media/export-API-teams/proofpoint-logo-blacktype-final-5A2.png" border="false" alt-text="Proofpoint Content Capture for Microsoft Teams":::|[Proofpoint Content Capture for Microsoft Teams](https://www.proofpoint.com/resources/data-sheets/proofpoint-content-capture-microsoft-teams)|
