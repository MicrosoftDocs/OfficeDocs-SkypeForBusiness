...
- Check that the user has a Teams Upgrade policy which enables scheduling meetings in Teams. See [Upgrade from Skype for Business to Teams](upgrade-to-Teams-on-prem-tools.md) for more details.
