---
title:  Deploy for the new Microsoft Teams desktop client
ms.author: jhendr
...
f1.keywords:
- NOCSH
description: Learn how to deploy  the new Microsoft Teams desktop client. 
appliesto: 
- Microsoft Teams
ms.localizationpriority: high
---

# Rollout the new Teams client
