...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="https://docs.microsoft.com/microsoftteams/healthcare/healthcare-templates">
        <div class="cardSize">
    ...
    <li>
        <a href="https://docs.microsoft.com/MicrosoftTeams/healthcare/messaging-policies-hc">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
