...
Emails will be automatically sent to users who are [enabled for Audio Conferencing](SkypeForBusiness/audio-conferencing-in-office-365/set-up-audio-conferencing.md) using Microsoft as the audio conferencing provider.
