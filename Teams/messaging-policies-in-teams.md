...
- **Users can send priority notifications** <a name="urgent-message"></a>If you turn this on, users can send a message that uses [priority notifications](https://support.office.com/article/mark-a-message-as-important-or-urgent-in-teams-ea99d5b6-1317-4550-8d75-86ff14cd4462). Priority notifications notify users every 2 minutes for a period of 20 minutes or until messages are picked up and read by the recipient, maximizing the likelihood that the message is picked up and acted upon in a timely manner. This feature is available with [[Premium Messaging add-on licensing]](teams-add-on-licensing/pri-message.md).
