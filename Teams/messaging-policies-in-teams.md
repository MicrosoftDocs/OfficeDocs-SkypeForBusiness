...
- **Chat** Turn this setting on if you want users in your organization to be able to use the Teams app to chat with other people. When this setting is off, chat is disabled for new one-on-one and group chats. The user can still message in existing one-on-one and group chats.
