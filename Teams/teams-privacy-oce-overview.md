...
The Teams app link previews service generates a preview snippet of the app's adaptive card and attaches it under URL when a user sends a URL string that maps to an app in the Teams Store. This service will make a request to the service URL as the user is typing the message.
