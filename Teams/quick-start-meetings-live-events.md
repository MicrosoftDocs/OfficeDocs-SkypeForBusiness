...
> [!NOTE]
> For additional information and to get guidance by role for delivering online events using Microsoft Teams, see the [Virtual Event Playbook](https://adoption.microsoft.com/virtual-event-guidance/). You can also join the [Virtual Event Community](https://aka.ms/VirtualEventCommunity) on the Microsoft Tech Community.
