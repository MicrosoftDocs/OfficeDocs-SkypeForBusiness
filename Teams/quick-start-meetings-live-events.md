...
<sup>1</sup>  Meeting organizers need to have an Audio Conferencing license to send an invite that includes dial-in conferencing.
...
To learn more about licensing, read [Office 365 licensing for Teams](Office-365-licensing.md). For details about Audio Conferencing licenses, read [Teams add-on licensing](teams-add-on-licensing/microsoft-teams-add-on-licensing.md). To decide whether you need a dial plan, read [What are dial plans?](what-are-dial-plans.md)
