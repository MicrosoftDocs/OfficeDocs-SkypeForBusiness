...
|The setting "When you're in a call and receive another call" in the call settings is available for all possible options for the setting "When you receive a call"|The setting "When you're in a call and receive another call" is no longer available for the selected options "Also ring a call group" or "Also ring a new number or contact". Teams will automatically forward a second call to the voicemail when you're busy.|
