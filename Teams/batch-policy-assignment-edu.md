...
> [!IMPORTANT]
> We recommend that you assign policies in batches of 5,000 users at a time. During these times of increased demand, you may experience delays in processing time. To minimize the impact of these increased processing times, we suggest that you submit smaller batches sizes of up to 5,000 users, and submit each batch after the previous one is completed. Submitting batches outside your regular business hours can also help.
