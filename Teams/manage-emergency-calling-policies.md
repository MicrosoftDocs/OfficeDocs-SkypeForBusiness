...
4. Set the **External location lookup mode** to on to allow your end-user to configure their emergency address, when they are working from a network location outside the corporate network.
...
5.  Set the **Emergency service disclaimer** to show a banner to remind your end-user to confirm their emergency location.
