...
* Once Adobe Acrobat is made the default PDF file handler, then a PDF file clicked inside Teams will open inside Teams. Users can't open PDF files in their desktop app using any setting. Users can download PDF files locally and open those in other apps.
