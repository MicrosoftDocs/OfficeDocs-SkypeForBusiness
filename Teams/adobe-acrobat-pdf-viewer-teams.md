...
* The PDF files pinned as tabs in channels and the PDF files available in the Assignments app continue to open in the default viewer of Teams and not in the Adobe Acrobat app.
