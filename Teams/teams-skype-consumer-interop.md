---
title: Teams and Skype Consumer interoperability
author: LanaChin
ms.author: v-lanac
manager: serdars
ms.topic: article
...
Microsoft Teams users can chat with Skype Consumer users and vice versa. Teams users can search and start a 1:1 conversation with a Skype Consumer user and Skype Consumer users can search and start a 1:1 chat with a Teams user. Conversations are text-only, with limited audio/video capabilities. 
...
- 1:1 chats
- Text-only messages
- Limited audio/video experience
- No presence 

Available for Teams desktop, web, and mobile (Android and iOS)
