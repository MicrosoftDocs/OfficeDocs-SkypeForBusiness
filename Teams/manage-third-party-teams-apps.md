...
Admins can control user access to Teams third party apps, check the following table to block app access specific users or all users based on the admin roles:
