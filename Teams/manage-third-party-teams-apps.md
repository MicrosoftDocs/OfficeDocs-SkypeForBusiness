...
description: Learn how to manage access to Teams apps for end-users such as, new app access for specific end-users, new app access for all end-users across Microsoft 365. 
---
