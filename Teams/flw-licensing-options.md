...
| ----- | ----- |
| Frontline workers need access to information on the go - they have the Office apps on phones or tablets. | Information workers write, edit, and share documents and have Office apps on desktops or laptops, as well as mobile apps on phones and tablets. |
...
| Frontline workers can find organization-wide resources, commmunications, or training with SharePoint, OneDrive, Yammer, and Stream. | Information workers create or consume team or organization-wide resources and communications with included Microsoft 365 services (depending on the specific license). |
