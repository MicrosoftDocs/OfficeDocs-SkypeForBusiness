...
This policy is off by default and allows your organizers to see who registered and attended the meetings and webinars they set up. To turn this on in the Teams admin center, go to **Meetings** > **Meeting policies** > **Global (Org-wide default)**, and set the **Engagement report** setting to **Enabled**.
