...
|Firstline manager (in preview) |This policy package is designed to create a set of policies and apply those settings to first line managers (FLM) in your organization. |
|Firstline worker  (in preview) |This policy package is designed to create a set of policies and apply those settings to first line workers (FLW) in your organization. |
