...
|Reverse Number Lookup | Available in September 2019, Phone System will show called ID for an external phone number, if this number is associated with a user in AAD. If the phone number is not in AAD, then telco provided display name will be shown if available.  
