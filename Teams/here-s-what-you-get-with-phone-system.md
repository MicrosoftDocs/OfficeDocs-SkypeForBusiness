...
|Caller ID  <br/> |Calls from inside your company display a detailed caller ID that pulls information from your corporate directory, showing you a picture and job title instead of just a phone number. In an incoming call from an external phone number, Caller ID as provided by phone service provider is also displayed.   <br/> |
