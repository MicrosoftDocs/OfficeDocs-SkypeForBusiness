...
Teams is tightly integrated into Microsoft 365 and uses many features for collaboration, group chat, private chat, file sharing and live editing, conduct meetings and live events with video capability, integrate telephony to a PSTN, access to hundreds of app integrations, and more. Before you roll out Teams, check out [Microsoft Teams IT architecture and telephony solutions posters](teams-architecture-solutions-posters.md) to get familiar with how Teams works with the rest of Microsoft 365 to create a complete collaboration experience for your users.
...
Network planning for Teams is extremely important when you have any number of users and for all types of networks.  It's essential to ensure your network for 8 users or 8,000 users is capable of delivering the best experience with Teams.  Your existing network infrastructure and provider bandwidth could make a big impact on Teams for your users.  Teams supports voice calling and video conferencing, both of which rely on real-time communications to provide the best experience possible for users. Networks must:
...
- How long will the Team remain active?
...
Creating policies and guidelines as part of your initial deployment will help ensure your users can find the information they need. Just as important, appropriate policies will help protect your organization from information leakage, help you conform to regulatory requirements, and help you retain information as needed for archival purposes.
...
To ensure that your organization and your users get the most out of Teams, you will need an adoption program. An effective adoption program can mobilize early adopters who can:
