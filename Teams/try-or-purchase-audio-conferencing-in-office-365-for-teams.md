...
If you have users enabled with a 3rd party audio conferencing provider, you must change the provider of those users to Microsoft. To change the provider for a user, see [Assign Microsoft as the audio conferencing provider](../Skype/SfbOnline/audio-conferencing-in-office-365/assign-microsoft-as-the-audio-conferencing-provider.md).
