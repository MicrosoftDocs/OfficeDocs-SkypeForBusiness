...
|Tab |Description  |
|---------|---------|
|**[Virtual Visits](#virtual-visits)**     |Shows the total number of Virtual Visits, with a breakdown of the number of Virtual Visits scheduled using the Bookings app and Teams EHR-integrated meetings conducted from your EHR system.         |
...
> [!NOTE]
> We’re working on a new Teams app for Virtual Visits reporting. With the Virtual Visits app, non-admin users such as business decision makers can view Virtual Visits reports directly from within Teams. If your organization would like to participate in private preview of the app, [reach out us](mailto:).
