...
|Tab |Description  |
|---------|---------|
|**[Virtual Visits](#virtual-visits)**     |Shows the total number of Virtual Visits, with a breakdown of the number of Virtual Visits scheduled using the Bookings app and Teams EHR-integrated meetings conducted fom your EHR system.         |
...
|**[EHR](#ehr)**     |Shows the number of Teams EHR-integrated Virtual Visits conducted from your EHR system..         |  
