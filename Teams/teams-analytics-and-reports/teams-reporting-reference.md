...
|[Teams Virtual Visits usage report](virtual-visits-usage-report.md)  | Number of Virtual Visits<br>Number of Bookings visits<br>Number of Electronic Health Records (EHR) visits<br>Average duration of a visit<br>Average lobby wait time of attendees<br>Start time<br>Meeting ID<br>Lobby wait time<br>Duration<br>Status<br>Product type<br>Attendees<br>SMS sent
