...
|[Teams virtual visits usage report](virtual-visits-usage-report.md)  | Start time<br>Meeting ID<br>Lobby wait time</br>Duration<br>Status<br>Product type<br>Attendees<br>SMS sent
