...
|[Teams EHR connector Virtual Appointments report](../expand-teams-across-your-org/healthcare/ehr-admin-reports.md) | Start time<br>Duration<br>Primary (name of meeting organizer)<br>Primary's email (email of meeting organizer)<br>Department<br>Attendants<br>Lobby wait time<br>Whether the appointment is within the allocation limit
