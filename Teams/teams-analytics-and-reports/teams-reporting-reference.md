...
|[Walkie Talkie usage and performance report](/microsoft-365/frontline/walkie-talkie-usage-report?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fmicrosoftteams%2ftoc.json) |Yes|Yes|No|No| Whether the call timed out<br>Conversation ID<br>Participant list<br>Transmission start time<br>Transmission end time<br>Channel ID<br>Connection ID<br>Device ID<br>Tenant ID<br>User ID<br>Team ID<br>Audio duration<br>Notified participants<br>Packet count<br>Total participants<br>Transmission duration<br>Unreachable participants<br>Platform<br>Participant type<br>Web socket state<br>App version<br>Client call status|
|[Walkie Talkie usage and performance report](/microsoft-365/frontline/walkie-talkie-usage-report?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fmicrosoftteams%2ftoc.json) |Yes|Yes|No|No| Metrics include the number of push-to-talk (PTT) transmissions made and received, channel activity, transmission duration, device and participant details, and network quality|
