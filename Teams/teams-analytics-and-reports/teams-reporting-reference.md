...
|[Frontline usage report](/microsoft-365/frontline/frontline-usage-report?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fmicrosoftteams%2ftoc.json)|Yes|Yes|No|No| Total number of users on each team.<br>Number of active users on each team. <br>Last date on which the user signed in to Teams.|
