...
|[Walkie Talkie usage and performance report](/microsoft-365/frontline/walkie-talkie-usage-report?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fmicrosoftteams%2ftoc.json) |Yes|Yes|No|No| Tenant ID<br>User ID<br>Device ID<br>Channel ID<br>Conversation ID<br>Team ID<br>Unreachable participants<br>Transmission duration<br>Total participants<br>Packet count<br>Notified participants<br>Audio duration<br>Connection ID<br>Transmission start time<br>Transmission end time<br>Participant list<br>Whether the call timed out<br>Platform<br>Participant type<br>Web socket state<br>App version<br>Client call status|
|[Walkie Talkie usage and performance report](/microsoft-365/frontline/walkie-talkie-usage-report?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fmicrosoftteams%2ftoc.json) |Yes|Yes|No|No| Metrics include the number of push-to-talk (PTT) transmissions made and received, channel activity, transmission duration, and device and participant details.|
