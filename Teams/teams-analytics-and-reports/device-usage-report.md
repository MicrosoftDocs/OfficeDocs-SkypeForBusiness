...
|**3**   |The X axis on the chart represents the different devices (**Windows**, **Mac**, **iOS**, **Android Phone**) used to connect to Teams.<br>The Y axis is the number of users using the device over the selected time period.|
