...
Administrators manage their transition to Teams using the concept of [mode](migration-interop-guidance-for-teams-with-skype.md), which is a property of [TeamsUpgradePolicy](/powershell/module/teams/grant-csteamsupgradepolicy?view=skype-ps&preserve-view=true). A user that has been migrated to Teams as described above is in "TeamsOnly" mode. For an organization that is migrating to Teams, the ultimate goal is to move all users to TeamsOnly mode.
...
[Grant-CsTeamsUpgradePolicy](/powershell/module/teams/grant-csteamsupgradepolicy?view=skype-ps&preserve-view=true)
