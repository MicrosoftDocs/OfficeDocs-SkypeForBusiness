...
[//]: # (In the first sentence, I changed "single-client mode" to "Teams Only mode". Is that okay?)
...
[//]: # (Please change "SfB" to "Skype for Business" in the graphic.)
