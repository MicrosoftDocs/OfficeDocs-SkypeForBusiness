...
![A screenshot of upgrade building blocks from Skype for Business to Teams, consisting of Skype for Business with Teams collaboration only mode, Skype for Business with Teams collaboration and meetings mode, Islands mode, Teams-only and Skype for Business-only mode.](media/upgrade_and_coexistence_building_block.png)
