...
> [!IMPORTANT]
> If you're using the PowerShell steps in this article to manage private channels, you must install and use the Teams PowerShell public preview module from the [PowerShell Gallery](https://www.powershellgallery.com/packages/MicrosoftTeams/). For steps on how to install the module, see [Teams PowerShell Overview](teams-powershell-overview.md). The Generally Available version of the Teams PowerShell module doesn't support managing private channels.
