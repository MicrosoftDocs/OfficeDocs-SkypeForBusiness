...
> [!NOTE]
>1. The policy only restricts sign-ins. It does not restrict the ability for users to be invited as guest in other Azure AD tenants, or switch to those other tenants (where users have been invited as guest).
