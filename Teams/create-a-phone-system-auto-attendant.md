...
While you’re logged in as an administrator, navigate to the  Microsoft 365 admin center. In the navigation pane, select **Show all** > **Support** > **New service request**. After you have briefly described your issue (for example, “Teams auto attendant troubleshooting”), the system determines whether a diagnostic scenario matches your issue.
