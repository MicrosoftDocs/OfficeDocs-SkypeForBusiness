...
Note that for public teams, the "Everyone except external users" group is added to the SharePoint team site. The team isn't displayed in Teams for people who aren't members of that team. However, people who aren't members of the team can access content on the SharePoint team site using the URL of the SharePoint team site.
