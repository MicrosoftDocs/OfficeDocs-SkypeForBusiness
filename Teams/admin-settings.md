...
![Screen hot of the expanded Apps section in Tenant-wide settings.](media/teams-tenant-wide-settings-external-apps.png "Screen shot of the expanded Apps section in tenant-wide settings")
