...
:::image type="content" image source="media/direct-routing-1-sbc-requirements.png" alte-text=Diagram showing requirements to domains and Contact header." lightbox="media/direct-routing-1-sbc-requirements.png":::
