...
By default, a deleted Microsoft 365 group is retained for 30 days. This 30-day period is called a "soft-delete" because you can still restore the group. To learn more, see [Restore a deleted Microsoft 365 Group](/microsoft-365/admin/create-groups/restore-deleted-group?view=o365-worldwide&tabs=admin-center).
