...
You can use the Content Search eDiscovery tool in the Microsoft Purview portal to search for and export schedule and time clock data to Excel. For all other Shifts data, you can take screenshots of the data.
