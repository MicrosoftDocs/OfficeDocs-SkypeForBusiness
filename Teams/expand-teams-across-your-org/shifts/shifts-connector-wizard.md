...
1. Choose your sync settings:
    ...
    > [!IMPORTANT]
    > If you chose any of the following options to disable swap requests, time off requests, or open shifts, there's another step you need to do after you run the wizard to disable these capabilities. Make sure you follow the steps in the [Disable swap requests, time off requests, open shifts, and open shifts requests](#disable-swap-requests-time-off-requests-open-shifts-and-open-shifts-requests) section later in this article.
    >
