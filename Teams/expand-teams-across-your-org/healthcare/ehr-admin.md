...
- The FHIR base URL is a static address corresponding to your server FHIR API endpoint. An example URL is `lamnahealthcare.org/fihr/auth/connect-ocurprd-oauth/api/FHDST`.
