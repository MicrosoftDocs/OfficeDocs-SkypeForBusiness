...
- If you want to make changes to a form that's already linked to an appointment type, edit it from within the forms group at [https://forms.office.com](https://forms.office.com).
