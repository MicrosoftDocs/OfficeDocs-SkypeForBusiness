...
description: This article provides resources for planning and deploying Teams in Microsoft 365 Government environments.
layout: LandingPage
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Plan for Microsoft 365 Government - GCC deployments</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Plan for Microsoft 365 Government - GCC High</h3>
                    </div>
                </div>
            </div>
        </div>
