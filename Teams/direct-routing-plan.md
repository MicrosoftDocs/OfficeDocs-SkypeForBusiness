...
> [!NOTE]
> *Baltimore CyberTrust Root Certificate must be installed in the SBC Trusted Root Store of the Teams TLS context if Mutual TLS support is enabled for the Teams connection on the SBC. For more information, see Baltimore CyberTrust Root Certificate for Mutual TLS.
