...
The certificate needs to have the SBC FQDN as the common name (CN) in the subject field. The certificate should be issued from certification authority directly, not from an intermediate provider.
