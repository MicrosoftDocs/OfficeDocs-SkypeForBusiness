...
Reduce channel noise by having only team owners post to the General channel. Go to the team, locate the General channel, and click **˙˙˙ More options** > **Manage channel**. On the **Channel settings** tab, click **Permissions** and select **Only owners can post messages**.
