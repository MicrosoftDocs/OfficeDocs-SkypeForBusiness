...
1. Select apply.
   Learn more [Assign policies to your users in Microsoft Teams - Microsoft Teams \| Microsoft Docs](./assign-policies-users-and-groups.md#assign-a-policy-to-a-batch-of-users).
