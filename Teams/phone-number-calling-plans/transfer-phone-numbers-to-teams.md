...
> [!NOTE]
> Currently, you can use this wizard to get phone numbers for the United Kingdom and Canada. To get phone numbers for other countries and regions, you can [manually submit a port order](manually-submit-port-order.md). To get the form you need to manually request phone numbers, select your country or region in the drop-down list in [Manage phone numbers for your organization](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).
