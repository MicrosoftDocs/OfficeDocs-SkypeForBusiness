...
- If you are porting hybrid phone numbers (migrating from Direct Routing or Operator Connect to Calling Plans) please contact the TNS Service Desk, make sure you include a note stating those are hybrid phone numbers.
