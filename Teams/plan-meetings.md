...
Meetings in Teams include audio, video, and screen sharing capabilities for up to around 900 people and view-only capabilities for participants over 900.
...
You can allow or prevent the view-only experience for meetings with more than 900 attendees. If you disable the view-only experience, meeting attendance is limited to the first 900 attendees.
...
|[View-only](view-only-meeting-experience.md)|Allow organizers to host large meetings where after the meeting reaches capacity at around 900 users, additional attendees join with a view-only experience.|No control.|
