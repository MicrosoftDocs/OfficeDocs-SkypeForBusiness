...
- [List channels](https://docs.microsoft.com/en-us/graph/api/channel-list)
- [Create channel](https://docs.microsoft.com/en-us/graph/api/channel-post)
- [Add member to channel](https://docs.microsoft.com/en-us/graph/api/conversationmember-add)
- [Update member in channel](https://docs.microsoft.com/en-us/graph/api/conversationmember-update)
- [Remove member from channel](https://docs.microsoft.com/en-us/graph/api/conversationmember-delete)