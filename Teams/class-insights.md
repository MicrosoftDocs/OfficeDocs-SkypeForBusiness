...
* To turn off Insights use of School Data Sync follow the instruction in [Disabling SDS for Insights](https://docs.microsoft.com/schooldatasync/how-to-deploy-sds-for-insights#disabling-sds-for-insights).

* To turn it back on follow the instructions in [How to deploy SDS for Insights](https://docs.microsoft.com/schooldatasync/how-to-deploy-sds-for-insights).
