...
The following is an example of how to disable Teams for users who have a particular license type. You'll need to do this first, then individually enable Teams for the users who should have access.
