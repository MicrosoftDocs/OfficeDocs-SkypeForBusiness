...
> | What method are you using or plan to use to <br/>connect Phone System (formerly Cloud PBX) to <br/>the PSTN? <br/>Select all that apply. | <input type="checkbox"> Calling Plans (formerly PSTN calling) <br/> <input type="checkbox"> On-premises PSTN connectivity <br/>&nbsp; &nbsp; &nbsp;(leveraging existing Skype for <br/>&nbsp; &nbsp; &nbsp;Business 2015 or Lync Server <br/>&nbsp; &nbsp; &nbsp;2013 deployment) <br/> <input type="checkbox"> On-premises PSTN connectivity <br/>&nbsp; &nbsp; &nbsp;(using Cloud Connector) | |
