...
<!-- 
Note that this article includes almost all the same text as teams-and-skypeforbusiness-coexistence-and-interoperability.md. Any changes to that article, be sure to duplicate here. 
-->
