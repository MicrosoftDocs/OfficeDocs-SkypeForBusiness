...
- **signInSSOPage**: Triggered when user views single sign on page while sign in
-- **signInError**: Triggered when user hits any error while sign in. This is needed to proactively identify and fix issues that users face during sign in. 
...
- **get_resource_token_async**: Required service call to acquires tokens for Azure Active Directory resources asynchronously
