...
| Minutes available for Calling Plans.              | There are four plan options available per calendar month: <ul><li>120 minute Domestic Calling Plan (availability is limited)</li><li>240 minute Domestic Calling Plan (availability is limited)</li></li><li>3000 minute Domestic Calling Plan </li></li><li>For the Domestic and International Calling Plan you get 3000 min of domestic -OR- 600 minutes of international calling (whichever is reached first in the calendar month).</li></li> |
