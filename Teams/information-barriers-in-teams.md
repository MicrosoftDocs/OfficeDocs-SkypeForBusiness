...
When a team is created, a SharePoint site is provisioned and associated with the Team for the files experience. Informatoin barrier policies are not honored on this SharePoint site and files by default. To enable Information Barrier policies, admin has already filled out a form, requesting IB policies to be enabled on SharePoint and OneDrive (see pre-requisite section [here] (https://docs.microsoft.com/en-us/sharepoint/information-barriers#prerequisites). If Information Barrier policy is turned on on SharePoint and OneDrive, then IB policies will work on SharePoint sites provisioned when a team is created with Microsoft Teams.
