...
- **Maximum number of segments allowed in a tenant**: Each tenant can set up to 100 segments for configuring IB policies. However, there is no limit on the number of policies that can be configured.
