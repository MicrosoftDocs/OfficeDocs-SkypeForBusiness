...
- **Guest Users in Teams** - Information Barriers policies apply to guest users in Teams too, guest users needs to be made discoverable in global address list [Manage guest access](https://docs.microsoft.com/en-us/office365/admin/create-groups/manage-guest-access-in-groups?view=o365-worldwide#can-i-make-guest-objects-visible-in-the-global-address-list). Once guest users are made discoverable set up information barrier policies, see [Define policies for information barriers](https://docs.microsoft.com/office365/securitycompliance/information-barriers-policies)
