...
- **IB policies don't work for external access users**: If you have trusted external organizations defined in external access, the users of those organizations won't be restricted by IB policies. If users of your organization join a chat or meeting organized by external access users in another organization, then IB policies also won't restrict communication between users of your organization.
