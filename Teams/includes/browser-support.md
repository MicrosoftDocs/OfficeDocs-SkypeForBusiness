...
|---------|---------|---------|
|Internet Explorer 11     |Not supported         |<ul> <li>Audio: PSTN only (if meeting includes PSTN calling information)<li>Video: Not supported<li>Sharing: Incoming sharing only (no outgoing) </li></ul><br><br>Users who try to join a meeting on Internet Explorer 11 will be encouraged to download the Teams desktop client.   |
...
|Firefox, the latest version plus two previous versions     |Not supported         |<ul><li>Audio: PSTN only (if meeting includes PSTN calling information)<li>Video: Not supported<li>Sharing: Incoming sharing only (no outgoing)</li></ul><br><br>Users who try to join a meeting on Firefox will be encouraged to download the Teams desktop client.     |
|Safari 11.1+     | Not supported        |<ul><li>Audio: PSTN only (if meeting includes PSTN calling information)<li>Video: Not supported<li>Sharing: Incoming sharing only (no outgoing)</li></ul><br><br>Safari is enabled on versions higher than 11.1 in preview. While in preview, there are [known issues](https://support.office.com/article/safari-browser-support-1aac0a7c-35a8-42c1-a7df-f674afe234df) with Safari's Intelligent Tracking Prevention.      |
