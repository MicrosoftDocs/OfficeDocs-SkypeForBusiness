...
|Google Chrome, the latest version plus two previous versions       |<ul><li>Audio fully supported<li>Incoming and outgoing video not supported (coming soon)  </li>  </ul> |Fully supported  <br>As of July 3, 2019, screen sharing is supported without any plug-ins or extensions       |
