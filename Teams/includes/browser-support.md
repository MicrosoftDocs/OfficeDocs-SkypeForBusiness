...
|Safari 14+     |1:1 calls not supported. Group calls fully supported.<br><br>Video: Fully supported<br><br>Sharing: Fully supported         |Meetings fully supported.<br><br>Video: Fully supported<br><br>Sharing: Incoming sharing only (no outgoing). Note that only a user's entire display can be shared; sharing specific windows within a display is not available.     |
