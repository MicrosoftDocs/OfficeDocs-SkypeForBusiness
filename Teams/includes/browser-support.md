...
|Safari 13+     |1:1 calls not supported. Group calls supported with full audio support.<br><br>Video: Incoming only<br><br>Sharing: Incoming sharing only (no outgoing)         |Meetings are supported with full audio support.<br><br>Video: Incoming only<br><br>Sharing: Incoming sharing only (no outgoing)     |
