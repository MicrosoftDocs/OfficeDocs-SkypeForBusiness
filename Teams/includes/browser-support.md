...
|Safari 14+     |1:1 calls not supported. Group calls supported with full audio support.<br><br>Video: Fully supported<br><br>Sharing: Fully supported         |Meetings are supported with full audio support.<br><br>Video: Fully supported<br><br>Sharing: Incoming sharing only (no outgoing). Note that only a user's entire display can be shared; sharing specific windows within a display is not available.     |
|Safari 13.1+     |1:1 calls not supported. Group calls supported with full audio support.<br><br>Video: Incoming only<br><br>Sharing: Fully supported         |Meetings are supported with full audio support.<br><br>Video: Incoming only<br><br>Sharing: Incoming sharing only (no outgoing). Note that only a user's entire display can be shared; sharing specific windows within a display is not available.     |
