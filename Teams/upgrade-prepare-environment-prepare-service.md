...
![Stages of the upgrade journey, with emphasis on deployment](media/upgrade-banner-deployment.png "Stages of the upgrade journey, with emphasis on deployment")
...
apply to every deployment of collaboration and voice capabilities with Teams. You can
