...
This article describes how to enable Location-Based Routing for Operator Connect India. Before you follow the steps in this article, make sure you've read [Plan and configure Location-Based Routing for India](location-based-routing-india-plan.md) and completed the steps in [Configure network settings for Location-Based Routing](location-based-routing-configure-network-settings.md).

 After you deploy Operator Connect India and set up network regions, sites, and subnets, you're ready to enable Location-Based Routing. To complete the steps in this article, you'll need some familiarity with PowerShell cmdlets. To learn more, see [Teams PowerShell Overview](teams-powershell-overview.md)
