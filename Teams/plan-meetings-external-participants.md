...
A *validated* meeting participant is one that is logged in to Teams in Microsoft 365 in way that you trust. There are two types of validated external participants:
