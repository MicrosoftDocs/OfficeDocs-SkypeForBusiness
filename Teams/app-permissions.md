...
## View permissions in Microsoft Entra

After you consent to the app permissions, these are visible in Microsoft Entra portal.

   :::image type="content" source="media/permissions-entra-portal.png" alt-text="{alt-text}":::
