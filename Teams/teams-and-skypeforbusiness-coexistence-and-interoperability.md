...
> [!Important]
> In **Islands** mode all messages from federated users (outside your organization) are delivered to Skype for Business. After switching to **Teams Only** mode, all messaged from outside your organization will be delivered to Teams.
