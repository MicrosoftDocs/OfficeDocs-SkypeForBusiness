...
|Number of members in a team | 10,000&sup5;|
...
|Maximum number of members in an Office 365 group that can be converted to a team    |10,000&sup5;|
...
<sup>5</sup> 10,000 member teams are only supported in production clouds. Teams in GCC can only accommodate 5,000 members and teams in GCCH/DoD can only accommodate 2,500 members.
## Messaging
