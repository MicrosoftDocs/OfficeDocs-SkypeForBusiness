...
> [!NOTE]
  > There is a throttling limit of how many emails you can send to a channel which  is 6 emails per 10 seconds per channel per user and 8 emails per 10 seconds per tenant per user
