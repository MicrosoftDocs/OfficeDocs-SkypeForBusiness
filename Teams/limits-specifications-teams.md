...
|Feature     | Maximum limit |
|------------|---------------|
|Number of people in a meeting (can chat and call in)  | 1000, includes GCC but not yet for GCCH or DoD. **View-only** allows for up to 10,000 listen-only participants to join a meeting in which the organizer has a license for E3/E5/A3/A5 SKU, as well as, Government (GCC, GCC High, DoD). Learn more about the [View-only experience](view-only-meeting-experience.md).|
|Number of people in a video or audio call from chat | 20 |
