...
|Number of channels per team    | 1000 (includes deleted channels)<sup>4,7</sup>         |
...
|Shared channels per team|up to 1000 |Hosted and shared with the team. (Includes deleted channels during their 30-day recovery window.)|
