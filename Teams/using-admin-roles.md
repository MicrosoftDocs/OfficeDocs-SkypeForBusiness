...
| Virtual Visits Administrator           | Manage Virtual Visits in the Teams admin center and Microsoft 365 admin center. | Manage and configure all aspects of Virtual Visits. <br><br> View Virtual Visits reports. These include Virtual Visits usage reports in the Teams admin center and Microsoft 365 admin center and Virtual Visits Power BI reports.<br><br>View Virtual Visits features and settings in the Microsoft 365 admin center. |
