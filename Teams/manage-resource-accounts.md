...
To get the Virtual User license, in the Microsoft 365 admin center, go to **Billing** > **Purchase services** > **View products**, select the **Add-ons** filter, and scroll to the end - you will see the *Microsoft Teams Phone Standard - Virtual User* license. Next, select **Details** > **Manage** > **Buy licenses**. There is a zero cost, but you still need to follow these steps to acquire the license.
