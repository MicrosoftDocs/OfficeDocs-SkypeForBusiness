...
The Lists app in Microsoft Teams helps users in your organization track information and organize work. With Lists, users can track information such as issues, assets, routines, contacts, inventory and more using customizable views, smart rules, and alerts to keep everyone on the team in sync.

In Teams, users access Lists as a tab in a channel. Click **+** to add a new tab to a Teams channel, and then select the Lists app to get started. Users can create new lists or add existing lists to a channel. New lists can be created from scratch, from built-in templates, or by importing data from Excel.
