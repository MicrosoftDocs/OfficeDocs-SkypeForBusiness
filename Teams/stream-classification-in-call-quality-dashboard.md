...
|:-----|:-----|:-----|:-----|
|Audio Degradation Avg|Payload Description is not SATIN|> 1.0|Average Network Mean Opinion Score degradation for stream. How much network loss and jitter have impacted the quality of received audio.|
...
|Ratio Concealed Samples Avg|Payload Description is not SATIN|> 0.07|Average ratio of the number of audio frames with concealed samples generated by packet loss healing to the total number of audio frames.|
||||
