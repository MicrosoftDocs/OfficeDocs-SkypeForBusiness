...
|No|MediaBypass |Parameter indicated of the SBC supports Media Bypass and the administrator wants to use it.|None|True<br/>False|Boolean||No|Enabled|Used to enable this SBC for outbound calls. Can be used to temporarily remove the SBC while it's being updated or during maintenance. |False|True<br/>False|Boolean|
