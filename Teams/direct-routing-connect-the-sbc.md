...
|No|**MediaBypass** |This setting indicates whether the SBC supports media bypass and whether you want to use it for the SBC.|None|True<br/>False|Boolean||No|Enabled|Used to enable this SBC for outbound calls. Can be used to temporarily remove the SBC while it's being updated or during maintenance. |False|True<br/>False|Boolean|
