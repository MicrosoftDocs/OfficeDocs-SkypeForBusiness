...
<table>
  ...
  <tr>
    ...
    <td valign="top">Device permissions (see above).</td>
...
A connector posts messages to a channel when events in an external system occur.
  ...
  <tr>
    ...
    <td valign="top">REPLYTO_CONNECTOR_MESSAGE. Certain connectors support _actionable messages_, which allow users to post targeted replies to the connector message, for example by adding a response to a GitHub issue or adding a date to a Trello card.</td>
