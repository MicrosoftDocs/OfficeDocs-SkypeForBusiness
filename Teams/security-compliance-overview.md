...
Services in compliance categories C and D that have industry-leading compliance commitments are enabled by default. Services in categories A and B come with controls to turn on or turn off these services for an entire organization. To access the document, see [Compliance Framework for Industry Standards and Regulations](https://www.lsuhsc.edu/admin/it/helpdesk/office365/docs/Office%20365%20Compliance%20Framework%20document.pdf). Teams also supports Cloud Security Alliance compliance.
