...
- Example 1: Update-MgUser -UserPrincipalName 'usern@domain.com' -PhoneNumber '15555555678;ext=5678'
- Example 2: Update-MgUser -UserPrincipalName 'usern@domain.com' -PhoneNumber '+15555555678x5678'
- Example 3: Update-MgUser -UserPrincipalName 'usern@domain.com' -PhoneNumber 'x5678'
