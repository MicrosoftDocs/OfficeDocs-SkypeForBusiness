...
3. Give the policy a name, and then switch **Allow call park** to **On**. (Some settings are currently unavailable to be customized because call park doesn't support custom pickup ranges yet).
