...
- Although the Mac client uses the same port ranges, it also uses hard-coded values for audio (EF), video and application/screen sharing (AF41). These values aren't configurable.
