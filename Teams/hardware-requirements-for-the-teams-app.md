...
|Operating system  |    Windows 10 (excluding Windows 10 LTSC), Windows 10 on ARM, Windows 8.1, Windows Server 2019, Windows Server 2016, Windows Server 2012 R2. Note: We recommend using the latest Windows version and security patches available.|
...
|Supported Linux distributions | Ubuntu 18.04 LTS, 20.04 LTS, Fedora 30 Workstation (does not apply to releases after Fedora 30 Workstation), RHEL 8 Workstation, CentOS 8       |
