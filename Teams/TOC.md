...
### [Use the Teams App Submission API to submit and approve your custom apps](submit-approve-custom-apps.md)
### [Use the Microsoft Teams admin center to upload your custom apps](upload-custom-apps.md)
