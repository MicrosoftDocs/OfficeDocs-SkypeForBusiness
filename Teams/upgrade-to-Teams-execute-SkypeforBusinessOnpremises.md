...
If you're not using Calling Plans in Office 365, you need to transition your enterprise voice deployment to Phone System Direct Routing as part of your upgrade to Teams. To upgrade your users to Teams, see the [additional considerations for Phone System Direct Routing]{https://docs.microsoft.com/en-us/MicrosoftTeams/2-envision-make-my-service-decisions-direct-routing}. If you are planning to use Calling Plans in Office 365, please refer to our guidance for transferring your phone numbers to Office 365