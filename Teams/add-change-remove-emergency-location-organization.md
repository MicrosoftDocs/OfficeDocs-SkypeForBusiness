...
Regardless of the [PSTN connectivity option](pstn-connectivity.md) you choose&mdash;Microsoft Calling Plans, Operator Connect, Operator Connect Mobile, or Direct Routing&mdash;emergency locations can be associated with a phone number.
...
This article applies to Microsoft Calling Plans, Operator Connect, Operator Connect Mobile, and Direct Routing.
