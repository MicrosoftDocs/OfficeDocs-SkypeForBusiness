...
On July 31, 2021, Skype for Business Online was retired. This retirement was originally announced in July 2019 to give customers two years to plan their upgrades to Microsoft Teams. Teams is the core app for communication and collaboration in Microsoft 365. Now that Skype for Business Online is retired, we want to ensure customers have the information and resources they need to plan and execute a successful upgrade to Teams.  The Skype consumer service is not affected by this retirement.
...
It is no longer possible for users homed in the cloud to be assigned a mode other than TeamsOnly. This means:
 - When licensing new users (except for users homed in on-premises Skype for Business Server), these users will automatically be assigned TeamsOnly mode, regardless of the tenant's global policy of TeamsUpgradePolicy.
