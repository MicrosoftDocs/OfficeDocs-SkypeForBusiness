...
>
>A roaming folder or caching manager is required to ensure that the Teams app has the runtime data and files that are required to run the application. This is necessary to mitigate any network latencies, issues, or glitches.
