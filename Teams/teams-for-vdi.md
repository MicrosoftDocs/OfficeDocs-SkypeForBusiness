...
1. Run the following command to install the MSI to the VDI VM (or complete updating it).
...
1. Run the following command to uninstall the MSI from the VDI VM (or prepare for updating it).
