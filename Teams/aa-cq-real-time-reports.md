...
|sl_target                               |Current & Summary	|Authorized Users & Agents|Service level target number of seconds (*null if not set*)<br>See [Service Level Notes](#service-level-notes). |
