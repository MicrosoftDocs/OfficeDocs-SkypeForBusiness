...
> [Step 2 - Resource accounts >](https://docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=resource-account#steps)
...
> [!div class="nextstepaction"]
> [Step 3 - Call agents >](https://docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=call-agents#steps)
...
> [!div class="nextstepaction"]
> [Step 4 - Resource accounts >](https://docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=call-routing#steps)
...
> [!div class="nextstepaction"]
> [Step 5 - Call overflow >](https://docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=call-overflow#steps)
...
> [!div class="nextstepaction"]
> [Step 6 - Call timeout >](https://docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=call-timeout#steps)
