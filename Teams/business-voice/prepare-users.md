...
-  Make sure they have Microsoft Teams and Microsoft Office installed, 
- Set up devices on their computers.
- Show them how to set up voicemail greetings and other Business Voice features.
- Encourage them to learn more about Teams so they get the most out of it.

## Install Microsoft Teams on computers and phones

If you haven't already done this, you need to install Teams on any computers and phone that users want to use to make calls over Business Voice. Teams is available for PCs and Macs, and for Android and iPhone phones. It's also available on the web at https://teams.microsoft.com. For computers, you'll need a headset or a microphone and speakers. The next section provides more detail.
...
* **Mobile users or those in noisy environments:** Consider USB and wireless headsets with microphones. Paired with Microsoft Teams, any computer can work as a phone as long as it has an Internet connection.
* **Receptionists and executives:** Full, multi-function desktop handsets can be used just like with regular phones. Auto-dial, conferencing, speakerphone, and support for headsets make these devices extremely flexible.
...
> [!NOTE]
> To test that Teams, your speakers, and your microphone are all work correctly, follow the steps in [Make sure computers and devices on your network can reach Microsoft 365](get-ready-internet.md#make-sure-computers-and-devices-on-your-network-can-reach-microsoft-365).
...
Just like regular with phones, you can set up voicemail greetings and call forwarding, choose ringtones, and more. To configure these functions, the user clicks their profile picture in the upper-right corner of Teams and then selects **Settings** > **Calls**. For details, see [Manage your call settings in Teams](https://support.office.com/article/manage-your-call-settings-in-teams-456cb611-3477-496f-b31a-6ab752a7595f).

## Learn what Microsoft Teams and Business Voice can do

Business Voice can do a lot more than regular phones, too. You can set up simultaneous ring and call groups, share a phone line with a delegate, park calls, make multiple calls at once, and more. For directions, see [Meetings and calls](https://support.office.com/article/meetings-and-calls-d92432d5-dd0f-4d17-8f69-06096b6b48a8?ui=en-US&rs=en-US&ad=US#ID0EAABAAA=Calls).
