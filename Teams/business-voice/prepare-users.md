...
> [!NOTE]
> To test that Teams, your speakers, and your microphone all work correctly, follow the steps in [Make sure your networked devices can reach Microsoft 365](get-ready-internet.md#make-sure-your-networked-devices-can-reach-microsoft-365).
...
Just like with phones, you can set up voicemail greetings and call forwarding, choose ringtones, and more. To configure these functions, select the user profile picture in the upper-right corner of Teams and then go to **Settings** > **Calls**. For help, see [Manage your call settings in Teams](https://support.office.com/article/manage-your-call-settings-in-teams-456cb611-3477-496f-b31a-6ab752a7595f).
