...
4. On the Location and quantity page, do the following:
    ...
    4. Under **Location**, type the name of the location you created in the [Set up emergency locations](set-up-emergency-locations.md) step.
    5. Under **Area code**, select an area code, and then click **Next** to select your numbers
...
4. On the Location and quantity page, do the following:
    ...
    4. Under **Location**, select a location. You can select either the emergency location you added in the [Set up emergency locations](set-up-emergency-locations.md) step, or if you need to create a new location for another office or a home office, click **Add a location**.
    5. Under **Area code**, select an area code, and then click **Next** to select your numbers.
