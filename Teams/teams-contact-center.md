...
1. [Direct Routing Connectivity](https://docs.microsoft.com/en-us/MicrosoftTeams/direct-routing-landing-page)

2. [Microsoft Graph Cloud Communication APIs](https://docs.microsoft.com/en-us/graph/cloud-communications-get-started)
...
While the following is not a comprehensive list of feature capabilities for this model of integration, the focus areas include:
  ...
  - Partners to implement [<span class="underline">Microsoft certified session border controller (SBC)</span>](https://docs.microsoft.com/en-us/MicrosoftTeams/direct-routing-border-controllers) 
