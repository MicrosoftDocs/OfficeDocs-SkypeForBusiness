...
The file will be deleted early monring on the expiration date, though there is no strict gaurantee it will happen at that time. The file owner will receive an email notification when the recording expires and will be directed to the recycle bin to recover the recording.
