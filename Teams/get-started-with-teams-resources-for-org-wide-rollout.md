...
|![enterprise](media/deploy-teams-landing-page-Enterprise.png)<BR>I'm responsible for more than 500 users, and need help to make sure that my rollout is successful. |Go to the [Teams Adoption Hub](adopt-microsoft-teams-landing-page.md)] for guidance, tools, and resources to help your organization get the most out of Teams. |
