...
> [!NOTE]
> The limitations below are subject to change. Please check [this link](https://docs.microsoft.com/en-us/microsoftteams/limits-specifications-teams#browsers) for updates.
