...
> [!Note]
> Setting building details requires the tenant admin to add building directory details. Once added, users can set work location buildings for the day. For more information, see [Manage floor plans](/learn.microsoft.com/microsoftsearch/manage-floorplans/).
