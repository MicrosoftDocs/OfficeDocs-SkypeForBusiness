...
> [!IMPORTANT]
> The "bring your own email" (BYOE) wizard is now available at [http://admin.microsoft.com,](http://admin.microsoft.com) which automates most of the steps described in this article.
