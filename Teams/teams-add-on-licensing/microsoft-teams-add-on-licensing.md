...
Teams Phone options are described in more detail later in this article.   |
| **Microsoft Teams Calling Plans** | If your users need to call phone numbers outside your organization, you can purchase [Microsoft Teams Calling Plans](../calling-plans-for-office-365.md) to connect to PSTN phone numbers. With this option, Microsoft is your PSTN provider. <br/><br/>
Calling Plan options are described in more detail later in this article.  |
...
| **Teams Phone with a separate PSTN connectivity option** | Use your own carrier | | 
