---
title: "Assign Microsoft Teams licenses"
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: mikedav
...
ms.custom:
- Licensing
description: "Learn how to assign Microsoft Teams licenses for Phone System, Audio Conferencing, Calling Plans, and Communications Credits."
---
...
> [!IMPORTANT]
> See [Microsoft Teams add-on licensing](microsoft-teams-add-on-licensing.md) for information about what licenses you need to buy and **how to buy** them - depending on your Office 365 plan - so users get Audio Conferencing, toll-free numbers, and the ability to call phone numbers outside your business.
...
|Domestic & International Calling Plan  <br/> |MCOPSTN2  <br/> |
|Domestic Calling Plan (3000 minutes per user/month for US/PR/CA, 1200 minutes per user/month for EU countries) <br/> |MCOPSTN1  <br/> |
|Domestic Calling Plan (120 minutes per user/month for each country)<br/> *Note: This plan is not available in US.* |MCOPSTN5  <br/> |
|Domestic Calling Plan (240 minutes per user/month for each country) <br/> *Note: This plan is not available in US.* |MCOPSTN6  <br/> |
...
|**Product name**|**SKU part name**|
|:-----|:-----|
|Audio Conferencing (subscription) <br/> |MCOMEETADV  <br/> |
|Audio Conferencing Pay Per Minute (pay as you go) <br/> *Note: Requires Communications Credits to be set up and enabled.* |MCOMEETACPEA <br/> |
|Skype for Business Online Standalone Plan 2  <br/> |MCOSTANDARD  <br/> |
|Enterprise E1  <br/> |STANDARDPACK  <br/> |
|Enterprise E3  <br/> |ENTERPRISEPACK  <br/> |
