...
|---------|:-----:|:-------------:|
| Host and attend Teams Meetings | x |  |
| Experience Teams’ standard look and feel | x |  |
| Use standard and custom meeting backgrounds at the user level| x |  |
| Read live captions during meetings and live events | x |  |
...
| Feature | Teams | Teams Premium |
|---------|:-----:|:-------------:|
| Require attendees to register | x |  |
| Assign a co-organizer | x |  |
| Limit the number of people who can register | x |  |
| Allow registered users to bypass the lobby | x |  |
| Turn on Q&A for webinars with up to 1000 attendees | x |  |
| View attendance reports | x |  |
...
| Feature | Teams | Teams Premium |
|---------|:-----:|:-------------:|
| Manage meeting lobbies | x |  |
| End-to-end encryption for one-to-one calls | x |  |
| Moderate meeting chats | x |  |
| Control who can present | x |  |
...
| Feature | Teams | Teams Premium |
|---------|:-----:|:-------------:|
| View recordings of meetings | x |  |
| View meeting transcripts | x |  |
| View and use files added to meetings | x |  |
| View and use apps added to meetings | x |  |
...
| Feature | Teams | Teams Premium |
|---------|:-----:|:-------------:|
| Access Virtual Appointments with the Bookings app for scheduling, appointment management, and email notifications | x |  |
| Integrate Virtual Appointments using APIs | x |  |
| Join appointments from a browser | x |  |
| Join appointments in Teams | x |  |
| Allow users to join a virtual lobby waiting room | x |  |
| Integrate with Microsoft Forms | x |  |
