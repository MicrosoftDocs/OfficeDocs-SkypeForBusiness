...
|Phone System is included! <br/> | Buy a [Calling Plan](../calling-plans-for-office-365.md) from Office 365. <br/>  Or, use the [telephone service from your existing provider](microsoft-teams-add-on-licensing.md#bkmk_existing).  <br/> |
|Phone System voicemail is included! <br/> |You don't need to do anything else.  <br/> |
