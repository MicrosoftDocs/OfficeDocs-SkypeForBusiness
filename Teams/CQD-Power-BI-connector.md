...
6. **Government Community Cloud (GCC) Support –** For customers in the GCC environment, the CQD Power BI Connector will not work when using Power BI Desktop. The CQD Power BI connector is not presently compatible with the Power BI service for GCC customers.
