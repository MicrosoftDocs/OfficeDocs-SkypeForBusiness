...
If you're the admin for Microsoft Teams in your organization, you're in the right place. Here you’ll find all the information you need to plan, deploy, and run Teams. When you're ready to get going with Teams, start with [Quick start - Teams](get-started-with-teams-quick-start.md). Then check out [How to roll out Teams](How-to-roll-out-teams.md).
