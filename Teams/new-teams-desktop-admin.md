...
|Add third party cloud storage to a teams channel from the desktop client|You'll no longer see the "Add cloud storage" in the Files app on Teams' left navigation bar. Instead, use the Teams app provided by your third-party cloud storage provider.|
