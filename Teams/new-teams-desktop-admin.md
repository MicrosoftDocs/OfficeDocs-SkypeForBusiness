...
|Add third party cloud storage to a teams channel from the desktop client|Use the integrated Teams app created by your third party cloud storage provider. </br>**Note:** Teams admins can also choose to replace all native OneDrive and SharePoint file entry points like Files app, Files tab, and File picker with those from their third party cloud provider if they prefer. Learn more at [Turn off Teams native file upload policy](/microsoftteams/turn-off-teams-native-file-upload-policy)|
