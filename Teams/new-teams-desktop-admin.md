...
Solution: Confirm that the minimum prerequisites have been met, including installing the Office and Windows security updates as it applies to your organization.</br>See [**Prerequisites**](#prerequisites). Also: [Learn more about Office version history](/officeupdates/update-history-microsoft365-apps-by-date#version-history)</br>
