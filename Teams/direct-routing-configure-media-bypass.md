...
f1.keywords:
- NOCSH
description: Learn how to use Teams to configure media bypass with Phone System Direct Routing by switching all users at once or implementing a phased approached (recommended).
