...
|------- | -------------------- | ------------------------------ |
| October 2021 | [2.6.1-preview](https://www.powershellgallery.com/packages/MicrosoftTeams/2.6.1-preview) |<li>Releases [Set\|Remove]-CsPhoneNumberAssignment cmdlets. These cmdlets will be gradually rolled out. Tenants that aren't flighted will get an error message referencing the existing cmdlets they can use.</li><li>Releases Get-CsOnlineTelephoneNumberCountry and Get-CsOnlineTelephoneNumberType cmdlets.</li><li>Releases new parameter EnhancedEmergencyServiceDisclaimer for [Set\|New]-CsTeamsEmergencyCallingPolicy cmdlet.</li><li>Releases Get-CsUserCallingSettings cmdlet. This cmdlet will be eventually released in GA module. Releasing the trial version in preview module.</li>
