...
|------- | -------------------- | ------------------------------ |
Note: The New-Team related updates have been reverted from 2.5.0 and the previous version has been provided so as to avoid any breaking changes. The updated cmdlet will be published in the upcoming preview release instead.
