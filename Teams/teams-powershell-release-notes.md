...
|------- | -------------------- | ------------------------------ |
| April 2021 | [2.3.0](https://www.powershellgallery.com/packages/MicrosoftTeams/2.3.0) | <li>Added cmdlet to get multi-geo region for users and groups</li><li>Fixes for integrated windows authentication to use -AccountId with Connect-MicrosoftTeams</li><li>TeamsCallHoldPolicy cmdlets are now available</li><li>Updates to input parameters and output formats of many commands</li><li>Fixes large latency issue while remoting commands</li><li>GA custom package features</li>|
