...
|------- | -------------------- | ------------------------------ |
| April 2021 | [2.2.0-preview](https://www.powershellgallery.com/packages/MicrosoftTeams/2.2.0-preview) | <li>Fixes for integrated windows authentication to use -AccountId with Connect-MicrosoftTeams</li><li>Added cmdlet to get details of total change Notification event that can be sent and user</li><li>Added cmdlet to get multi-geo region for users and groups</li>|
