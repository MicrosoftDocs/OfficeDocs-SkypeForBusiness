...
|------- | -------------------- | ------------------------------ |
| May 2021 | [3.0.0] |<li>Updates for AccessToken login with Connect-MicrosoftTeams - unified token array instead of resource specific access token parameters</li><li>Removed all AADGraph references as AADGraph is nearing End of Life</li>|
