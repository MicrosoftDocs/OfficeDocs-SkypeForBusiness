...
| Decision | Description |
|--|--|
| Org-wide settings| [Manage meeting settings in Microsoft Teams](meeting-settings-in-teams.md)|
| Meeting policies | [Manage meeting policies in Teams](meeting-policies-in-teams.md)|
| Meeting recording and archiving| [Teams cloud meeting recording](cloud-recording.md) |

### Audio conferencing

| Decision | Description |
|--|--|
| Video teleconferencing| [Cloud Video Interop for Microsoft Teams](cloud-video-interop.md)|
| Conference bridges| [Manage the Audio Conferencing settings for your organization in Microsoft Teams](manage-the-audio-conferencing-settings-for-my-organization-in-teams.md) |
| Communications Credits| [Set up Communications Credits for your organization](set-up-communications-credits-for-your-organization.md)|
| Outbound calling restrictions| [Outbound calling restriction policies for Audio Conferencing and user PSTN calls](outbound-calling-restriction-policies.md) |
| Dial plans | [Create and manage dial plans](create-and-manage-dial-plans.md) |
| Live events | [Set up for live events in Microsoft Teams](teams-live-events/set-up-for-teams-live-events.md) |
...
| Decision | Description |
|--|--|
| Phone System | [Set up Phone System in your organization](setting-up-your-phone-system.md)|
| Cloud Voicemail| [Set up Cloud Voicemail](set-up-phone-system-voicemail.md) |
| Emergency calling| [Plan and configure dynamic emergency calling](configure-dynamic-emergency-calling.md) |
| Caller ID| [Manage caller ID policies in Microsoft Teams](caller-id-policies.md) |
| Common area phones| [Set up the Common Area Phone license for Microsoft Teams](set-up-common-area-phones.md)|
...
https://docs.microsoft.com/en-us/MicrosoftTeams/qos-in-teams?WT.mc_id=AdvisorForTeams
