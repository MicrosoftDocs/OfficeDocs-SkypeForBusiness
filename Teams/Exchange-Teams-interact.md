...
- The checkbox for the Exchange Hybrid Deployment feature in Azure AD Connect is set. For more information about this checkbox, see [Exchange hybrid writeback](https://docs.microsoft.com/azure/active-directory/hybrid/reference-connect-sync-attributes-synchronized#exchange-hybrid-writeback).
