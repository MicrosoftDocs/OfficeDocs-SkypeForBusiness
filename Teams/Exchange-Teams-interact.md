...
- For the Teams Scheduling add-in for Outlook, when scheduling a meeting on behalf of someone, Exchange 2013 CU19 or later is enough. This is to support the unauthenticated discovery of the mailbox by our service to check delegate permissions against the delegator mailbox. The delegate and delegator location could be Exchange 2013 or later, or Exchange online, but Autodiscover must resolve to Exchange 2013 CU19 or later.
