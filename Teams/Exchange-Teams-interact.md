...
- Control and protect the configuration of compliance policies in Teams and Exchange using Conditional Access. For more information see [How do Conditional Access policies work for Teams?](https://docs.microsoft.com/en-us/microsoftteams/security-compliance-overview#how-do-conditional-access-policies-work-for-teams) and [Set up app-based conditional access policies with Intune](https://docs.microsoft.com/en-us/intune/app-based-conditional-access-intune-create)
