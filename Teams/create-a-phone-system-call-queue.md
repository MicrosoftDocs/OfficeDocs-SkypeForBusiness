...
- **Longest idle** routes the next available call to the call agent who has been idle the longest time.
    > [!IMPORTANT]
    > Agents who use the Skype for Business client won't receive calls when **Longest idle** is enabled. If you have agents who use Skype or Business, don't enable this setting.
