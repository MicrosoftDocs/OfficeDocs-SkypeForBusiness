...
The Microsoft Developer Network provides [sample tabs](platform/samples/code-samples.md) developed by Microsoft that you can download, and [detailed instructions](platform/tabs/design/tabs.md) for designing and building your own tabs.
