...
![Diagram illustrating the three components of quality](media/prepare-network-image1.png "Diagram illustrating the three components of quality, and how service management overlaps all three components.")
...
![Diagram illustrating the three components of quality](media/prepare-network-image2.png "Diagram illustrating the three components of quality, and how service management overlaps all three components. With a focus on service management.")
...
![Diagram illustrating areas examined during quality experience review](media/prepare-network-image3.png "A diagram that illustrates the key areas that are examined during a quality experience review.")
...
![Diagram illustrating the three components of quality](media/prepare-network-image4.png "Diagram illustrating the three components of quality, and how service management overlaps all three components. With a focus on the network.")
...
![Diagram illustrating the three components of quality](media/prepare-network-image5.png "Diagram illustrating the three components of quality, and how service management overlaps all three components. With a focus on endpoints.")
