...
## URLs Required for Communication
 ...
 > [!NOTE]
 > All network traffic between the MTR devices agent and the Microsoft Teams Rooms – Managed Services service portal is SSL over port 443*.*  The below URLs are for managed service agent, for Teams information see [Office 365 URLs and IP address ranges - Microsoft 365 Enterprise | Microsoft Docs](/microsoft-365/enterprise/urls-and-ip-address-ranges?view=o365-worldwide&preserve-view=true).
...
Our agent test tool is available at [https://aka.ms/mmr/AgentTestTool](https://aka.ms/mmr/AgentTestTool).

This will check for some common misconfigurations or blocked network connections and suggest solutions. It will also collect the agent logs, if no issue is identified or you require more assistance please create a customer reported incident within the managed service portal and attach the logs generated by the test tool. 
