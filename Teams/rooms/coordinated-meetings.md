...
| **Resource account consideration**   | Determines how the secondary device's resource account settings should be set up to avoid it being booked separately from the main Teams Rooms system. |  
