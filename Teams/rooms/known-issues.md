...
|  ---        |      ---             |   ---            | --- |
| Volume level of ingest audio drops after ending the meeting | After updating to application version 4.8.31, when a user connects to a Teams Rooms device via HDMI, the audio drops to a point where it can't be heard. | Do the following to work around this issue:<p><ol><li>Open the Start menu, type <b>Sound settings</b>, and then select <b>Sound settings</b></li><li>Select <b>Sound Control Panel</b></li><li>In the <b>Sound</b> dialog, select the <b>Communications</b> tab</li><li>In the <b>When Windows detects communications activity</b> list, select <b>Do nothing</b></li><li>Select <b>OK</b></li></ol> | None |
