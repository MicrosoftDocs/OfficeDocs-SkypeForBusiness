...
| Application not launching |  After update to application version 4.4.41.0, system boots to black screen and may get stuck at black screen or goes to logon screen after few minutes. | Follow steps in this [guide](https://docs.microsoft.com/en-us/microsoftteams/troubleshoot/teams-administration/teams-rooms-app-wont-start-after-update) to fix this issue  | None |
