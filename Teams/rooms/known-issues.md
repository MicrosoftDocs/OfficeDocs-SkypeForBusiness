...
|  Low meeting volume after content sharing         |   Microsoft Teams Rooms devices on Windows 10 20H2 release experience decrease in volume after sharing content via in room HDMI. This is caused by Audio ducking issue in Windows 10 OS. | There is no known workaround. HDMI Audio feature is disabled for all customers to lower impact from this issue. Windows 10 OS team is performing root cause analysis and a customer advisory remains in effect until a resolution is found. | None |
