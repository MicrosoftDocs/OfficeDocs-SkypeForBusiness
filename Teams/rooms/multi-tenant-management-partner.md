...
description: Mult-tenant management for partners.
f1keywords: 
---
...
[!]Important] There must always be at least one user in the **Primary admins** role.
...
[!Note] A user assigned as a Primary admin for Customer A has full permissions in the TRM service for only that customer. The permissions of the user in Customer A have no influence on other customers.
\*
