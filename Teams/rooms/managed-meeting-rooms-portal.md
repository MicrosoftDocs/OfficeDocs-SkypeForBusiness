...
> [!Important]
> Review [**Assign users to the Pro Manager Administrator role**](microsoftteams/rooms/enrolling-mtrp-managed-service#assign-users-to-the-managed-service-administrator-role) and make sure that access to the portal is restricted based on your organizational needs.
