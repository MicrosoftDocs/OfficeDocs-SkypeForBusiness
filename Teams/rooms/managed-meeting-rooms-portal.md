...
> [!Important]
> Review [**Assign users to the Teams Rooms Pro Manager role**](enrolling-mtrp-managed-service.md#assign-users-to-the-teams-rooms-pro-manager-role) and make sure that access to the portal is limited based on your business needs.
