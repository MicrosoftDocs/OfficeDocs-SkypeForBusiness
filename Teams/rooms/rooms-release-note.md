...
- Support for Microsoft Teams Rooms Pro and Microsoft Teams Room Basic room licenses <sup>2</sup>
...
<sup>2</sup> This feature is rolling out to the Teams web client and will take about two weeks from the date this update was released to complete. For more information, see [Teams updates](../teams-client-update.md).
