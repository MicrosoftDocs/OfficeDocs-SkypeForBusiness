...
|`<SendFeedbackToPMP>`| Boolean ❷ | First ❶ |Disabled by default. If enabled, all entries sbumitted by a room user via Report a Problem will create an event in Teams Rooms Pro Management portal.|
