...
| `<TeamsRoomsNewExperience>` | Boolean &#x2777; | First &#x2776; | Default is `false`. This setting enables the refreshed home screen design. For more information, see [Microsoft Teams Rooms home screen design refresh](mtr-home-refresh.md). |
| `<RemoveFoRCalendar>` | Boolean &#x2777; | First &#x2776; | Default is `false`. This setting hides the calendar on your front-of-room display. For more information, see [Microsoft Teams Rooms home screen design refresh](mtr-home-refresh.md). |
