...
| `<TeamsRoomsNewExperience>`n| Boolean &#x2777; |   | Enable or disable the refreshed home screen design on front-of-row displays. The refreshed home screen design is disabled by default. For more information, see [Microsoft Teams Rooms home screen design refresh](mtr-home-refresh.md).  |
