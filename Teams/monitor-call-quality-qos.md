...
Ideally you would implement QoS on your internal network while setting up Teams. This allows the delay-sensitive voice and video traffic to get prioritized ahead of other traffic. You'd do this prioritization on all the client devices, as well as on the switches and routers in your network.
