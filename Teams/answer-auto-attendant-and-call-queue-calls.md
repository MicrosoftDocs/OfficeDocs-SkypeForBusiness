...
Users will be able to differentiate incoming calls from an Auto attendant or Call queue before they answer the call. Along with the name and/or number of the caller, each call will include Display Name of the Resource Account, assigned to the Auto Attendant or the Call Queue,the caller was trying to reach, giving users a better context for addressing the caller.
