...
## Remove a direct policy assignement

You can remove a direct policy assignement from a user. This can be done to allow a group policy assignment to take effect.

To remove a direct policy assignement
