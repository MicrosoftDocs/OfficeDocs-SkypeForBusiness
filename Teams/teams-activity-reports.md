...
|**8**   |Click or tap **Columns** to add or remove columns from the report.  ![Screenshot of the Teams user activity report showing the available activity columns.](media/teams-user-activity-columns.png)        |
