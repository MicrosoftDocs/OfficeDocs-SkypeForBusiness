...
|:-----|:-----|:-----|
|:::image type="icon" source="media/purple-square.png" border="false":::|:::image type="icon" source="media/orange-square-teams.png" border="false":::|Can't add tabs to chat</br></br>Can't reorder pinned chats</br></br>Immersive reader not available|
...
|Classic|New|Limitations|
|:-----|:-----|:-----|
|:::image type="icon" source="media/purple-square.png" border="false":::|:::image type="icon" source="media/purple-square.png" border="false":::||
