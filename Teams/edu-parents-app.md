...
1. In the left panel, navigate to **Tables** under **Data**.
    :::image type="content" source="media/delete-data-verse/delete-student-1.png" alt-text="Screenshot of selecting tables from Power Automate.":::

1. Under **Tables**, select the **All** tab, and then select the **Approval** table.
   :::image type="content" source="media/delete-data-verse/delete-student-2.png" alt-text="Screenshot of Tables view."::: 

1. In the **Approvals** table, add the **Partner Id Hash** column.
    :::image type="content" source="media/delete-data-verse/delete-student-3.png" alt-text="Screenshot of Approvals table.":::
1. Select the **Partner Id Hash** dropdown and in the **Filter by window**, enter **student object ID**, and select **Apply**.
    :::image type="content" source="media/delete-data-verse/delete-student-4.png" alt-text="Screenshot of student id column.":::
1. From the displayed list, select the rows to delete the required student data.
    :::image type="content" source="media/delete-data-verse/delete-student-5.png" alt-text="Screenshot of displayed data.":::
