...
>
> The CMD to preemptively change the MeetingExpirationDays setting in Teams isn't yet available to be set.  We'll publish an updated message center post when the setting is available for modification.
>
>
