...
|Let **Teams users** in your organization communicate with **Teams free users** from outside your organization. | To learn how the free version of Teams works with external access, see [Differences between Microsoft Teams and Microsoft Teams free](https://support.office.com/article/differences-between-microsoft-teams-and-microsoft-teams-free-0b69cf39-eb52-49af-b255-60d46fdf8a9c).|
