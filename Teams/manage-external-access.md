...
|Hybrid with some users online (in either Skype for Business or Teams) and some users on-premises. | Follow above steps for online organizations. Please note that chat with unmanaged Teams users is not supported for on-premises users. |
