...
> [!NOTE]
> 1. When compliance recording policy is assigned to users, calls from call queues can be recorded. However, this scenario is not supported, as some call queue routing methods might lead to multiple recording announcements.
