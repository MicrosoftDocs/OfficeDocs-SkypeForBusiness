...
If you are a vendor seeking to join the certification program, sign up at http://aka.ms/TeamsPhonePartner. You will receive the next steps on how to proceed. If you would like to provide more details, send an e-mail to [Teamscategorypartner@microsoft.com](mailto:Teamscategorypartner@microsoft.com).
