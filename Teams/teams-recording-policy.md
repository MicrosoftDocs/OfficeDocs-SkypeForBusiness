...
If you are a vendor seeking to join the certification program, please fill out the form [http://aka.ms/CallingPlatformIntake](http://aka.ms/CallingPlatformIntake) as the next step. If you need to provide additional context and details, send a mail to [Teamscategorypartner@microsoft.com](mailto:Teamscategorypartner@microsoft.com).
