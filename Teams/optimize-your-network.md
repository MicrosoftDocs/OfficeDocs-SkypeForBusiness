...
## Step 2: Implement the most efficient routing to MS datacenters
...
## Step 3: Configure firewall ports requested for connectivity to Teams
...
## [Step 5: Configure split-tunnel VPN](prepare-environment-prepare-network#vpn)
...
## Step 6: Configure packet prioritization by using QoS
...
## Step 7: Optimize Wi-Fi networks for quality and performance
Several factors come into play when you optimize your Wi-Fi network:

## Step 8: Implementing QoS or Wi-Fi Multimedia (WMM) to ensure that media traffic over the Wi-Fi networks is prioritized.
...
## Step 9: Validate network connectivity by using the Network Assessment Tool
...
## Step 10: Monitor your network using CQD/CA
