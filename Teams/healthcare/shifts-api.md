---
title: "Shifts Graph API enabled for SIs/ISVs/Admins"
author: jambirk
ms.author: jambirk 
manager: serdars
audience: ITPro
...
description: Shifts Graph API enabled for SIs/ISVs/Admins (april 19)
---

# Shifts Graph API enabled for SIs/ISVs/Admins
