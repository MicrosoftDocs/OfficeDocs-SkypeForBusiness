...
The Patients Application connects to FHIR conformant EHRs directly, and can connect to non-conformant EHRs through a secondary FHIR integration server. Note that only team owners can initiate the EHR connection process. More information regarding the technical aspects of the application can be found HERE 
