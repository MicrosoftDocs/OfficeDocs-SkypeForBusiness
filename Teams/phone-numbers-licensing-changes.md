...
For information about how to change the license simultaneously with group-based licensing, see [Change license assignments for a user or group in Azure Active Directory](https://learn.microsoft.com/azure/active-directory/enterprise-users/licensing-groups-change-licenses).
