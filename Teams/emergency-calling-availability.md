...
| Czech Republic | All outbound calls to Emergency Services are routed to incumbent Operator and then routed to the East or West Call Centers, and then distributed to the appropriate Emergency Services Provider.  |
...
| Luxembourg | All outbound calls to Emergency Services are routed to the centralized emergency center.   |
...
| New Zealand |  All outbound calls to Emergency Services are routed to the National Call Center, and then distributed to the appropriate Emergency Services Provider.  |
