...
This article gives an overview of the requirements for properly evaluating your current environment for using Teams. By evaluating your environment, you identify risks and requirements that will influence your overall Teams deployment. By identifying these items beforehand, you can adjust your planning to drive success.

## [Network readiness](evaluate-my-environment#network-readiness)
...
## [Bandwidth planning](evaluate-my-environment#bandwidth-planning.md)
