...
Share Get started with Teams displays [LINK TO END USER DOC] with your users to help them get started using Teams displays. Let them know that their data and preferences aren't changed after the upgrade to Teams displays. For example, they can access all their meetings, missed calls, and voicemails in Teams displays. 
