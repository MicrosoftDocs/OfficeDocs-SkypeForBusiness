...
2. Select the Teams phones you want to upgrade, and then select **Upgrade**.
    ...
    :::image type="content" source="../media/upgrade-phones-to-displays-select-new.png" alt-text="Screenshot showing Teams phones selected for upgrade to Teams displays.":::
