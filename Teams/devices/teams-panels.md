...
The installation hardware requirements for the devices may not be the same for every meeting space in your organization. Depending on the meeting space specifications, such as layout and wall surface material, you might need to procure additional installation hardware. For example, the installation hardware requirement for mounting the device on a glass wall may be different from mounting it on a plaster surface or a wood paneling. Refer to the device partner's documentation for available mounting options.
