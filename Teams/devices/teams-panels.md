...
To use Teams panels, you need a [Microsoft Teams Rooms license](../rooms/rooms-licensing.md) or a [Teams Shared Device license](../teams-add-on-licensing/teams-shared-device-license.md).
