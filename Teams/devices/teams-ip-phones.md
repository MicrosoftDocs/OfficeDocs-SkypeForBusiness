...
> [!NOTE]
> If your phone is not listed in this table, manually provisioning the phone may be possible via the device's generic profile and as a SIP device. For more information, see [Configure SIP Gateway](/microsoftteams/sip-gateway-configure).
