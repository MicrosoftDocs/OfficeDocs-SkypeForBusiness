...
First, Configure IP Phone Policy [SignInMode](/powershell/module/teams/new-csteamsipphonepolicy?view=skype-ps#-signinmode&preserve-view=true) parameter via PowerShell to enable associated apps on phone device.
