...
| Upgrade IP phones to Teams displays                | On the **Ip phones** page, select one or more eligible IP phones > **Upgrade**. To learn more, see [Upgrade IP phones to Teams displays](upgrade-phones-to-displays.md).   |
