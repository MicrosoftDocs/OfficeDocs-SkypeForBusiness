...
| Upgrade IP phones to Teams displays                | On the **IP phones** page, select one or more eligible IP phones > **Upgrade**. To learn more, see [Upgrade Teams phones to Teams displays](upgrade-phones-to-displays.md).   |
