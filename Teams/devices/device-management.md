...
| Upgrade IP phones to Teams displays                | Select one or more eligible IP phones > **Upgrade**. To learn more, see [Update IP phones to Teams displays](upgrade-phones-displays.md)   |
