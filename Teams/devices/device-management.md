...
| Upgrade Teams phones to Teams displays                | On the **IP phones** page, select one or more IP phones > **Upgrade**. To learn more, see [Upgrade Teams phones to Teams displays](upgrade-phones-to-displays.md).   |
