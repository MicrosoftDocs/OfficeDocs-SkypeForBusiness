...
For new spaces, the intended use of the room should drive both furniture and technology considerations. For example, when designing a room intended to facilitate both individual work and group instruction, the two uses should be separate for maximum efficiency.
...
-   [EPOS Sennheiser Headset – Adapt 560](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/epos-sennheiser-adapt-560/467)
...
-   [Yealink USB Webcam – UVC20](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/yealink-uvc20/854)

-   [Poly Speakerphone – Sync 20](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/poly-sync-20/825)
...
-   [Poly Soundbar – Studio P15](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/poly-studio-p15/821)
...
A large display gives remote participants a physical presence within the room, along with front-of-the-room speakers that allow their voices to be heard by all, even by those at desks furthest from the source. Microphones are situated at the front of the room so teachers and students can be heard by all. A traditional whiteboard for analog content can be captured the room system and shared with both in-room and remote participants.

*Devices shown:*

-   Room System - [Microsoft Surface Hub 2S](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/microsoft-surface-hub-2s/822)

    -   Note that the Surface Hub solution represents a premium experience for collaboration and interactive usage. A [Microsoft Teams Room solution](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/category/teams-rooms/20?page=1&filterIds=) paired with a large display can be used as an alternative in this same scenario.

-   Analog Whiteboard capture – [Logitech Brio Content Camera Kit](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/logitech-brio-content-camera-kit/349)

-   Camera and Audio - [Logitech Rally Plus kit](https://www.logitech.com/en-us/products/video-conferencing/room-solutions/rally-ultra-hd-conferencecam.html)
...
-   Optional Digital Whiteboard - [Microsoft Surface Hub 2S](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/microsoft-surface-hub-2s/822)

-   Camera – [AVer CAM520 Pro](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/aver-cam520-pro-standard/575)

-   Installed Audio – [QSC and Senheiser for Large Rooms](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/qsc-meeting-room-audio-in-ceiling-speakers/701)
...
-   Optional Dual Digital Whiteboards - [Microsoft Surface Hub 2S](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/microsoft-surface-hub-2s/822)
...
[Certified devices for Microsoft Teams](https://www.microsoft.com/en-us/microsoft-teams/across-devices/devices/product/poly-sync-20/825) – A comprehensive list of devices certified for Microsoft Teams

[Learn More about Microsoft Teams Rooms](https://docs.microsoft.com/en-us/microsoftteams/rooms/) – A guide to Microsoft Teams Rooms covering planning, deployment, and usage
