...
-   Windows 10 laptop (or PC) with camera

-   USB wired certified headset for Teams
...
-   Personal PC with Windows 10

-   USB camera (such as Logitech Brio)

-   USB / wireless speakerphone device (such as Poly Sync 20)

*Installing or setting up this solution is:*

Very easy. This can be handled entirely by end users by simply combing their PC with a certified USB camera and a separate USB / wireless speakerphone.

### Small meeting and huddle rooms
...
A mounted display sized for the room ensures everyone physically present can see remote meeting participants and/or a collaborative document. A room camera captures the room for remote participants. Because the room is a dedicated meeting space, a tabletop audio device makes sure all parties are heard.

*Devices shown:*

-   Yealink MVC320 Microsoft Teams Video Conferencing Kit for Small Rooms (includes Microsoft Teams Room for Windows with a touch controller, small room camera, and tabletop audio device for microphone and speakers)

-   Single front-of-room display for remote participants and content to be shared

*Installing or setting up this solution is:*

Relatively easy. This solution features a limited number of components and associated wiring that will get a room Teams-capable quickly.
...
Multiple displays ensure that remote participants have a prominent space in the physical room and that any collaborative documents are visible. Mounted speakers give remote attendees an “in the room” voice. A mounted camera ensures all the physical meeting participants are captured.
...
-   Logitech Rally Plus kit for camera and audio (with front-mounted speakers and camera and tabletop-mounted microphones)

*Installing or setting up this solution is:*

Medium complexity because of the room wiring and setup. The solution requires multiple network connections for devices and features a variety of components that must be placed correctly for use in the space. This setup also requires correct configuration of both the Microsoft Teams Room system and the associated Surface Hub 2 device to work properly.
...
-   Installed audio with ceiling-tile microphones and a powered speaker
...
A meeting room designed for large meetings with both local and remote participants as well as observers with technology that facilitates video meetings, the sharing of existing content via the Microsoft Teams Room system, and the creation of new content via the Surface Hub 2 digital whiteboard.

*Why this layout and device type?*

A mounted, prominent display gives remote participants a seat at the table when it comes to important boardroom conversations. A second display for presentations or collaborative documents makes sure everyone is on the same page. An intelligent camera system ensures the visibility of everyone at the table. Ceiling-tile microphones and ceiling speakers provide whole-room audio coverage.
