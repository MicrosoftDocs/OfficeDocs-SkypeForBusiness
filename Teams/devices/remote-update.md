...
Updates for Teams app and device Firmware happen automatically by default. However, you can update them manually as well. When you are applying updates manually, they can be applied immediately or scheduled to be updated on a future date and time that you set.
...
1. Specify the **Update frequency** by selecting the day(s) of the week that are suitable for carrying out updates on the devices when available. 
...
Option to configure maintenance window is not available for GCC-High and DoD tenants. 
...
The app updates for paired Microsoft Teams Rooms running Android and their paired touch consoles happen in sync to ensure a streamlined experience. It is applicable for the following software components -
