...
|Screen sharing mode|Entire screen|Controls whether a user is allowed to share desktop and window in a Teams meeting. Read more on how to [Configure desktop sharing in Microsoft Teams](configure-desktop-sharing.md).|
