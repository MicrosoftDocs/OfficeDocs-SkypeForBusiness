...
>[!NOTE]
> Any new tenants created after Sept 3, 2019 are created as TeamsOnly tenants if the organization does not have an on-premises deployment of Skype for Business Server (based on DNS detection).  
