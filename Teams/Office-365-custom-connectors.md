...
1. For incoming webhook connectors, users can recreate the connection by simply selecting **Update URL** and using the newly generated webhook URL.

![Screenshot of the "Update URL" button.](media/Teams_update_URL_button.png)

1. For other connector types, the user would need to remove the connector and recreate the connector configuration.

1. You will see a message "URL is up-to-date" after the URL has been successfully updated.
