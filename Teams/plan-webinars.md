...
|[Chat](manage-meeting-chat.md)|Can manage whether organizers, presenters, and co-organizers, and attendees can read and write chat messages.|Can manage whether chat is available for their the webinars.|
...
|[Manage what attendees see (Teams Premium)](https://support.microsoft.com/office/manage-what-attendees-see-in-teams-meetings-19bfd690-8122-49f4-bc04-c2c5f69b4e16)|No control|Can decide whose avatars or video feeds to spotlight during a Teams meeting. Others will be hidden from view.|
...
|[Reactions and hand raise](manage-reactions-meetings.md)| Manage whether reactions and hand raise can be used in webinars by organizers with this policy. |Can control whether reactions and hand raise can be used in their webinars. |
