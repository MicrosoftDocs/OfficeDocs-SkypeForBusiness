...
|---------|---------|
|**Learn the Teams basics**<br> [download the .zip file](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/LearnTheBasics.oft?raw=true)<br> ![Screenshot of Learn the Teams Basics email template.](media/edu_teamsbasics.png)   |**Customize your learning environment**<br> [Download the .oft file](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/CustomizeLearningEnvironment.oft?raw=true)<br>![Screenshot of Customize your learning environment template.](media/edu_customizelearning.png)       |
|**See how to streamline your workflow in Teams**<br>[Download the .oft file](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/FocusOnStudents.oft?raw=true)<br>![Screenshot of See how to streamline your workflow template.](media/edu_streamlineworkflow.png)     |**Better tools for better assignments**<br>[Download the .oft file](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/BetterTools.oft?raw=true)<br>![Screenshot of Learn how to chat like a pro template.](media/edu_bettertoolsassignments.png)        |
|**Put the home back in homework**<br>[Download the .oft file](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/HomeInHomework.oft?raw=true)<br>![Screenshot of Take Teams on the go template.](media/edu_homehomework.png)    |          |
