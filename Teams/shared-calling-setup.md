...
1. [If you're using a resource account with Calling Plan service number, assign Pay-As-You-Go Calling Plan to the resource account.](#step-5-if-youre-using-a-resource-account-with-calling-plan-service-number-assign-pay-as-you-go-calling-plan-to-the-resource-account)
