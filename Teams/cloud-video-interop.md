...
|CY23Q3|Point-to-Point (P2P) calling between Teams Rooms on Windows and VTCs|Teams Rooms Pro calling feature, which creates the ability to perform bi-directional calling between Teams Rooms on Windows and VTC devices|Delivered to CVI Partners|TBD|TBD|Available <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps/pexip.pexip_teams_room_sip_calling?tab=Overview" target="_blank">Pexip Connect for Teams Rooms</a>|TBD|
