...
> [!NOTE]
> Pexip connectors must be hosted in the Arizona or Texas Azure regions for GCCH. The Virginia region does not support hosting of the Pexip connector for GCCH.
