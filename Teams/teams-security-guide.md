...
- If a user in your organization received a phishing message, the tenant admin can [remove this message from the user's view using the graph API 'RemoveAllAccessForUser'](https://learn.microsoft.com/en-us/microsoftteams/security-remove-external-chat))
