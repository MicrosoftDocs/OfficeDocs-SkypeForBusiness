...
At a high level, here’s how to choose (for a detailed comparison, jump down to the [Table: Comparison of external and guest access](#table-compare-external-and-guest-access)):
...
## Table: Compare external and guest access
