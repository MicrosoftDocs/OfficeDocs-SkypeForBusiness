...
> [!NOTE]
> If you have set the Teams update policy to **Not enabled** and you don't want users to get new Teams with M365 Apps, review [Upgrade to the new Teams using policies](new-teams-deploy-using-policies.md).
