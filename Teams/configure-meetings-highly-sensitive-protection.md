...
Since these settings differ between meetings and presentations, we'll create one template for meetings and another presentations. Both templates can use the sensitivity label that we create above.
