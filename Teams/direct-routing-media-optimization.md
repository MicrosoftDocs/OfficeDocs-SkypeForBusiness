...
|Voice apps (e.g. Auto Attendant, Call Queue) do not work.| LMO does not support Voice Apps, as they reside in the cloud and require external connectivity.For Location-Based Routing scenarios, see [Voice apps (Auto Attendant or Call Queue)](location-based-routing-plan#inbound-calls-through-voice-apps-auto-attendant-or-call-queue).|
