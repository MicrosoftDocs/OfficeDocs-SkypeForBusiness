...
|Voice apps (e.g. Auto Attendant, Call Queue) do not work.| Local Media Optimization does not support Voice Apps because they reside in the cloud and require external connectivity. For Location-Based Routing scenarios, see [Voice apps (Auto Attendant or Call Queue)](location-based-routing-scenarios.md#inbound-calls-through-voice-apps-auto-attendant-or-call-queue).|
