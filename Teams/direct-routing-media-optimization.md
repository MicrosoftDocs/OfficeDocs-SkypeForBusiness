...
|Sometimes while call is established for few seconds user might hear silence|Due to complexity of Local Media Optimization architecture this might occure in some cases|
