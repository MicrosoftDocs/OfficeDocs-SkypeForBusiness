...
Insights works best when using [SDS V2 file format](https://docs.microsoft.com/en-us/schooldatasync/sds-v2-csv-file-format) and up, but also supports [SDS V1 file format](https://docs.microsoft.com/en-us/schooldatasync/school-data-sync-format-csv-files-for-sds) *with limited functionality*.
...
To Sync your SIS information with Educations Insights follow the instructions in [How to deploy SDS for Insights](https://docs.microsoft.com/en-us/schooldatasync/how-to-deploy-sds-for-insights).
...
To verify the sync status progress follow the instructions in [SDS for Insights Data Health and Monitoring](https://docs.microsoft.com/en-us/schooldatasync/sds-for-insights-data-health-and-monitoring).
