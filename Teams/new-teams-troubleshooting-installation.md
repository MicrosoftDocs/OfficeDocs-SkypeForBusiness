...
>[!Important]
>If **AllowAllTrustedApps** is disabled, the new Teams app (MSIX) installation fails. This issue has been fixed in the Windows October cumulative update KB5031455. This optional update isn't available for all builds of Windows. If the October update isn't available for your OS build, the November security update will include the fix.
>
