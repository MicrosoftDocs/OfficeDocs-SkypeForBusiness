...
1. If you're using a resource account with Calling Plan service number, assign Pay-As-You-Go Calling Plan to the resource account.

1. If you're using a resource account with Calling Plan service number, assign and fund a Communication credits license to the resource account.
