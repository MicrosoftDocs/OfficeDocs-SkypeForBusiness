...
description: In this learning path, you'll learn how to use and manage app setup policies that helps you to choose apps to pin, install apps and upload custom apps.
f1.keywords:
- CSH
ms.custom: 
