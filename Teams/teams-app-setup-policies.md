...
- Install apps for users. You choose which apps are installed by default for users when they start Teams and of these, which apps users can and can't uninstall.
