...
To assign a user role, in Teams, select the team name and then select **More options** (**...**) > **Manage team**. On the **Members** tab, you can add members and choose owners and moderators (if you have sufficient permissions). For more information, see [Manage team settings and permissions in Teams](https://support.office.com/article/ce053b04-1b8e-4796-baa8-90dc427b3acc).
