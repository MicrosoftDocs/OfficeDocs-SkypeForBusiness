...
<div id="main" class="v2">
    <div class="container">
        <h1>Teams in 30</h1>
           ...
           <p><font color="#6264A7"><strong>Ready to jump in?</strong></font> We encourage all members of your project team to start with the <i>Get Started with Teams in 30</i> session. Click a session title below to sign up.
        <ul class="pivots">
            <li>
