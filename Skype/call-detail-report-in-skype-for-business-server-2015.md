...
- The  [Location Report in Skype for Business Server 2015](location-report-in-skype-for-business-server-2015.md) (by clicking either the Call volume or the Poor call percentage metric)
    
  
- The  [Media Quality Summary Report in Skype for Business Server 2015](media-quality-summary-report-in-skype-for-business-server-2015.md) (by clicking either the Call volume or Poor call percentage metric)
    
  
- The  [Media Quality Comparison Report in Skype for Business Server 2015](media-quality-comparison-report-in-skype-for-business-server-2015.md) (by clicking the [Call List Report in Skype for Business Server 2015](call-list-report-in-skype-for-business-server-2015.md) and then clicking the Detail metric).
    
  
- The  [Server Performance Report in Skype for Business Server 2015](server-performance-report-in-skype-for-business-server-2015.md) (by clicking either the Call volume or Poor call percentage metric)
    
  
- The  [Call List Report in Skype for Business Server 2015](call-list-report-in-skype-for-business-server-2015.md) (by clicking the Detail metric)
    
  
From within the Call Detail Report you can access the  [Device Report in Skype for Business Server 2015](device-report-in-skype-for-business-server-2015.md) by clicking either of the following metrics:
