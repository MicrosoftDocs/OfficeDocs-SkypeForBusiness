...
## What's in this article?
 ...
 [What is ADAL?](how-to-use-modern-authentication-adal-with-skype-for-business.md#BKMK_ADAL)
  
    
    
 [Configure ADAL in your pool and set ADFS as security token server](how-to-use-modern-authentication-adal-with-skype-for-business.md#BKMK_Config)
  
    
    
 [Other Options for Enabling ADAL sign-in (like Office client apps)](how-to-use-modern-authentication-adal-with-skype-for-business.md#BKMK_Options)
  
    
    
 [Clients where Modern Authentication / ADAL isn't Supported](how-to-use-modern-authentication-adal-with-skype-for-business.md#BKMK_Support)
...
|HKCU\\SOFTWARE\\Microsoft\\Office\\15.0\\Common\\Identity\\Version  <br/> |REG_DWORD  <br/> |1  <br/> |
    ...
    > [!TIP]
      > To disable Modern Authentication on devices for Office 2013, set the HKCU\\SOFTWARE\\Microsoft\\Office\\15.0\\Common\\Identity\\EnableADAL registry key to a value of zero. > Be aware that a similiar Registry key ( HKCU\\SOFTWARE\\Microsoft\\Office\\ **16.0** \\Common\\Identity\\EnableADAL) can also be used to disable Modern Authentication on devices for Office 2016.
