...
|:-----|:-----|:-----|
|Join  <br/> |A user joins a chat room.  <br/> |
```
...
|
|Part  <br/> |A user leaves a chat room.  <br/> |
```
...
|
|Chat  <br/> |The sender's email address.  <br/> |
```
...
|
|Backchat  <br/> |A user requests content from chat history.  <br/> |
```
...
|
|File upload  <br/> |A user uploads a file.  <br/> |
```
...
|
|File download  <br/> |A user downloads a file.  <br/> |
```
