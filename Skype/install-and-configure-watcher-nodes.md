...
To install the agent files, follow the procedures listed in  [Configure the Skype for Business Server computers that will be monitored](configure-the-skype-for-business-server-computers-that-will-be-monitored.md).
