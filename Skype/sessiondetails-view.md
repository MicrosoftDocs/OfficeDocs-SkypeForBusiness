...
|:-----|:-----|:-----|
|**SessionIdTime** <br/> |datetime  <br/> |Time of session request. Used in conjunction with SessionIdSeq to uniquely identify a session. See the  [Dialogs table in Skype for Business Server 2015](dialogs-table-in-skype-for-business-server-2015.md) Table for more information. <br/> |
...
|**FromUriType** <br/> |nvarchar(256)  <br/> |Type of URI of the user who started the session. See the  [UriTypes table](uritypes-table.md) for more information. <br/> |
|**ToUriType** <br/> |nvarchar(256)  <br/> |Type of URI of the user who joined the session. See the  [UriTypes table](uritypes-table.md) for more information. <br/> |
|**FromTenant** <br/> |nvarchar(450)  <br/> |Tenant of the user who started the session. See the  [Tenants table](tenants-table.md) for more information. <br/> |
|**ToTenant** <br/> |nvarchar(256)  <br/> |The tenant of the user who joined the session. See the  [Tenants table](tenants-table.md) for more information. <br/> |
...
|**FromClientType** <br/> |int  <br/> |Client used by the user who started the session. See the  [UserAgentDef table](useragentdef-table.md) for more details. <br/> |
...
|**ToClientType** <br/> |int  <br/> |Client used by the user who joined the session. See the  [UserAgentDef table](useragentdef-table.md) for more details. <br/> |
...
|**TargetUriType** <br/> |nvarchar(450)  <br/> |Type of URI of the target user for the session. See the  [UriTypes table](uritypes-table.md) for more information. <br/> |
|**OnBehalfOfUri** <br/> |nvarchar(450)  <br/> |URI of the user on whose behalf the session was started.  <br/> |
|**OnnnBehalfOfUriType** <br/> |nvarchar(256)  <br/> |Type of URI of the user on whose behalf the session was started. See the  [UriTypes table](uritypes-table.md) for more information. <br/> |
|**OnBehalfOfTenant** <br/> |nvarchar(256)  <br/> |Tenant of the user whose on behalf the session was started. See the  [Tenants table](tenants-table.md) for more information. <br/> |
|**ReferredByUri** <br/> |nvarchar(450)  <br/> |URI of the user who referred the session.  <br/> |
|**ReferredByUriType** <br/> |nvarchar(256)  <br/> |Type of URI of the user who referred the session. See the  [UriTypes table](uritypes-table.md) for more information. <br/> |
|**ReferredByTenant** <br/> |nvarchar(256)  <br/> |Tenant of the user who referred the session. See the  [Tenants table](tenants-table.md) for more information. <br/> |
...
|**ReplaceDialogIdTime** <br/> |datetime  <br/> |Time of the dialog which was replaced by the session. Used in conjunction with ReplaceDialogIdSeq to uniquely identify a dialog that is replaced by the session. See the  [Dialogs table in Skype for Business Server 2015](dialogs-table-in-skype-for-business-server-2015.md) for more information. <br/> |
|**ReplaceDialogIdSeq** <br/> |int  <br/> |ID number to identify the session. Used in conjunction with ReplaceDialogIdTime to uniquely identify a dialog that is replaced by the session. See the  [Dialogs table in Skype for Business Server 2015](dialogs-table-in-skype-for-business-server-2015.md) for more information. <br/> |
