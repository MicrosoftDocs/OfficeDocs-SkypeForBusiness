...
[]Read this topic to review planning considerations for implementing media bypass with Cloud Connector Edition version 2.0 and later. For information about deploying media bypass, see  [Deploy media bypass in Cloud Connector Edition](deploy-media-bypass-in-cloud-connector-edition.md).
...
![signaling Without Media Bypass](images/5cd7e3bf-2565-4bd9-ad5a-f03e13c01060.png)
...
![signaling With Media Bypass](images/60400c38-4921-4964-89f2-5e53b68fb497.png)
...
![Cloud Connector Multisite Example](images/ace8dc3c-1082-46a2-b8b4-98cbf678620e.png)
...
![Cloud Connector Multisite Example 2](images/ef95839c-4552-440e-9698-7615707a1b50.png)
...
![Cloud Connector Capacity](images/efb2269b-d44f-474e-aea8-c5158e729cfe.png)
