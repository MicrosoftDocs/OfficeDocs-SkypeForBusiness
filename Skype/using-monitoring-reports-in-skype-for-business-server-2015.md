...
-  [Using the Monitoring Dashboard in Skype for Business Server 2015](using-the-monitoring-dashboard-in-skype-for-business-server-2015.md) Provides administrators with a quick overview of their system health and system usage.
    
  
-  [System usage reports in Skype for Business Server 2015](system-usage-reports-in-skype-for-business-server-2015.md) Provides system usage information based on CDR data collected by Skype for Business Server.
    
  
-  [Call Diagnostic Reports (per user) in Skype for Business Server 2015](call-diagnostic-reports-per-user-in-skype-for-business-server-2015.md) Provides per-user information about failed peer-to-peer and conferencing sessions.
    
  
-  [Call Diagnostic Reports in Skype for Business Server 2015](call-diagnostic-reports-in-skype-for-business-server-2015.md) Provides summary information and diagnostic data for failed peer-to-peer and conferencing sessions.
    
  
-  [Media Quality Diagnostic Reports in Skype for Business Server 2015](media-quality-diagnostic-reports-in-skype-for-business-server-2015.md) Provides information about call quality as well as diagnostic and troubleshooting information for failed calls.
