...
-  [Components required for Enterprise Voice in Skype for Business Server 2015](components-required-for-enterprise-voice-in-skype-for-business-server-2015.md)
    
  
-  [Plan for PSTN connectivity in Skype for Business Server 2015](plan-for-pstn-connectivity-in-skype-for-business-server-2015.md)
    
  
-  [Network settings for the advanced Enterprise Voice features in Skype for Business Server 2015](network-settings-for-the-advanced-enterprise-voice-features-in-skype-for-busines.md)
...
-  [Plan for private telephone lines with Skype for Business 2015](plan-for-private-telephone-lines-with-skype-for-business-2015.md)
    
  
-  [Plan for Location-Based Routing in Skype for Business 2015](plan-for-location-based-routing-in-skype-for-business-2015.md)
    
  
-  [Plan for call management features in Skype for Business 2015](plan-for-call-management-features-in-skype-for-business-2015.md)
    
  
-  [Plan for Enterprise Voice resiliency in Skype for Business Server 2015](plan-for-enterprise-voice-resiliency-in-skype-for-business-server-2015.md)
