...
![Shows the steps during a Call Via Work call; first the caller clicks to call someone in the Skype for Business client; then the UCWA rings the caller's phone. When the caller picks up the phone, the recipient is called](images/050e88ed-e18e-40c0-84d5-b17fe40c305a.jpg)
...
To enable any users for Call Via Work, you must have some pre-requisites in place. For more information on these prerequisites, and for steps on how to enable users for Call Via Work, see  [Deploy Call Via Work in Skype for Business Server 2015](deploy-call-via-work-in-skype-for-business-server-2015.md). 
...
#### 
 ...
 [Plan for remote call control in Skype for Business 2015](plan-for-remote-call-control-in-skype-for-business-2015.md)
