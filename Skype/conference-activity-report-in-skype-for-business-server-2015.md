...
The Conference Activity Report is accessed from the  [Conference Summary Report in Skype for Business Server 2015](conference-summary-report-in-skype-for-business-server-2015.md) by clicking either one of the following metrics:
