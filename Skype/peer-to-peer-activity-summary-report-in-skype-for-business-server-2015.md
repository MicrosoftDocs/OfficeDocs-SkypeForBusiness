...
You access the Peer-to-Peer Activity Summary Report from the Monitoring Reports home page. You open the  [Peer-to-Peer IM Report in Skype for Business Server 2015](peer-to-peer-im-report-in-skype-for-business-server-2015.md) by clicking either of the following metrics:
