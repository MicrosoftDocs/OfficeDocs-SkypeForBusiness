...
You can enable your Skype for Business users to use the Skype for Business app feedback tool that's built in to let users report issues and provide feedback directly to Microsoft about their experience. 
...
> [!SECURITY NOTE]
> The logs collected by the app's feedback tool will be stored for up to a maximum of 90 days in the U.S. while the issue is being investigated. Because of this, please don't enable this feedback tool if this violates your organization's data protection policy. 
...
Enable feedback reporting for user's in your organization and enable them to submit device screenshot, run:
