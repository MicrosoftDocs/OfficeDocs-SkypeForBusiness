---
title: View conferencing policies in Skype for Business Server 2015
...
5. In **Edit File Filter**, select the **Show Details** check box.
    ...
    **Edit Conferencing Policy - <policy>** opens displaying the settings for the selected policy.
    ...
    For details about configuring the settings, see  [Create conferencing policies in Skype for Business Server 2015](create-conferencing-policies-in-skype-for-business-server-2015.md).
...
For more information, including a complete syntax description and list of parameters, see  [Get-CsConferencingPolicy](get-csconferencingpolicy.md).
