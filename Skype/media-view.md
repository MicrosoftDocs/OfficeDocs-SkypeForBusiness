...
The Media view contains all of the columns in the  [SessionDetails view](sessiondetails-view.md) in addition the ones listed below.
...
|:-----|:-----|:-----|
|**Media** <br/> |nvarchar(256)  <br/> |Media type. See the  [MediaList table](medialist-table.md) for more information. <br/> |
