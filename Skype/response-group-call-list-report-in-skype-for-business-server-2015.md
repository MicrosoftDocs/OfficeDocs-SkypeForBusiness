...
The Response Group Call List Report can only be accessed by clicking one of the following metrics found on the  [Response Group Usage Report in Skype for Business Server 2015](response-group-usage-report-in-skype-for-business-server-2015.md):
