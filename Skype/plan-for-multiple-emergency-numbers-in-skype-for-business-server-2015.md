...
For more information about defining and modifying a location policy, see  [Plan location policies for Skype for Business Server 2015](plan-location-policies-for-skype-for-business-server-2015.md) and [Create location policies in Skype for Business Server 2015](create-location-policies-in-skype-for-business-server-2015.md). These topics describe concepts about location policies; however, you must follow the instructions in  [Configure multiple emergency numbers in Skype for Business 2015](configure-multiple-emergency-numbers-in-skype-for-business-2015.md) to configure multiple emergency numbers.
...
- For information about which Skype for Business and Lync clients support receiving multiple emergency numbers, dial masks, and public switched telephone network (PSTN) usages, see  [Client support](plan-for-multiple-emergency-numbers-in-skype-for-business-server-2015.md#BKMK_Clients).
...
- To configure multiple emergency numbers, you must use the New-CsEmergencyNumber cmdlet, and you must define location policies that support more than one emergency number by specifying the EmergencyNumbers parameter with the  [New-CsLocationPolicy](new-cslocationpolicy.md) and [Set-CsLocationPolicy](set-cslocationpolicy.md) cmdlets.
...
For more information about configuring multiple emergency numbers, see  [Configure multiple emergency numbers in Skype for Business 2015](configure-multiple-emergency-numbers-in-skype-for-business-2015.md).
...
|:-----|:-----|:-----|
|**Click-to-Run** <br/> |CC (Current Channel) released on May 10, 2016 - Version 1604 (Build 6868.2062)  <br/> |Yes  <br/> |
||FRDC (First Release Current Channel) released on June 14, 2016 - Version 1605 (Build 6965.2058)  <br/> |Yes  <br/> |
||DC (Deferred Channel) released on October 11, 2016 - Version 1605 (Build 6965.2092)  <br/> |Yes  <br/> |
|**MSI** <br/> |June 7 update -  [https://support.microsoft.com/en-us/kb/3115087](https://support.microsoft.com/en-us/kb/3115087) <br/> |Yes  <br/> |
|**Mac**|**Version**|**Supported?**|
|:-----|:-----|:-----|
||Lync for Mac 2011  <br/> |No  <br/> |
|**Lync Phone Edition**|**Version**|**Supported?**|
|:-----|:-----|:-----|
|| Aastra 6721ip and Aastra 6725ip telephones - September 2016 cumulative update (Build 7577.4512) - [https://support.microsoft.com/en-us/kb/3194831](https://support.microsoft.com/en-us/kb/3194831) <br/> |Yes  <br/> |
|| HP 4110 and HP 4120 telephones - September 2016 cumulative update (Build 7577.4512) - [https://support.microsoft.com/en-us/kb/3194832](https://support.microsoft.com/en-us/kb/3194832) <br/> |Yes  <br/> |
||Polycom CX500, Polycom CX600, and Polycom CX3000 telephones - September 2016 cumulative update (Build 7577.4512) -  [https://support.microsoft.com/en-us/kb/3194833](https://support.microsoft.com/en-us/kb/3194833) <br/> |Yes  <br/> |
