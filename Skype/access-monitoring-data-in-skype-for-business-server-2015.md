...
For more information, see the topic  [Install Monitoring Reports in Skype for Business Server 2015](install-monitoring-reports-in-skype-for-business-server-2015.md) in the Skype for Business Server 2015 deployment guide.
