...
You can create CDR configuration settings by using either Skype for Business Server Control Panel or the  [New-CsCdrConfiguration](new-cscdrconfiguration.md) cmdlet. You can use Skype for Business Server Control Panel or the [Set-CsCdrConfiguration](set-cscdrconfiguration.md) cmdlet to modify existing settings. If you are using Skype for Business Server Control Panel to create or modify settings, the following options will be available to you:
...
> [!NOTE]
> The New-CsCdrConfiguration and Set-CsCdrConfiguration cmdlets include additional options not available in Skype for Business Server Control Panel. See the  [New-CsCdrConfiguration](new-cscdrconfiguration.md) and the [Set-CsCdrConfiguration](set-cscdrconfiguration.md) help topics for more information.
