---
title: Advanced DNS planning for Skype for Business Server 2015
ms.prod: SKYPEFORBUSINESS
ms.assetid: f3a5895f-f64f-44eb-9a5e-8d606ac1fc38
---


# Advanced DNS planning for Skype for Business Server 2015
...
-  [Walkthrough of Skype for Business clients locating services](advanced-dns-planning-for-skype-for-business-server-2015.md#WalkthroughOfSkype)
    
  
-  [Split-brain DNS](advanced-dns-planning-for-skype-for-business-server-2015.md#SplitBrainDNS)
    
  
-  [Automatic configuration without split-brain DNS](advanced-dns-planning-for-skype-for-business-server-2015.md#NoSplitBrainDNS)
    
  
-  [DNS disaster recovery](advanced-dns-planning-for-skype-for-business-server-2015.md#DNSDR)
    
  
-  [DNS load balancing](advanced-dns-planning-for-skype-for-business-server-2015.md#DNSLB)
...
> [!NOTE]
> You'll see the Front End pool FQDN appears twice, but with two different IP addresses. That's because DNS load balancing is used. If HLB is used, there'd only be a single Front End pool entry. > Also, the Front End pool FQDN values change between the contoso.com and fabrikam.com examples, but the IP addresses remain the same. That's because users who're signing in from either SIP domain will be using the same Front End pool for automatic configuration. 
