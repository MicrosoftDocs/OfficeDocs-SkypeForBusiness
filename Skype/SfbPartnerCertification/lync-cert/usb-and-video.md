...
USB audio and video devices are tested and qualified for Lync through the <!-- need fresh link here --> [Compatible Devices Program](https://technet.microsoft.com/en-us/office/dn788951#compatible_devices)<!-- need added to this folder -->. USB desk phones and handsets, personal speakerphones, corded and wireless headsets, and HD webcams Optimized for Microsoft Lync are tested to provide the following:
