...
Additional information on networking with Microsoft Lync Server 2010, including Planning, QoS, Call Admission Control and Security can be found on the [Lync Server Network Infrastructure Roadmap](https://technet.microsoft.com/en-us/office/dn788952). <!-- need new link eventually -->
