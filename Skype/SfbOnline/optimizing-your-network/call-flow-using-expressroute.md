...
|Join conference call by user in customer network  <br/> |Client on your network and conferencing server in the cloud.  <br/> |ExpressRoute  <br/> |ExpressRoute  <br/> |[Online user on your network joining a conference that is hosted Online](call-flow-using-expressroute.md#bk_Figure3) <br/> ||
|Join conference call by user in Internet  <br/> |Client is on the Internet and conferencing server in the cloud.  <br/> |Internet  <br/> |Internet  <br/> |[Online user on your network joining a conference that is hosted Online](call-flow-using-expressroute.md#bk_Figure3) <br/> ||
...
|PSTN call  <br/> |Client in customer network and Phone System servers in the cloud  <br/> |ExpressRoute  <br/> |ExpressRoute  <br/> |[Online user on your network joining a conference that is hosted Online](call-flow-using-expressroute.md#bk_Figure3) <br/> ||
|PSTN call  <br/> |Client on the Internet and Phone System servers in the cloud  <br/> |Internet  <br/> |Internet  <br/> |Not applicable  <br/> |The media and signaling will flow to the Microsoft 365 or Office 365 datacenter. Since the client endpoint is on the Internet, all data will flow to the Microsoft datacenter across the Internet (even if an Online Edge server is needed for connectivity).  <br/> |
