...
- When migrating from one CVI partner to another, in this scenario the tenant key will be updated to reflect the new partner. **Note:** unlike the previous scenarios, MMS will need to be executed manually once the CsTeamsVideoInteropServicePolicy is updated
