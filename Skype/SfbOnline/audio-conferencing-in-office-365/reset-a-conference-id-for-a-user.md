...
> [!NOTE]
> For information about resetting conference ID in Microsoft Teams, see [Reset a conference ID for a user in Microsoft Teams](https://docs.microsoft.com/en-us/MicrosoftTeams/reset-a-conference-id-for-a-user-in-teams).
