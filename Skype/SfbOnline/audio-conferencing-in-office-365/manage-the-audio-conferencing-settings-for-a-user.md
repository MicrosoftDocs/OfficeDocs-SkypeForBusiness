...
ms.custom:
- Audio Conferencing
description: "As a Microsoft 365 admin, you can edit the Skype for Business Online Audio Conferencing settings—such as the provider, default toll or toll-free number, conference ID, or PIN—for an individual user in your organization. "
---
