...
> [!NOTE]
> If you're looking for information about dialing out from a Teams meeting, see [Dialing out from a Teams meeting so other people can join it](https://docs.microsoft.com/MicrosoftTeams/dialing-out-from-a-teams-meeting-so-other-people-can-join-it).
