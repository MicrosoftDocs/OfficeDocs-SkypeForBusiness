...
> [!Note]
> If you want to enable or disable sending emails in Microsoft Teams, see [Enable or disable sending emails when Audio Conferencing settings change in Microsoft Teams](https://docs.microsoft.com/MicrosoftTeams/enable-or-disable-sending-emails-when-their-settings-change).
