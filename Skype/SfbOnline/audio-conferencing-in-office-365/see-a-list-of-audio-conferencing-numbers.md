...
> [!NOTE]
> For information about Audio Conferencing numbers in Microsoft Teams, see [See a list of Audio Conferencing numbers in Microsoft Teams](https://docs.microsoft.com/en-us/MicrosoftTeams/see-a-list-of-audio-conferencing-numbers-in-teams).
