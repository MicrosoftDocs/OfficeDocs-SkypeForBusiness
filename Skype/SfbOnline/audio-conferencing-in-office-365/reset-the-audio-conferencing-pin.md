...
- The email by default will be set to the Microsoft 365 primary SMTP address of the user. You can send an email to a non-Microsoft 365 address, such as a Hotmail or MSN email address. You can override the default email address by using Windows PowerShell. This is useful if the users don't have an Exchange mailbox in Microsoft 365.
