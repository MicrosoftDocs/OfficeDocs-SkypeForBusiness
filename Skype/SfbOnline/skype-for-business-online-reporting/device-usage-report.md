...
This report, along with the other Skype for Business reports, gives you details on the types of clients/devices that are used across your organization. These details are helpful when you're investigating, planning, and making other business decisions for your organization.
...
2. On the **Usage** page, select **Skype for Business device usage** on the **Select a report list** on the left. Or, select the **Skype for Business activity** widget and then select **Skype for Business device usage** on the **Skype for Business activity** list.
...
***
![Number 1.](../images/sfbcallout1.png)<br/>The **Skype for Business device usage** report can be viewed for trends over the last 7 days, 30 days, 90 days, or 180 days. However, if you select into a particular day in the report, the table (see number 7) will show data for 30 days, up to the date (see number 2) for when the report was generated.
...
***
![Number 7.](../images/sfbcallout7.png)<br/>The table shows you a breakdown of the all conferencing activities per user. This shows all users that have Skype for Business assigned to them and their conferencing activities. You can add more columns to the table.
...
*    **Android phone** is selected if the user is has the Skype for Business client app installed on an Android phone and is using it.
