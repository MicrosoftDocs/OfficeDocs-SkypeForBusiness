...
|Get new service phone numbers that aren't listed in the Skype for Business admin center. <br/> |Download this form [New phone number request for Spain (service numbers) (v.1.2) (es-es)](New-phone-number-request-for-spain-(service-numbers)-(v.1.2)-(es-es).pdf).<br/> Fill it out and [send it to us](mailto:ptneu@microsoft.com).
