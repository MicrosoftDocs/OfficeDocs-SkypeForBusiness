...
|You need to get phone numbers transferred to us.  <br/> | Download [Letter of Authorization (LOA) for Germany (geographic numbers) (v.1.0)(de-de)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-germany-(geographic-numbers)-(v.1.0)-(de-de).pdf). <br/>  Then fill it out and [send it to us](mailto:ptneu@microsoft.com).  <br/> |
=======
...
|You need to get phone numbers transferred to us.  <br/> | Download [Letter of Authorization (LOA) for Germany (geographic numbers) (v.1.0)(de-de)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-germany-(geographic-numbers)-(v.1.0)-(de-de).pdf) <br/>  Fill it out and [send it to us](mailto:ptneu@microsoft.com).  <br/> |
>>>>>>> master
