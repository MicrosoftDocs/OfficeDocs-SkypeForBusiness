...
|Get new service phone numbers that aren't listed in the Skype for Business admin center. <br/> |For service numbers inside of the United States, please [download this form](../../downloads/new-number-request-forms/new-phone-number-request-for-numbers-inside-the-u.s.-(service-numbers)-(v.1.0)-(en-us), fill it out and [send it to us](mailto:ptn@microsoft.com).
