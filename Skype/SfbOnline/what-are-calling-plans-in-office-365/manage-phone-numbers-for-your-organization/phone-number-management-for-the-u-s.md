...
|Get new service phone numbers that aren't listed in the Skype for Business admin center. <br/> |For service numbers inside of the United States, please [download this form](new-phone-number-request-for-the-u.s.-(service-numbers)-(v.1)-(en-us).pdf), fill it out and [send it to us](mailto:ptn@microsoft.com).
