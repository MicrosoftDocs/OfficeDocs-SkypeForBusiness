...
[]
Each record represents one peer-to-peer session, which could be a VoIP-VoIP phone call, two-party IM session, or other type of session. You can perform a table join with the  [Media table](media-table.md) to find the details of each media involved in this session.
...
|**User1Id** <br/> |int  <br/> |Foreign  <br/> |ID of one user in the session. See the  [Users table](users-table.md) for more information. <br/> |
|**User2Id** <br/> |int  <br/> |Foreign  <br/> |ID of the other user in the session. See the  [Users table](users-table.md) for more information. <br/> |
...
|**TargetUserId** <br/> |int  <br/> |Foreign  <br/> |The original To user URI in the SIP request. see the  [Users table](users-table.md) for more information. <br/> |
|**SessionStartedById** <br/> |int  <br/> |Foreign  <br/> |ID of the user who started the session. See the  [Users table](users-table.md) for more information. <br/> |
...
|**User1ClientVerId** <br/> |int  <br/> |Foreign  <br/> |Client version used by User1. See the  [ClientVersions table in Skype for Business Server 2015](clientversions-table-in-skype-for-business-server-2015.md) for more information. <br/> |
|**User2ClientVerId** <br/> |int  <br/> |Foreign  <br/> |Client version used by User2. See the  [ClientVersions table in Skype for Business Server 2015](clientversions-table-in-skype-for-business-server-2015.md) for more information. <br/> |
|**User1EdgeServerid** <br/> |int  <br/> |Foreign  <br/> |Edge Server used by User1. See the  [EdgeServers table in Skype for Business Server 2015](edgeservers-table-in-skype-for-business-server-2015.md) for more information. <br/> |
|**User2EdgeServerid** <br/> |int  <br/> |Foreign  <br/> |Edge Server used by User2. See the  [EdgeServers table in Skype for Business Server 2015](edgeservers-table-in-skype-for-business-server-2015.md) for more information. <br/> |
