...
You can access the Peer-to-Peer IM Report only by opening the  [Peer-to-Peer Activity Summary Report in Skype for Business Server 2015](peer-to-peer-activity-summary-report-in-skype-for-business-server-2015.md) and then clicking either of the following metrics:
