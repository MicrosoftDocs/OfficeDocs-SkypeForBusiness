...
|:-----|:-----|:-----|:-----|
|**ConferenceDateTime** <br/> |datetime  <br/> |Primary  <br/> |Referenced from the  [Session table](session-table.md).  <br/> |
|**SessionSeq** <br/> |int  <br/> |Primary  <br/> |Referenced from the  [Session table](session-table.md).  <br/> |
...
|**CallerIPAddr** <br/> |int  <br/> |Foreign  <br/> |IP Address of the caller. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
|**CallerPort** <br/> |int  <br/> | <br/> | Port used by the caller. <br/> |
|**CallerSubnet** <br/> |int  <br/> | Foreign <br/> |The subnet of the caller. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
|**CallerInside** <br/> |bit  <br/> | <br/> |1 means caller is inside the enterprise network, 0 means the caller is outside the network.  <br/> |
|**CallerMacAddress** <br/> |int  <br/> |Foreign  <br/> |Caller's mac address, referenced from  [MacAddress table](macaddress-table.md).  <br/> |
|**CallerRelayIPAddr** <br/> |int  <br/> |Foreign  <br/> |IP Address of the A/V Edge service used by the caller. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
|**CallerRelayPort** <br/> |int  <br/> | <br/> |Port used on the A/V Edge service by the caller.  <br/> |
|**CallerCaptureDev** <br/> |int  <br/> |Foreign  <br/> |Capture device used by the caller. Referenced from the  [Device table](device-table.md).  <br/> |
|**CallerRenderDev** <br/> |int  <br/> |Foreign  <br/> |Render device used by caller. Referenced from the  [Device table](device-table.md).  <br/> |
|**CallerCaptureDevDriver** <br/> |int  <br/> |Foreign  <br/> |Driver for the caller's capture device, referenced from the  [DeviceDriver table](devicedriver-table.md).  <br/> |
|**CallerRenderDevDriver** <br/> |int  <br/> |Foreign  <br/> |Driver for the caller's render device, referenced from the  [DeviceDriver table](devicedriver-table.md).  <br/> |
|**CallerNetworkConnectionType** <br/> |tinyint  <br/> |Foreign  <br/> |Indicates how the caller connected to the network. Values are obtained from the  [NetworkConnectionDetail table](networkconnectiondetail-table.md). Typical values are 0 for a wired connection' 1 for a WiFi connection; and 3 for an Ethernet connection.  <br/> |
|**CallerBssid** <br/> |int  <br/> |Foreign  <br/> |Caller's BSSID if wireless is used. Referenced from  [MacAddress table](macaddress-table.md).  <br/> |
...
|**CalleeIPAddr** <br/> |int  <br/> |Foreign  <br/> |IP Address of the call receiver. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
|**CalleePort** <br/> |bit  <br/> ||Port used by the call receiver.  <br/> |
|**CalleeSubnet** <br/> |int  <br/> |Foreign  <br/> |Subnet of callee. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
...
|**CalleeMacAddress** <br/> |int  <br/> |Foreign  <br/> |Callee Mac address. Referenced from the  [MacAddress table](macaddress-table.md).  <br/> |
|**CalleeRelayIPAddr** <br/> |int  <br/> |Foreign  <br/> |IP Address of the A/V Edge service used by the call receiver. See the  [IPAddress table](ipaddress-table.md) for more information. <br/> |
|**CalleeRelayPort** <br/> |int  <br/> | <br/> |Port used on the A/V Edge Service by the call receiver.  <br/> |
|**CalleeCaptureDev** <br/> |int  <br/> |foreign  <br/> |Capture device used by the call receiver. Referenced from the  [Device table](device-table.md).  <br/> |
|**CalleeRenderDev** <br/> |int  <br/> |Foreign  <br/> |Render device used by the call receiver. Referenced from the  [Device table](device-table.md).  <br/> |
|**CalleeCaptureDevDriver** <br/> |int  <br/> |Foreign  <br/> |Driver for the call receiver's capture device. Referenced from  [DeviceDriver table](devicedriver-table.md).  <br/> |
|**CalleeRenderDevDriver** <br/> |varchar(256)  <br/> |Foreign  <br/> |Driver for the call receiver's render device. Referenced from  [DeviceDriver table](devicedriver-table.md).  <br/> |
|**CalleeNetworkConnectionType** <br/> |tinyint  <br/> |Foreign  <br/> |Indicates how the callee connected to the network. Values are obtained from the  [NetworkConnectionDetail table](networkconnectiondetail-table.md). Typical values are 0 for a wired connection' 1 for a WiFi connection; and 3 for an Ethernet connection.  <br/> |
|**CalleeBssid** <br/> |int  <br/> |Foreign  <br/> |Callee's BSSID if wireless is used. Referenced from  [MacAddress table](macaddress-table.md).  <br/> |
...
|**AppliedBandwidthSourceKey** <br/> |smallint  <br/> ||This is the source of the bandwidth cap being imposed. It describes where the bandwidth limit is coming from ("Policy Server", "TURN Server", "Modality", and so on). Referenced from the  [AppliedBandwidthSource table](appliedbandwidthsource-table.md).  <br/> |
