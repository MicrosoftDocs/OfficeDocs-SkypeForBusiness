...
|<CustomThemeImageUrl>  <br/> |String 3 <br/> ||Required if using a custom theme, otherwise optional. See the  [Custom Theme Images](manage-a-skype-room-systems-v2-console-settings-remotely-with-an-xml-configurati.md#Themes) section below for more details on the custom theme image. <br/> |
