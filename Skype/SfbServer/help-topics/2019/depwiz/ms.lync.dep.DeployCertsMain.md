...
To assign a certificate that hasn't been assigned yet, select **Assign**.
  
To remove a certificate that you have previously assigned, select **Remove**.
