---
title: "Skype for Business Server 2015 Voice Traffic (planning tool)"
ms.reviewer: 
ms.author: v-cichur
author: cichur
manager: serdars
...
description: "The planning tool uses information about user traffic to determining the number of ports to use in the deployment. This then determines the number of Mediation Servers and gateways that will be required."
---

# Skype for Business Server 2015 Voice Traffic (planning tool)
