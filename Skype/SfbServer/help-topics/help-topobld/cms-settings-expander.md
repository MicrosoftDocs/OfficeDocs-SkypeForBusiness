...
For details about moving the Central Management Server store, see [Move-CsManagementServer](../../manage/management-shell/move-csmanagementserver.md) in the Windows PowerShell cmdlet reference.
