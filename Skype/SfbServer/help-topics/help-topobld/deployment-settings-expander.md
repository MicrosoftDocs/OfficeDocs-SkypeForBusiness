...
For details about moving the Central Management store, see [Move-CsManagementServer](../../manage/management-shell/move-csmanagementserver.md) in the Windows PowerShell cmdlet reference.
