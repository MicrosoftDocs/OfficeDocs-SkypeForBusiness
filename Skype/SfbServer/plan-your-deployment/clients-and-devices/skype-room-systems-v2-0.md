...
- In-app user selection of meeting room audio and video USB devices #x2780;
...
- Integrated room console status reporting for customers using Microsoft Operations Management Suite (see [Plan Skype Room Systems v2 management with OMS](oms-management.md)) #x2780;
