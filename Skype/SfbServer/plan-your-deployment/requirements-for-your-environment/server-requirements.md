...
If it's not on this list, it won't work properly, please don't try it for new installs of Skype for Business Server 2015.  Note:  In-place upgrade of the OS is not supported with Lync Server 2013.  You must deploy a separate pool and migrate users to the new pool with a difference OS.
