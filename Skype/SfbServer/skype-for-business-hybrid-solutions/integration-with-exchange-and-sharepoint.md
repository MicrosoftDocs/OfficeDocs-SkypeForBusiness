...
|Meeting delegation  <br/> |Supported only when both users are homed online in the same forest, or both are homed on-premises. For more information, see [Skype for Business hybrid solutions](/skypeforbusiness/hybrid/configure-hybrid-connectivity).
 <br/> |
