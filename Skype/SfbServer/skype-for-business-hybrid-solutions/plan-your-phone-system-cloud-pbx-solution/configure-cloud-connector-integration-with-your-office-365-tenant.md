...
2. Start a tenant Azure AD remove PowerShell session using your global or user administrator admin credentials, and then run the following cmdlet to set the department for the Azure AD user account configured in step 1 to "HybridMediationServer":
