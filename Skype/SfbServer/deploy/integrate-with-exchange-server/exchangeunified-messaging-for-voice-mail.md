...
After you have enabled his mailbox, the user kenmyer@litwareinc.com should be able to use Exchange unified messaging. You can verify that the user can connect to Exchange UM by running the [Test-CsExUMConnectivity](../../manage/management-shell/test-csexumconnectivity.md) cmdlet from within the Skype for Business Server Management Shell:
...
If you have a second user who has been enabled for unified messaging you can use the [Test-CsExUMVoiceMail](../../manage/management-shell/test-csexumvoicemail.md) cmdlet to verify that this second user can leave a voicemail message for the first user.
