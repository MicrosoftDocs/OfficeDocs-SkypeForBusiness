...
In hybrid environments the account used for Microsoft Teams Rooms must have password sync enabled in AADsync because Microsoft Teams Rooms authentication requires 0ffice 365 authentication.
