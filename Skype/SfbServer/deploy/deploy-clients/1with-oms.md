...
This article discusses how to set up and deploy integrated, end-to-end management of Skype Room Systems version 2 (v2) devices by using Microsoft Operations Management Suite.
...
1.  Download the dashboard and extract the zip file.
2.  Sign in to the [Microsoft Operations Management Suite portal](http://aka.ms/omsportal).
3.  Open **View Designer**.
4.  Select **Import**, and then select the **Skype Room Systems.omsview** file.
5.  Select **Save**.

### Create a Skype Room Systems v2 dashboard manually

Alternatively, you can create your own dashboard and add only the tiles that you like to monitor.
...
5.  Define the **Second Tile**:<br>
    **Legend:** Active devices that sent a heartbeat within the last 15 minutes<br>
...
3.  Define the **General** properties:<br>
    **Group Title:** Heartbeat<br>
    **New Group:** Selected
4.  Define the **Tile** properties:<br>
    **Legend:** All active devices (Skype Room System application heartbeat sent in the last 15 minutes)<br>
    **Tile Query:** ```Event | where EventLog == "Skype Room System" and SRSOperationName_CF == "Heartbeat" and TimeGenerated > ago(15m) | summarize AggregatedValue = count() by Computer | count```
5.  Define the **List** properties:<br>
    **List Query:** ```Event | where EventLog == "Skype Room System" and SRSOperationName_CF == "Heartbeat" and TimeGenerated > ago(15m) | summarize TimeGenerated = max(TimeGenerated) by Computer | order by TimeGenerated```
...
3.  Define the **Tile** properties:<br>
    **Legend:** Devices no longer sending heartbeat messages<br>
...
2.  Define the **General** properties:<br>
    ...
    **New Group:** Selected
3.  Define the **Tile** properties:<br>
    **Legend:** Devices that have had a hardware error in the last hour<br>
...
2.  Define the **General** properties:<br>
    **Group Title:** Application<br>
    **New Group:** Selected
3.  Define the **Header** properties:<br>
    **Title:** Skype Room Systems application versions<br>
    **Subtitle:** Number of devices running a specific application version
...
2.  Define the **General** properties.<br>
    ...
    **New Group:** Not Selected
3.  Define the **Tile** properties.<br>
    **Legend:** Devices that have had a Skype Room Systems application error in the last hour<br>
...
2.  Define the **General** properties.<br>
    ...
    **New Group:** Not Selected
3.  Define the **Tile** properties.<br>
    **Legend:** Skype Room Systems devices that have been restarted in the last 24 hours, and number of restarts<br>
