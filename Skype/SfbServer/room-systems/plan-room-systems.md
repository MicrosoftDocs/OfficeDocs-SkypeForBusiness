...
You can procure these components as preinstalled bundles from a number of vendors, or you can purchase the supported components individually by following the [requirements documented in this article](https://docs.microsoft.com/en-gb/skypeforbusiness/plan-your-deployment/clients-and-devices/requirements). 
...
For guidance for the type of system and peripheral devices by room type and size, see the [Skype Room Systems v2 requirements](https://docs.microsoft.com/en-gb/skypeforbusiness/plan-your-deployment/clients-and-devices/requirements) article. 
...
You can acquire devices from a number of partners who are listed in the [requirements article](https://docs.microsoft.com/en-gb/skypeforbusiness/plan-your-deployment/clients-and-devices/requirements). Please visit the device partners’ websites to learn more about these solutions and procurement options. 
