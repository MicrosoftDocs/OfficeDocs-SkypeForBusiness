...
- Skype for Business 2016 Click to Run Require the [April 2018](https://docs.microsoft.com/en-us/officeupdates/release-notes-office365-proplus) Updates: 
    - Monthly and Semi-Annual Targeted, 16.0<span></span>.9126.2152 and higher
    - Semi-Annual and Deferred Channel, 16.0<span></span>.8431.2242 and higher
...
1. Install Prerequisites Software for Skype for Business Server 2015: [https://technet.microsoft.com/en-us/library/dn933900.aspx](https://technet.microsoft.com/en-us/library/dn933900.aspx)
2. Install .NET 4.7: 
    ...
    - Download: https://www.microsoft.com/en-us/download/details.aspx?id=5516</br>**This download is no longer available.**
