...
> [!NOTE]
> The New-CsQoEConfiguration cmdlet includes additional options not available in Skype for Business Server Control Panel. For more information, see the [New-CsQoEConfiguration](../../manage/management-shell/new-csqoeconfiguration.md) help topic.
...
For more information, see the help topic for the [New-CsQoEConfiguration](../../manage/management-shell/new-csqoeconfiguration.md) cmdlet.
