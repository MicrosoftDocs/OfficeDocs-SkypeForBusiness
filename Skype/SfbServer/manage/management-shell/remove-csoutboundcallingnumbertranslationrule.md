 ...
 **Skype for Business Server Control Panel:** To remove an outbound calling number translation rule using the Skype for Business Server Control Panel, click **Voice Routing** and then click **Trunk Configuration**. Double-click the appropriate item in the **Name** column and then, in the **Edit Trunk Configuration** dialog box, scroll down to the section labeled **Calling number translation roles**. Select the rule to be deleted, and then click **Remove**.
