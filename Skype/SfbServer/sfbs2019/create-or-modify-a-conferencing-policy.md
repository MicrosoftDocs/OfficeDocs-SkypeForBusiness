---
title: "Create or modify a conferencing policy in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "Follow these steps to create a user-level or a site-level conferencing policy. For details about how to assign a user-level policy to a user, see Assign a per-user conferencing policy in Lync Server 2013. For a list of all available conferencing policy settings, see Conferencing policy settings reference for Lync Server 2013."
---

# Create or modify a conferencing policy in Lync Server 2013
[]
Follow these steps to create a user-level or a site-level conferencing policy. For details about how to assign a user-level policy to a user, see [Assign a per-user conferencing policy in Lync Server 2013](assign-a-per-user-conferencing-policy.md). For a list of all available conferencing policy settings, see [Conferencing policy settings reference for Lync Server 2013](conferencing-policy-settings-reference.md).
