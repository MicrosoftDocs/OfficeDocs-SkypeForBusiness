---
title: "Overview of monitoring in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "In Microsoft Lync Server 2013, monitoring is used to collect usage information and Quality of Experience (QoE) data about the communication sessions that your users are involved in. A session is a generic term that covers a user's connection to a:"
---
...
For more information see the topic [Deploying monitoring in Lync Server 2013](deploying-monitoring.md) in the Lync Server 2013 2013 deployment guide. 
