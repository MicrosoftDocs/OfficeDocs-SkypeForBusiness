...
| _AllowExchangeConnectivity_ <br/> |Optional  <br/> |System.Boolean  <br/> |When set to True (the default value) users will be allowed to connect to Microsoft Exchange Server 2013 by using their mobile device.  <br/> |
...
| _EnableMobility_ <br/> |Optional  <br/> |System.Boolean  <br/> |When set to True, users are allowed to use Lync Mobile.  <br/> |
