---
title: "How do I implement SIP trunking in Lync Server 2013?"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 12/9/2016
...
description: "In this articleCentralized vs. Distributed SIP TrunkingSupported SIP Trunking Connection TypesBandwidth RequirementsCodec SupportInternet Telephony Service Provider"
---
...
[Centralized vs. Distributed SIP Trunking](#sectionSection0)
  
[Supported SIP Trunking Connection Types](#sectionSection1)
  
[Bandwidth Requirements](#sectionSection2)
  
[Codec Support](#sectionSection3)
  
[Internet Telephony Service Provider](#sectionSection4)
...
For details about Mediation Servers, see [Mediation Server component in Lync Server 2013](mediation-server-component.md). 
...
> [!NOTE]
> For details about distributed SIP trunking, see [Branch site SIP trunking in Lync Server 2013](branch-site-sip-trunking.md). 
