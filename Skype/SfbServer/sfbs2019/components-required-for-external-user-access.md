---
title: "Components required for external user access in Lync Server 2013"
ms.author: heidip
...
description: "In this articleEdge ServersReverse ProxyFirewallDirector"
---
...
[Edge Servers](#sectionSection0)
  
[Reverse Proxy](#sectionSection1)
  
[Firewall](#sectionSection2)
  
[Director](#sectionSection3)
...
For additional information related to reverse proxies and the requirements that reverse proxies must meet, see the details in [Configuration requirements for reverse proxy in Lync Server 2013](configuration-requirements-for-reverse-proxy.md).
  
> [!NOTE]
> External users do not need a virtual private network (VPN) connection to your organization in order to participate in communications using Lync Server 2013. If you have implemented VPN technology in your organization and your users use the VPN for Lync, media traffic (such as video conferencing) can be adversely affected. You should consider providing a means for media traffic to connect to the AV Edge service directly and bypass the VPN. For details, see the NextHop Blog article, "Enabling Lync Media to Bypass a VPN Tunnel," at [https://go.microsoft.com/fwlink/p/?LinkId=256532](https://go.microsoft.com/fwlink/p/?LinkId=256532). 
