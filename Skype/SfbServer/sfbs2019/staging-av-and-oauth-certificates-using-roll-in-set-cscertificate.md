---
title: "Staging AV and OAuth certificates in Lync Server 2013 using -Roll in Set-CsCertificate"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "Audio/Video (A/V) communications is a key component of Microsoft Lync Server 2013. Features such as application sharing and audio and video conferencing rely on the certificates assigned to the A/V Edge service, specifically the A/V Authentication service."
---
