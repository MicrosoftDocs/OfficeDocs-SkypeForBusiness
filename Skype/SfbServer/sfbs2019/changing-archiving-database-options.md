---
title: "Changing Archiving database options in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "If you deploy Archiving using SQL Server storage for archiving storage for any of your users, you can make the following database storage changes:"
---
...
8. To save the configuration, click **OK**.
    ...
    > [!IMPORTANT]
    > The changes you make in Topology Builder do not take effect until you publish the new topology. For details, see [Publishing the updated topology to add Archiving databases in Lync Server 2013](publishing-the-updated-topology-to-add-archiving-databases.md) in the Deployment documentation. 
