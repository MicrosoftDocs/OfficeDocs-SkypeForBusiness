---
title: "Migrate response groups [OCS 2007 R2 to W15]"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
6. Provide users with the updated URL that agents need to sign into and out of their response groups.
    ...
    > [!NOTE]
    > The URL is typically https://webpoolFQDN/RgsClients/Tab.aspx, where  _webpoolFQDN_ is the fully qualified domain name (FQDN) of the web pool that is associated with the pool that you just migrated to Lync Server 2013. 
