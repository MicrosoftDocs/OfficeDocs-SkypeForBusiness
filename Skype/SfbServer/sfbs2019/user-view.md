---
title: "User view in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
|TenantKey  <br/> |uniqueidentifier  <br/> |Tenant of user. See the [Tenants table in Lync Server 2013](tenants-table.md) for more information.  <br/> |
|UriType  <br/> |nvarchar(256)  <br/> |Type of user URI. See the [UriTypes table in Lync Server 2013](uritypes-table.md) for more information.  <br/> |
