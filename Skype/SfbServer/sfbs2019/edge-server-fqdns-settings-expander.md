...
description: "To edit or specify External Settings for the Edge Servers, you first must determine if you will use separate IP addresses for Session Initiation Protocol (SIP) access, the Lync Server 2013 Web Conferencing Edge service, and the Lync Server 2013 Audio/Video Edge service."
---

# Edge Server FQDNs Settings Expander
[]
To edit or specify **External Settings** for the Edge Servers, you first must determine if you will use separate IP addresses for Session Initiation Protocol (SIP) access, the Lync Server 2013 Web Conferencing Edge service, and the Lync Server 2013 Audio/Video Edge service. 
...
For details about defining and configuring the settings for the Edge services, see [Define your edge topology in Lync Server 2013](define-your-edge-topology.md).
