---
title: "Server Performance Report in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "In this articleAccessing the Server Performance ReportMaking the Best Use of the Server Performance ReportFiltersMetrics"
---
...
[Accessing the Server Performance Report](#sectionSection0)
  
[Making the Best Use of the Server Performance Report](#sectionSection1)
...
The Server Performance Report is accessed from the Monitoring Reports home page. You can drill down to the [Call List Report in Lync Server 2013](call-list-report.md) by clicking either of the following metrics: 
