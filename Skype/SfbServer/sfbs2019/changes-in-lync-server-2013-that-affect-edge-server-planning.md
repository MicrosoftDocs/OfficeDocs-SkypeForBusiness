---
title: "Changes in Lync Server 2013 that affect Edge Server planning"
ms.author: heidip
...
description: "In this articleSupport for IPv6 AddressingSupport for Extensible Messaging and Presence Protocol (XMPP) DeploymentSupport for Rolling Audio/Video Authentication and Server to Server Authentication CertificatesReduced Reliance on Cookie-based AffinityAutoDiscover EnhancementsServices for Mobile ClientsDirector Role is Optional"
---
...
[Support for IPv6 Addressing](#sectionSection0)
  
[Support for Extensible Messaging and Presence Protocol (XMPP) Deployment](#sectionSection1)
  
[Support for Rolling Audio/Video Authentication and Server to Server Authentication Certificates](#sectionSection2)
  
[Reduced Reliance on Cookie-based Affinity](#sectionSection3)
  
[AutoDiscover Enhancements](#sectionSection4)
  
[Services for Mobile Clients](#sectionSection5)
  
[Director Role is Optional](#sectionSection6)
...
For details about cookie-based affinity in Lync Server 2013, see [Components required for external user access in Lync Server 2013](components-required-for-external-user-access.md).
