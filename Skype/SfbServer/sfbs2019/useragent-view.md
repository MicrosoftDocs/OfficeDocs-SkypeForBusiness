---
title: "UserAgent view in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
|UAType  <br/> |smallint  <br/> |Type of user agent. See the [UserAgent table in Lync Server 2013](useragent-table.md) for more details.  <br/> |
