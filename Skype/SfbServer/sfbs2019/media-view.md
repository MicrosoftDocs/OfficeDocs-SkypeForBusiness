---
title: "Media view in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
The Media view contains all of the columns in the [SessionDetails view in Lync Server 2013](sessiondetails-view.md) in addition the ones listed below. 
  
|**Column**|**Data Type**|**Details**|
|:-----|:-----|:-----|
|**Media** <br/> |nvarchar(256)  <br/> |Media type. See the [MediaList table in Lync Server 2013](medialist-table.md) for more information.  <br/> |
