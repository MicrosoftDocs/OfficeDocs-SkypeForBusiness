---
title: "Assign a per-user Persistent Chat policy in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "You can assign a per-user persistent chat policy with either Lync Server 2013 Control Panel or Lync Server 2013 Management Shell. For details on creating user policies for Persistent Chat Server, see Create a user policy for Persistent Chat in Lync Server 2013."
---

# Assign a per-user Persistent Chat policy in Lync Server 2013
[]
You can assign a per-user persistent chat policy with either Lync Server 2013 Control Panel or Lync Server 2013 Management Shell. For details on creating user policies for Persistent Chat Server, see [Create a user policy for Persistent Chat in Lync Server 2013](create-a-user-policy-for-persistent-chat.md).
