---
title: "Configure the unassigned number table in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "In Lync Server 2013, you can specify what happens to incoming calls to phone numbers that are valid for your organization, but are not assigned to a user or phone. Callers can hear a message, or can be routed to another destination, or both."
---
...
[Create or modify an unassigned number range in Lync Server 2013](create-or-modify-an-unassigned-number-range.md)[Create an announcement in Lync Server 2013](create-an-announcement.md)
