---
title: "Peer-to-Peer Activity Diagnostic Report in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "In this articleAccessing the Peer-to-Peer Activity Diagnostic ReportMaking the Best Use of the Peer-to-Peer Activity Diagnostic ReportFiltersMetrics (per modality)"
---
...
[Accessing the Peer-to-Peer Activity Diagnostic Report](#sectionSection0)
  
[Making the Best Use of the Peer-to-Peer Activity Diagnostic Report](#sectionSection1)
  
[Filters](#sectionSection2)
  
[Metrics (per modality)](#sectionSection3)
...
The Peer-to-Peer Diagnostic Report is accessed from the Monitoring Reports home page. You can access the [Failure Distribution Report in Lync Server 2013](failure-distribution-report.md) by clicking either of the following metrics: 
