---
title: "Key security features in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 12/9/2016
...
description: "Lync Server 2013 includes several security features, including server-to-server authentication, role-based access control, and centralized storage of configuration data."
---
...
[Key Security Features in Lync Server 2013](#sectionSection0)
  
[Network Address Translation (NAT)](#sectionSection1)
  
[Simplified Certificates for Edge Servers](#sectionSection2)
  
[Trustworthy Computing Security Development Lifecycle (SDL)](#sectionSection3)
...
For details about these tools, see [Planning for Lync Server 2013](planning.md).
...
Lync Server 2013 is designed and developed in compliance with the Microsoft Trustworthy Computing Security Development Lifecycle (SDL), which is described at [https://go.microsoft.com/fwlink/?linkid=68761](https://go.microsoft.com/fwlink/?linkid=68761).
