...
description: "To assign a certificate to Lync Server 2013, select a certificate from the local certificate store. Click Next to continue."
---

# Certificate List
[]
To assign a certificate to Lync Server 2013, select a certificate from the local certificate store. Click **Next** to continue. 
...
![Online Certificate Request Status page](media/FE-Cert-Wizard-Step-15a.jpg)
