---
title: "VideoStreamDetail view in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
|MediaLineLabel  <br/> |tinyint  <br/> |Referenced from the [MediaLine table in Lync Server 2013](medialine-table.md).  <br/> |
...
|ConnectivityIce  <br/> |tinyint  <br/> |Information about media path, such as direct or relayed. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
...
|PayloadDescription  <br/> |int  <br/> |Audio codec used for the call, referenced from the [PayloadDescription table in Lync Server 2013](payloaddescription-table.md).  <br/> |
