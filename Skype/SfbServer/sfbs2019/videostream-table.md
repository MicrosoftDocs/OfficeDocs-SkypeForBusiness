---
title: "VideoStream table in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
|**SessionSeq** <br/> |int  <br/> |Primary  <br/> |R Referenced from the [MediaLine table in Lync Server 2013](medialine-table.md).  <br/> |
...
|**VideoPayloadDescription** <br/> |smallint  <br/> |Foreign, Primary  <br/> |Payload description. See the [PayloadDescription table in Lync Server 2013](payloaddescription-table.md) for more information.  <br/> |
...
|**SendCodecTypes** <br/> |smallint  <br/> |Foreign  <br/> |Type of video codecs used by the sender. See the [CodecDescription table in Lync Server 2013](codecdescription-table.md) for more information.  <br/> This column was introduced in Microsoft Lync Server 2013.  <br/> |
...
|**RecvCodecTypes** <br/> |smallint  <br/> |Foreign  <br/> |Video codes used by the receiver. See the [CodecDescription table in Lync Server 2013](codecdescription-table.md) for more information.  <br/> This column was introduced in Microsoft Lync Server 2013.  <br/> |
