...
![Scaled Consolidated Edge](media/Plan_LyncServer_Edge_NetPerimeter_ScaledConsolidatedEdgeDNSLB.jpg)
...
|A/V/RTP/TCP/50,000-59,999  <br/> |Edge Server A/V Edge service public IP address  <br/> |Any  <br/> |Required for federating with partners running Office Communications Server 2007, Office Communications Server 2007 R2, Lync Server 2010 and Lync Server 2013.  <br/> |
...
|:-----|:-----|:-----|:-----|
|XMPP/MTLS/TCP/23456  <br/> |Any (can be defined as Front End Server address, or Front End pool IP address running the XMPP Gateway service)  <br/> |Edge Server internal interface  <br/> |Outbound XMPP traffic from XMPP Gateway service running on Front End Server or Front End pool  <br/> |
