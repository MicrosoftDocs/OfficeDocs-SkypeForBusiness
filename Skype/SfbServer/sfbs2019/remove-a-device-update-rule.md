---
title: "Remove a Device Update rule in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "Removing a device update rule takes it permanently out of the device update queue."
---
...
Removing a rule is different from uninstalling an update from the devices in your deployment or from your test devices. To uninstall an approved update from your deployment, you  *restore*  the device update rule. For details, see [Restore a Device Update rule in Lync Server 2013](restore-a-device-update-rule.md). To uninstall an update you haven't approved from your test devices, you  *reset*  it. For details, see [Reset a Device Update rule in Lync Server 2013](reset-a-device-update-rule.md).
