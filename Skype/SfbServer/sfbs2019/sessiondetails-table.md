---
title: "SessionDetails table in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "Each record represents one peer-to-peer session, which could be a VoIP-VoIP phone call, two-party IM session, or other type of session. You can perform a table join with the Media table in Lync Server 2013 to find the details of each media involved in this session."
---

# SessionDetails table in Lync Server 2013
[]
Each record represents one peer-to-peer session, which could be a VoIP-VoIP phone call, two-party IM session, or other type of session. You can perform a table join with the [Media table in Lync Server 2013](media-table.md) to find the details of each media involved in this session. 
...
|**User1Id** <br/> |int  <br/> |Foreign  <br/> |ID of one user in the session. See the [Users table in Lync Server 2013](users-table.md) for more information.  <br/> |
|**User2Id** <br/> |int  <br/> |Foreign  <br/> |ID of the other user in the session. See the [Users table in Lync Server 2013](users-table.md) for more information.  <br/> |
...
|**TargetUserId** <br/> |int  <br/> |Foreign  <br/> |The original To user URI in the SIP request. see the [Users table in Lync Server 2013](users-table.md) for more information.  <br/> |
|**SessionStartedById** <br/> |int  <br/> |Foreign  <br/> |ID of the user who started the session. See the [Users table in Lync Server 2013](users-table.md) for more information.  <br/> |
...
|**User1ClientVerId** <br/> |int  <br/> |Foreign  <br/> |Client version used by User1. See the [ClientVersions table in Lync Server 2013](clientversions-table.md) for more information.  <br/> |
|**User2ClientVerId** <br/> |int  <br/> |Foreign  <br/> |Client version used by User2. See the [ClientVersions table in Lync Server 2013](clientversions-table.md) for more information.  <br/> |
|**User1EdgeServerid** <br/> |int  <br/> |Foreign  <br/> |Edge Server used by User1. See the [EdgeServers table in Lync Server 2013](edgeservers-table.md) for more information.  <br/> |
|**User2EdgeServerid** <br/> |int  <br/> |Foreign  <br/> |Edge Server used by User2. See the [EdgeServers table in Lync Server 2013](edgeservers-table.md) for more information.  <br/> |
...
|**CallPriority** <br/> |int  <br/> |Foreign  <br/> |Call priority. See the [CallPriorities table in Lync Server 2013](callpriorities-table.md) for more information.  <br/> |
