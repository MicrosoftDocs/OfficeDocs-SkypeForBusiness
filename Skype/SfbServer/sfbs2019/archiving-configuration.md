...
description: "You use Archiving configurations to control archiving options for your Lync Server 2013 deployment, including enabling and disabling the following options:"
---

# Archiving Configuration
[]
You use Archiving configurations to control archiving options for your Lync Server 2013 deployment, including enabling and disabling the following options:
...
- **Global configuration** The global configuration is created by default in all Lync Server 2013 deployments. You edit the global configuration, but you cannot delete this Archiving configuration. If you try to delete it, all options are reset to the defaults. 
...
> [!NOTE]
> Archiving configurations apply to users homed on Lync Server 2013 and, if you use Exchange to store archiving data in Microsoft Exchange, to users homed on Exchange 2013 but are implemented slightly differently for users homed on Exchange 2013. The differences are described in the next section. 
