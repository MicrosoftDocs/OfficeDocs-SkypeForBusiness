...
| _PassThru_ <br/> |Optional  <br/> |System.Management.Automation.SwitchParameter  <br/> |Enables you to pass a meeting room object through the pipeline that represents the meeting room being enabled for Lync Server. By default, the **Enable-CsMeetingRoom** cmdlet does not pass objects through the pipeline.  <br/> |
