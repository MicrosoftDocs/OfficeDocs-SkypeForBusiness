---
title: "System usage reports in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "The System Usage Reports provide system usage information based on call detail recording (CDR) data collected by the Lync Server."
---
...
- [User Registration Report in Lync Server 2013](user-registration-report.md)
...
- [Peer-to-Peer Activity Summary Report in Lync Server 2013](peer-to-peer-activity-summary-report.md)
...
- [Conference Summary Report in Lync Server 2013](conference-summary-report.md)
    
    Provides a summary of all conference activities. Conferences are sessions involving three or more people.
    
- [PSTN Conference Summary Report in Lync Server 2013](pstn-conference-summary-report.md)
...
- [Response Group Usage Report in Lync Server 2013](response-group-usage-report.md)
...
- [IP Phone Inventory Report in Lync Server 2013](ip-phone-inventory-report.md)
...
- [Call Admission Control Report in Lync Server 2013](call-admission-control-report.md)
