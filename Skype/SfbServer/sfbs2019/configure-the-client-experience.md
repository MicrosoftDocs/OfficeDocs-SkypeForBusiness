...
description: "Summary: This topic describes how to configure the client experience for Skype for Business client users in a Lync Server 2013 environment. You can configure the client experience only if you are running Lync Server 2013 with the December 2014 Cumulative Update (5.0.8308.857) or later installed. For information about updating Lync Server 2013, see Updates for Lync Server 2013 ."
---
...
[Configure the client experience](#sectionSection0)
  
[First launch client behaviors](#sectionSection1)
  
[Default client experiences](#sectionSection2)
  
[Create a Group Policy Object to modify the registry on a domain joined computer](#sectionSection3)
...
> [!IMPORTANT]
> If your organization has both Skype for Business Server 2015 and Lync Server 2013 deployed, the default client experience will differ depending on server versions and UI settings. When users launch Skype for Business for the first time, they will always see the Skype for Business user interface--even if you have selected the Lync user interface. After several minutes, users are asked to switch to Lync mode. For more information, see **First launch client behavior** later in this topic. 
...
|Lync Server 2010 or Lync Server 2013 (without patches)  <br/> |Default  <br/> |User asked to switch to Lync client experience (user cannot switch to Skype for Business later)  <br/> |
...
|
|
|**Server version**|**Skype UI setting**|**Client UI = Lync**|**Client UI = Skype for Business**|
|:-----|:-----|:-----|:-----|
|Skype for Business Server 2015  <br/> |True  <br/> |User asked to switch to Skype for Business  <br/> |Skype for Business  <br/> |
|Skype for Business Server 2015  <br/> |False  <br/> |Lync UI  <br/> |User asked to switch to Lync UI  <br/> |
...
|Lync Server 2010 or Lync Server 2013 (with correct patches)  <br/> |False  <br/> |Lync UI  <br/> |User asked to switch to Lync UI  <br/> |
|Lync Server 2010 or Lync Server 2013 (without patches)  <br/> |Default  <br/> |Lync mode (cannot switch to Skype for Business)  <br/> |Lync UI (cannot switch to Skype for Business)  <br/> |
