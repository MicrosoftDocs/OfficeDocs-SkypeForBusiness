---
title: "Supported Active Directory topologies in Lync Server 2013"
ms.author: heidip
...
description: "In this articleSingle Forest, Single DomainSingle Forest, Multiple DomainsSingle Forest, Multiple TreesMultiple Forests, Central ForestMultiple Forests, Resource ForestMultiple forests in a Lync resource forest topology with Exchange Online"
---
...
[Single Forest, Single Domain](#sectionSection0)
  
[Single Forest, Multiple Domains](#sectionSection1)
  
[Single Forest, Multiple Trees](#sectionSection2)
  
[Multiple Forests, Central Forest](#sectionSection3)
  
[Multiple Forests, Resource Forest](#sectionSection4)
  
[Multiple forests in a Lync resource forest topology with Exchange Online](#sectionSection5)
...
![Key to topology illustrations](media/AD_Topology_Labels.jpg)
...
![Single domain topology](media/Single_Domain_Topo.jpg)
...
![Single forest with multiple domains](media/Multiple_Domain_Topo.jpg)
...
![Single forest with multiple trees](media/Multiple_Tree_Forest_Topo.jpg)
...
![Central forest topology](media/Central_Forest_topology.jpg)
...
![Active Directory Resource Forest Topology](media/Support_OCS_AD_ResourceForestTopology.jpg)
