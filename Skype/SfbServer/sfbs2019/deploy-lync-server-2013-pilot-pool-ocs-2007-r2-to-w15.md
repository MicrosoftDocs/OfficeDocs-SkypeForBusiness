...
14. Update the **Administrative access URL**.
    ...
    For additional information on Simple URLs, see the topic [Edit or configure simple URLs in Lync Server 2013](edit-or-configure-simple-urls.md) in the Deployment documentation. 
