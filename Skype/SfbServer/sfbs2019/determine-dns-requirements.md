---
title: "Determine DNS requirements for Lync Server 2013"
ms.author: heidip
...
description: "In this articleHow Lync Clients Locate ServicesConfiguring Split-Brain DNS with Lync ServerAutomatic Configuration without Split-Brain DNSConfiguring the domain name system (DNS) for Disaster RecoveryDNS Load Balancing"
---
...
[How Lync Clients Locate Services](#sectionSection0)
  
[Configuring Split-Brain DNS with Lync Server](#sectionSection1)
  
[Automatic Configuration without Split-Brain DNS](#sectionSection2)
  
[Configuring the domain name system (DNS) for Disaster Recovery](#sectionSection3)
  
[DNS Load Balancing](#sectionSection4)
...
If you are configuring split-brain DNS, the following internal and external zone contain a summary of the types of DNS records required in each zone. For details, see [Scenarios for external user access in Lync Server 2013](scenarios-for-external-user-access.md).
