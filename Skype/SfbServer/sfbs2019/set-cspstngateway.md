...
| _Identity_ <br/> |Optional  <br/> |Microsoft.Rtc.Management.Xds.XdsGlobalRelativeIdentity  <br/> |Service identity of the PSTN gateway to be modified. For example: -Identity "PstnGateway:192.168.0.240".  <br/> Note that you can leave off the prefix "PstnGatewayServer:" when specifying a PSTN gateway. For example: -Identity "atl-cs-001.litwareinc.com".  <br/> |
| _MediationServer_ <br/> |Optional  <br/> |System.String  <br/> |Service identity of the Mediation Server to be associated with the PSTN gateway. For example: -MediationServer "MediationServer:atl-cs-001.litwareinc.com".  <br/> |
