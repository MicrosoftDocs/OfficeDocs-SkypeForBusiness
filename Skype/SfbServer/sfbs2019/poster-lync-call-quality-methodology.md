---
title: "Lync Call Quality Methodology in Lync Server 2013"
ms.author: jambirk
author: jambirk
manager: laurawi
ms.date: 12/9/2016
...
description: "In this articleWhat is Lync CQM?Prioritize: Run Trending QueriesPCDManaged/UnmanagedThe Server Plant RoadThe Last Mile RoadThe End Points RoadService ManagementBoard Game Rules"
---
...
[What is Lync CQM?](#WhatIs)
  
[Prioritize: Run Trending Queries](#Trending)
  
[PCD](#PCD)
  
[Managed/Unmanaged](#ManagedUn)
  
[The Server Plant Road](#ServRd)
  
[The Last Mile Road](#LastMi)
  
[The End Points Road](#EndPt)
  
[Service Management](#ServMgt)
  
[Board Game Rules](#BoardGm)
...
![Poster describing the CQM process](media/CQM-final.jpg)
...
- [What is Lync CQM?](poster-lync-call-quality-methodology.md#WhatIs)
    
- [Prioritize: Run Trending Queries](poster-lync-call-quality-methodology.md#Trending)
    
- [PCD](poster-lync-call-quality-methodology.md#PCD)
    
- [Managed/Unmanaged](poster-lync-call-quality-methodology.md#ManagedUn)
    
- [The Server Plant Road](poster-lync-call-quality-methodology.md#ServRd)
    
- [The Last Mile Road](poster-lync-call-quality-methodology.md#LastMi)
    
- [The End Points Road](poster-lync-call-quality-methodology.md#EndPt)
    
- [Service Management](poster-lync-call-quality-methodology.md#ServMgt)
    
- [Board Game Rules](poster-lync-call-quality-methodology.md#BoardGm)
...
Segment 1 of the Server Plant Road addresses the actual servers in the Lync implementation. Gather KHI data regarding both the server itself and its role in the implementation and analyze the result. If action is warranted, correct any problems found. More detail on this topic is presented in the article about [Key Health Indicators in Lync Server 2013](poster-key-health-indicators.md) that accompanies the KHI poster. 
