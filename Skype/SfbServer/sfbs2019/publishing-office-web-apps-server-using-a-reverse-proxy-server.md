---
title: "Publishing Office Web Apps Server in Lync Server 2013 using a reverse proxy server"
ms.author: heidip
...
After completing the installation you can test your Office Web Apps Server using the procedures in the topic [Validating the configuration of Office Web Apps Server in Lync Server 2013](validating-the-configuration-of-office-web-apps-server.md).
