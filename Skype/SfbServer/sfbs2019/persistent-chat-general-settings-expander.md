...
- **SQL Server store**: Elect the SQL Server store and optional named instance from the list.
...
![Persistent Chat General Settings Expander](media/Persistent_Chat_General_Settings_Expander.jpg)
