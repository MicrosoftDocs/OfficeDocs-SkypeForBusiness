---
title: "Prevent new connections to Lync Server 2013 for server maintenance"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "Lync Server enables you to take a server offline (for example, to apply software or hardware upgrades) without any loss of service to users."
---
...
For details about DNS load balancing, see [DNS load balancing in Lync Server 2013](dns-load-balancing.md) in the Planning documentation. 
