---
title: "AudioStreamDetail view in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
|:-----|:-----|:-----|
|SessionTime  <br/> |datetime  <br/> |Referenced from the [MediaLine table in Lync Server 2013](medialine-table.md).  <br/> |
|SessionSeq  <br/> |int  <br/> |Referenced from the [MediaLine table in Lync Server 2013](medialine-table.md).  <br/> |
...
|DialogCategory  <br/> |bit  <br/> |Dialog category: 0 is the Lync Server to Mediation Server leg; 1 is the Mediation Server to PSTN gateway leg.  <br/> |
...
|CallerUserAgentType  <br/> |smallint  <br/> |Type of the caller's user agent. See the [UserAgent table in Lync Server 2013](useragent-table.md) for details.  <br/> |
|CallerUserAgentCategory  <br/> |nvarchar(64)  <br/> |Category of the caller's user agent. See the [UserAgentDef table (QoE) in Lync Server 2013](useragentdef-table-qoe.md) for details.  <br/> |
|CalleeUserAgent  <br/> |nvarchar(256)  <br/> |Callee's user agent string.  <br/> |
|CalleeUserAgentType  <br/> |smallint  <br/> |Type of callee's user agent. See the [UserAgent table in Lync Server 2013](useragent-table.md) for information.  <br/> |
|CalleeUserAgentCategory  <br/> |nvarchar(64)  <br/> |Category of callee's user agent. See the [UserAgentDef table (QoE) in Lync Server 2013](useragentdef-table-qoe.md) for information.  <br/> |
...
|CallerVirtualizationFlag  <br/> |tinyint  <br/> |Indicates whether the caller's system is running in a virtualized environment. See the [Endpoint table in Lync Server 2013](endpoint-table.md) for more information.  <br/> |
|CalleeVirtualizationFlag  <br/> |tinyint  <br/> |Indicates whether the callee's system is running in a virtualized environment. See the [Endpoint table in Lync Server 2013](endpoint-table.md) for more information.  <br/> |
|CorrelationKey  <br/> ||Correlation key. Referenced from the [SessionCorrelation table in Lync Server 2013](sessioncorrelation-table.md).  <br/> |
|ConnectivityIce  <br/> |tinyint  <br/> |Information about the media path, such as direct or relayed. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
...
|CallerRelayIPAddr  <br/> |var(50)  <br/> |IP Address of the A/V Edge service used by the caller. See the [IPAddress table in Lync Server 2013](ipaddress-table.md) for more information.  <br/> |
|CallerRelayPort  <br/> |int  <br/> |Port used on the A/V Edge service used by the caller.  <br/> |
|CalleeRelayIPAddr  <br/> |var(50)  <br/> |IP Address key of the A/V Edge service used by the callee. See the [IPAddress table in Lync Server 2013](ipaddress-table.md) for more information.  <br/> |
...
|PayloadDescription  <br/> |int  <br/> |The audio codec used for the call, referenced from the [PayloadDescription table in Lync Server 2013](payloaddescription-table.md).  <br/> |
...
|CallerVsEntryCauses  <br/> |smallint  <br/> |Voice switch is a half-duplex mode with reduced interruption ability. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
|CallerEchoEventCauses  <br/> |tinyint  <br/> |Causes of an echo event for the caller. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
...
|CalleeVsEntryCauses  <br/> |smallint  <br/> |Voice switch is a half-duplex mode with reduced interruption ability. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
|CalleeEchoEventCauses  <br/> |tinyint  <br/> |Causes of an echo event for the callee. See the [MediaLine table in Lync Server 2013](medialine-table.md) for more information.  <br/> |
