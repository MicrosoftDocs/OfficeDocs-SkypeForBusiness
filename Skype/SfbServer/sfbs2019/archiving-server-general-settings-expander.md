...
description: "In Lync Server 2013 Topology Builder, you can edit the properties for an individual server running Archiving either by right-clicking the server running Archiving in the console tree and clicking Action in the toolbar, or by clicking a task in the Actions pane, and then clicking Edit Properties and changing any of the following options:"
---

# Archiving Server General Settings Expander
[]
In Lync Server 2013 Topology Builder, you can edit the properties for an individual server running Archiving either by right-clicking the server running Archiving in the console tree and clicking **Action** in the toolbar, or by clicking a task in the Actions pane, and then clicking **Edit Properties** and changing any of the following options: 
