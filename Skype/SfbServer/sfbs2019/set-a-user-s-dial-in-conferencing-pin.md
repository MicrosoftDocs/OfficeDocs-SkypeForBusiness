---
title: "Set a user's dial-in conferencing PIN in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
> [!NOTE]
> Specific characteristics of the PIN, such as its minimum length, can be configured as a policy. In addition to the global policy, you can configure a PIN policy for individual sites or users. For details about configuring a PIN policy, see [Configure dial-in conferencing personal identification number (PIN) rules in Lync Server 2013](configure-dial-in-conferencing-personal-identification-number-pin-rules.md). 
...
[Dial-in Access Number](dial-in-access-number.md)
#### 
