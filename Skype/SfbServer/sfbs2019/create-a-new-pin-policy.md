---
title: "Create a new PIN policy in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "You can use the PIN Policy page to provide personal identification number (PIN) authentication to users who are connecting to Lync 2013 with IP Phones. To use PIN authentication, make sure that Enable PIN Authentication is selected in Web Service settings. For details, see Modify existing Web Service configuration settings in Lync Server 2013."
---

# Create a new PIN policy in Lync Server 2013
[]
You can use the **PIN Policy** page to provide personal identification number (PIN) authentication to users who are connecting to Lync 2013 with IP Phones. To use PIN authentication, make sure that **Enable PIN Authentication** is selected in Web Service settings. For details, see [Modify existing Web Service configuration settings in Lync Server 2013](modify-existing-web-service-configuration-settings.md). 
