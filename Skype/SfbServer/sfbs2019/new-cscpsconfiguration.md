...
| _EnableMusicOnHold_ <br/> |Optional  <br/> |System.Boolean  <br/> |Determines whether music plays for the caller while a call is parked.  <br/> Lync Server ships with a default Music on Hold file. You can change this file (thereby changing the music the caller hears while parked) with the **Set-CsCallParkServiceMusicOnHoldFile** cmdlet.  <br/> Default: True  <br/> |
