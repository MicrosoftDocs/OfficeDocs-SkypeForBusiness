...
| _MirrorSqlInstanceName_ <br/> |Optional  <br/> |System.String  <br/> |Name of the SQL Server instance containing the Lync Server mirror database tables and data. For example: -SqlInstanceName "rtc".  <br/> |
...
| _SqlInstanceName_ <br/> |Optional  <br/> |System.String  <br/> |Name of the SQL Server instance containing the Lync Server tables and data. For example: -SqlInstanceName "rtc".  <br/> |
