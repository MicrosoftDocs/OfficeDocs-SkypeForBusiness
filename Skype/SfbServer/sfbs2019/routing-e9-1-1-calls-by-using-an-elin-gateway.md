---
title: "Routing E9-1-1 calls by using an ELIN gateway in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 12/9/2016
...
> [!NOTE]
> For details about using a SIP trunk connection for emergency calls, see [Routing E9-1-1 calls by using a SIP trunk in Lync Server 2013](routing-e9-1-1-calls-by-using-a-sip-trunk.md). 
...
![ELIN Call Routing](media/Plan_LyncServer_E911_ELINCallRouting.jpg)
