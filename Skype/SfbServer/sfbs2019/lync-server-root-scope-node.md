---
title: "Lync Server Root Scope Node"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
- **New Topology**. Enables you to start creating a new topology for your Lync Server 2013 deployment. This option is useful when you are planning your deployment, before you have installed your servers. Do not click this option if you have already used your current topology to install your deployment.
...
- **Install Database**. Enables you to create the databases necessary for your Lync Server 2013 deployment.
    
- **Merge Office Communications Server 2007 R2 Topology**. Starts the Topology Builder Merge wizard. This tool collects information about your previous Office Communications Server environment, including Edge Server information, and publishes that information to a database shared with Lync Server 2013. 
    
- **Remove Deployment**. Starts the Remove Deployment wizard, which enables you to start removing your whole Lync Server 2013 deployment.
