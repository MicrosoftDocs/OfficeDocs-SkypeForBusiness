...
| _Identity_ <br/> |Required  <br/> |Microsoft.Rtc.Management.AD.UserIdParameter  <br/> |Indicates the identity of the shared number to which the delegate will be added.  <br/> UNRESOLVED_TOKENBLOCK_VAL(PS_PD_User_Updated_Specification)  <br/> |
