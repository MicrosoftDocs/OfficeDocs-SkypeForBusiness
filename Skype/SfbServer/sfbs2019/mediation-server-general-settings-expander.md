...
description: "To edit the settings for an existing Mediation Server pool or single Mediation Server you are presented with the following sections:"
---

# Mediation Server General Settings Expander
[]
To edit the settings for an existing Mediation Server pool or single Mediation Server you are presented with the following sections:
...
For additional information on the settings for the Mediation Server pool or Mediation Server, see [Define a Mediation Server in Topology Builder in Lync Server 2013](define-a-mediation-server-in-topology-builder.md) in the Deployment documentation. 
