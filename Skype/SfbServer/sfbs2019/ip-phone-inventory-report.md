---
title: "IP Phone Inventory Report in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "In this articleAccessing the IP Phone Inventory ReportMaking the Best Use of the IP Phone Inventory ReportFiltersMetrics"
---
...
[Accessing the IP Phone Inventory Report](#sectionSection0)
  
[Making the Best Use of the IP Phone Inventory Report](#sectionSection1)
...
|**Last logon time** <br/> |Yes  <br/> |Date and time that the IP phone last logged on to Lync Server.  <br/> |
|**Last logoff time** <br/> |Yes  <br/> |Date and time that the IP phone last logged off from Lync Server.  <br/> |
