---
title: "Managing Response Group agent groups in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "An agent group consists of a group of people who are designated to answer calls to a response group. When you create an agent group, you select the agents who are assigned to the group and specify additional group settings, such as the routing method and whether an agent can sign in to and out of the group."
---
...
> [!NOTE]
> Users must be enabled for Enterprise Voice before you can add them to agent groups. For details about how to enable a user for Enterprise Voice, see [Enable users for Enterprise Voice in Lync Server 2013](enable-users-for-enterprise-voice.md). 
...
- [Delete an agent group in Lync Server 2013](delete-an-agent-group.md)
