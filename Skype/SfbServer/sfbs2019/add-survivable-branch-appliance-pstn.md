...
For additional details about designing a Mediation Server topology and specifying gateway information, see [Define a Mediation Server in Topology Builder in Lync Server 2013](define-a-mediation-server-in-topology-builder.md) in the Deployment documentation. 
