---
title: "Overview of E9-1-1 in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
If you plan to configure your infrastructure to automatically detect client location, first you need to decide which network elements you will use to map callers to locations. For details about the possible options, see [Defining the network elements used to determine location in Lync Server 2013](defining-the-network-elements-used-to-determine-location.md). 
  
## In This Section

- [Acquiring a location in Lync Server 2013](acquiring-a-location.md)
    
- [Routing E9-1-1 calls by using a SIP trunk in Lync Server 2013](routing-e9-1-1-calls-by-using-a-sip-trunk.md)
    
- [Routing E9-1-1 calls by using an ELIN gateway in Lync Server 2013](routing-e9-1-1-calls-by-using-an-elin-gateway.md)
