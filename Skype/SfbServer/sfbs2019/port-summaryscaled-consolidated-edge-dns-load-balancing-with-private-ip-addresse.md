...
|:-----|:-----|:-----|:-----|
|XMPP/MTLS/TCP/23456  <br/> |Any (can be defined as Front End Server address, or Front End pool IP address running the XMPP Gateway service)  <br/> |Edge Server internal interface IP address  <br/> |Outbound XMPP traffic from XMPP Gateway service running on Front End Server or Front End pool  <br/> |
