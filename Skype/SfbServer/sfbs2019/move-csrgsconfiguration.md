...
|:-----|:-----|:-----|:-----|
| _Destination_ <br/> |Required  <br/> |System.String  <br/> |FQDN of the computer where the Lync Server 2013 Response Group application is to be hosted (the "copy to" location).  <br/> |
| _Source_ <br/> |Required  <br/> |System.String  <br/> |FQDN of the pool where the Office Communications Server 2007 R2 or Lync Server 2010 Response Group application is currently hosted (the "copy from" location).  <br/> |
