...
|:-----|:-----|:-----|:-----|
| _PoolFqdn_ <br/> |Required  <br/> |Microsoft.Rtc.Management.Deploy.Fqdn  <br/> |Fully qualified domain name of the pool being failed back. For example:-PoolFqdn "atl-cs-001.litwareinc.com"  <br/> The pool FQDN used during failback must be the same FQDN used during failover.  <br/> |
