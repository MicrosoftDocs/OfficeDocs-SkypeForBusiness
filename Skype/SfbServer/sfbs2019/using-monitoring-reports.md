---
title: "Using Monitoring Reports in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
description: "In this articleIn This SectionLocating RecordsFiltering DataExporting Data"
---
...
[In This Section](#sectionSection0)
  
[Locating Records](#sectionSection1)
  
[Filtering Data](#sectionSection2)
  
[Exporting Data](#sectionSection3)
...
- [Using the Monitoring Dashboard in Lync Server 2013](using-the-monitoring-dashboard.md) Provides administrators with a quick overview of their system health and system usage. 
    
- [System usage reports in Lync Server 2013](system-usage-reports.md) Provides system usage information based on CDR data collected by Lync Server. 
    
- [Call Diagnostic Reports (per user) in Lync Server 2013](call-diagnostic-reports-per-user.md) Provides per-user information about failed peer-to-peer and conferencing sessions. 
    
- [Call Diagnostic Reports in Lync Server 2013](call-diagnostic-reports.md) Provides summary information and diagnostic data for failed peer-to-peer and conferencing sessions. 
    
- [Media Quality Diagnostic Reports in Lync Server 2013](media-quality-diagnostic-reports.md) Provides information about call quality as well as diagnostic and troubleshooting information for failed calls. 
