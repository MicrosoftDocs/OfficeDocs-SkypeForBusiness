...
|:-----|:-----|:-----|:-----|
| _Component_ <br/> |Required  <br/> |System.String  <br/> |Indicates the type of simple URL being created. Valid values are:  <br/> Meet - URL used for managing meetings.  <br/> Admin - URL that points to the Lync Server Control Panel.  <br/> Dialin - URL used for dial-in conferencing.  <br/> For example: -Component "Meet".  <br/> |
| _Domain_ <br/> |Required  <br/> |System.String  <br/> |SIP domain for the simple URL. For example: -Domain "litwareinc.com".  <br/> |
| _ActiveUrl_ <br/> |Optional  <br/> |System.String  <br/> |Indicates the URL that is actually to be accessed by users. The SimpleUrlEntry property can contain multiple URLs, but only one of those URLs can be active at a given time. An error will occur if you try to set the ActiveUrl to a value not found in the SimpleUrlEntry property.  <br/> To assign an active URL, simply use the URL itself as the parameter value. For example: -ActiveUrl https://meet.litwareinc.com".  <br/> |
