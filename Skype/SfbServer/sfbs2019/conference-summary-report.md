---
title: "Conference Summary Report in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "In this articleAccessing the Conference Summary ReportMaking the Best Use of the Conference Summary ReportFiltersMetrics"
---
...
[Accessing the Conference Summary Report](#sectionSection0)
  
[Making the Best Use of the Conference Summary Report](#sectionSection1)
  
[Filters](#sectionSection2)
  
[Metrics](#sectionSection3)
  
The Conference Summary Report provides an overall view of your online conferencing sessions. A conference typically involves more than 2 users and requires the use of Microsoft Lync Server 2013 conferencing services. By comparison, a peer-to-peer session typically involves just 2 users and does not require the use of Lync Server's conferencing services. Peer-to-peer activities are reported on the [Peer-to-Peer Activity Summary Report in Lync Server 2013](peer-to-peer-activity-summary-report.md).
...
|:-----|:-----|
|Ken Myer  <br/> |7/7/2012 10:00 AM  <br/> |
|David Ahs  <br/> |7/7/2012 10:00 AM  <br/> |
|Ken Myer  <br/> |7/7/2012 11:00 AM  <br/> |
|Pilar Ackerman  <br/> |7/7/2012 11:00 AM  <br/> |
|Ken Myer  <br/> |7/7/2012 1:00 PM  <br/> |
|Pilar Ackerman  <br/> |7/7/2012 2:00 PM  <br/> |
|Ken Myer  <br/> |7/2/2012 10:00 AM  <br/> |
|Pilar Ackerman  <br/> |7/2/2012 10:00 AM  <br/> |
...
|**Interval** <br/> | Time interval. Select one of the following:  <br/>  Hourly (a maximum of 25 hours can be displayed)  <br/>  Daily (a maximum of 31 days can be displayed)  <br/>  Weekly (a maximum of 12 weeks can be displayed)  <br/>  Monthly (a maximum of 12 months can be displayed)  <br/>  If the start and end dates exceed the maximum number of values allowed for the selected interval, only the maximum number of values (starting from the start date) are displayed. For example, if you select the Daily interval with a start date of 7/7/2012 and an end date of 2/28/2012, data is displayed for the days 8/7/2012 12:00 AM to 9/7/2012 12:00 AM (that is, a total of 31 days' worth of data).  <br/> |
...
|:-----|:-----|:-----|
|**Hourly** <br/> **Daily** <br/> **Weekly** <br/> **Monthly** <br/> |No  <br/> |Indicates the time interval that you selected on the filter toolbar. Where applicable, you can click a given time interval to view detailed information for that interval. For example, if you are using the Daily interval and you click 7/7/2012, you see an hourly breakdown of user registration activity for that date.  <br/> |
