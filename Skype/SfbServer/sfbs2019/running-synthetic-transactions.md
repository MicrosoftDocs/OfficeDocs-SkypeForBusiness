---
title: "Running synthetic transactions in Lync Server 2013"
ms.author: jambirk
author: jambirk
manager: laurawi
ms.date: 11/17/2014
...
[Configuring watcher node test users and configuration settings in Lync Server 2013](configuring-watcher-node-test-users-and-configuration-settings.md)
  
[Special setup instructions for synthetic transactions in Lync Server 2013](special-setup-instructions-for-synthetic-transactions.md)
