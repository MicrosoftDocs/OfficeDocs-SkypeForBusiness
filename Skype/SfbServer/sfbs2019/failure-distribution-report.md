---
title: "Failure Distribution Report in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 3/9/2015
...
description: "In this articleViewing the Failure Distribution ReportUsing the Failure Distribution ReportFiltersMetrics for Top Diagnostic ReasonsMetrics for Top ModalitiesMetrics for Top PoolsMetrics for Top SourcesMetrics for Top ComponentsMetrics for Top From UsersMetrics for Top To UsersMetrics for Top User Agents"
---
...
[Viewing the Failure Distribution Report](#sectionSection0)
  
[Using the Failure Distribution Report](#sectionSection1)
  
[Filters](#sectionSection2)
  
[Metrics for Top Diagnostic Reasons](#sectionSection3)
  
[Metrics for Top Modalities](#sectionSection4)
  
[Metrics for Top Pools](#sectionSection5)
  
[Metrics for Top Sources](#sectionSection6)
  
[Metrics for Top Components](#sectionSection7)
  
[Metrics for Top From Users](#sectionSection8)
  
[Metrics for Top To Users](#sectionSection9)
  
[Metrics for Top User Agents](#sectionSection10)
...
- [Top Failures Report in Lync Server 2013](top-failures-report.md)
    
- [Conference Diagnostic Report in Lync Server 2013](conference-diagnostic-report.md)
    
- [Peer-to-Peer Activity Diagnostic Report in Lync Server 2013](peer-to-peer-activity-diagnostic-report.md)
    
From the Failure Distribution Report, you can click any of the following metrics to view the [Failure List Report in Lync Server 2013](failure-list-report.md):
...
|**Name**|**Can you sort on this item?**|**Description**|
|:-----|:-----|:-----|
|**Rank** <br/> |No  <br/> |Relative ranking of failed sessions based on Lync Server 2010 component (for example, ExumRouting, GroupChat, or MediationServer).  <br/> |
