...
| _Regions_ <br/> |Optional  <br/> |System.Management.Automation.PSListModifier  <br/> |Collection of regions defined for the centralized logging configuration settings. Regions are defined using the New-CsClsRegion cmdlet.  <br/> This parameter is intended for use with Lync Server 2013.  <br/> |
