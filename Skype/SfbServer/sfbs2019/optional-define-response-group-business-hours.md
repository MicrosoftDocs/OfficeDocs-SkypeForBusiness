---
title: "(Optional) Define Response Group business hours in Lync Server 2013"
ms.author: kenwith
author: kenwith
manager: laurawi
ms.date: 11/17/2014
...
> [!TIP]
> When you create or modify a workflow, you can specify a custom schedule that applies only to that workflow. For details, see [Create or modify a hunt group workflow in Lync Server 2013](create-or-modify-a-hunt-group-workflow.md) or [Create or modify an interactive workflow in Lync Server 2013](create-or-modify-an-interactive-workflow.md). 
