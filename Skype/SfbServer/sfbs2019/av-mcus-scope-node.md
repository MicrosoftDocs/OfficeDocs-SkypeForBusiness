...
- **Topology**. You can use this option to define a new topology, open an existing topology, download the current topology, save a copy of the topology, publish the topology, install a database, merge Microsoft Office Communications Server 2007 R2 Standard Edition components, or remove the deployment.
