---
title: "Scaled consolidated edge, DNS load balancing with private IP addresses using NAT in Lync Server 2013"
ms.author: heidip
...
description: "In the Edge Server pool topology, two or more Edge Servers are deployed as a load-balanced pool in the perimeter network of the data center. Domain Name System (DNS) load balancing is used for traffic to both the external and internal Edge interfaces."
---
...
![DNS LB With Private IP Using NAT](media/Plan_LyncServer_Edge_Scenario_ScaledConsolidatedEdgeDNSLBPrivateIP.jpg)
