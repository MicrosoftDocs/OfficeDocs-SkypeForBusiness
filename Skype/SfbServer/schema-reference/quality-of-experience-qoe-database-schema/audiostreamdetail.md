...
|CallerSendSignalLevel  <br/> |int  <br/> |Post-Analog Gain Control audio signal level for the audio the caller sent. The unit for this metric is dBmo. For acceptable quality, it should be at least 30 dBmo. This metric isn't reported by the A/V Conferencing Server or IP phones.  <br/> |
