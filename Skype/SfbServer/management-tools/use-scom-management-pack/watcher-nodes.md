...
description: "Learn to install and configure watcher nodes for Skype for Business Server synthetic transactions."
---

# Learn to install and configure watcher nodes
