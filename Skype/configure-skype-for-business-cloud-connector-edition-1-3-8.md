...
Before you start, you should review the prerequisites in the  [Plan for Skype for Business Cloud Connector Edition](plan-for-skype-for-business-cloud-connector-edition.md) topic.
> [!IMPORTANT]
> The steps in this topic apply only to Cloud Connector Edition 1.3.8. If you are using Cloud Connector Edition 1.4.1, see  [Configure Skype for Business Cloud Connector Edition](configure-skype-for-business-cloud-connector-edition.md). 
...
Prepare the CloudConnector.ini file using the information you gathered using the table in  [Determine deployment parameters](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_SiteParams) [Information you need to gather before deployment](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_PlanDeployment) in the [Plan for Skype for Business Cloud Connector Edition](plan-for-skype-for-business-cloud-connector-edition.md) topic.
...
1. Login to the VMs created by the installation script. Note that you can safely ignore the **Shutdown Event Tracker** dialog. The dialog is displayed because the operating system on the VM had to be restarted multiple times during the installation for adding features and installing Skype for Business Server on them.
     ...
     ![ShutDownEventTracker](images/e95873fc-bef7-4b10-9574-9859440ea748.png)
  

  

  
2. Configure the firewall settings to open the required ports as described in  [Ports and protocols](plan-for-skype-for-business-cloud-connector-edition.md#BKMB_Ports) in [Plan for Skype for Business Cloud Connector Edition](plan-for-skype-for-business-cloud-connector-edition.md).
...
1. Log in to Office 365 using a tenant admin account, and open the admin portal. Select the **Setup** tab, and then select **Start setup**.
     ...
     ![O365 sign-in and start setup](images/d808bcd6-f424-4667-850c-5b99dc1acdcf.png)
...
2. On the next page, confirm that **Yes, I want to transfer DNS management in the next step** is selected, and then select **Next**.
     ...
     ![Set up DNS records](images/51bf9620-d64c-407c-9cb5-d41f6e1b1801.png)
...
3. Verify your DNS host authorization by following the guidance on the page to add a TXT record to your DNS host. Once completed, select **Okay, I've added the record**.
     ...
     ![Verify DNS authorization](images/d02d336c-52ec-4ce2-bf38-b9b16ed68ba0.png)
...
2. Add a DNS A record for AV Edge External
    ...
    https://portal.office.com/Admin/Default.aspx#@/Domains/DomainEdit.aspx?DomainEditLayout=DomainDnsManagementPanel&amp;domainName=<Domain Fqdn>
     ...
     ![Add DNS A record for AV Edge External](images/098fcf24-c694-486f-a761-6295bf6ffbc7.png)
...
### Setup HybridSkype for Business Cloud Connector Edition and Office 365
...
![Add DNS records for Edge on O365 portal for the same ext FQDN](images/3fbf9f20-a890-4897-96af-cccfc3e99746.png)
...
3. Add DNS records for Edge on O365 portal for all the External FQDNs and IPs for Access Edge.
     ...
     ![Add DNS records for Edge on O365 portal for ALL the Ext FQDNs](images/89eed3d6-65e3-4ea1-9635-65cbc937b32a.png)
