...
-  [Edge Servers](edge-server-system-requirements-in-skype-for-business-server-2015.md#EdgeServers)
    
  
-  [Reverse proxies](edge-server-system-requirements-in-skype-for-business-server-2015.md#ReverseProxies)
    
  
-  [Firewalls](edge-server-system-requirements-in-skype-for-business-server-2015.md#Firewalls)
    
  
-  [Directors](edge-server-system-requirements-in-skype-for-business-server-2015.md#Directors) (these are optional, and if they're included, they'll be located on your internal network)
    
  
-  [Load Balancers](edge-server-system-requirements-in-skype-for-business-server-2015.md#LoadBalancers) (you can have DNS load balancing or a hardware load balancer (HLB), but for a single Edge Server, this isn't needed)
...
These are the Skype for Businessservers deployed in your perimeter environment. Their role is to send and receive network traffic to external users for the services offered by your internal Skype for Business Server deployment. To do this successfully, each Edge Server runs:
...
#### hardware load balancer requirements for Edge ServersEdge Servers running the A/V Edge service
...
We've covered Edge Server hardware and software requirements in our overall  [Server requirements for Skype for Business Server 2015](server-requirements-for-skype-for-business-server-2015.md) documentation.
...
We've covered Edge Server collocation in our  [Topology Basics for Skype for Business Server 2015](topology-basics-for-skype-for-business-server-2015.md) documentation.
