...
[]
This article provides guidance on how many servers you need at a site for the number of users at that site, according to the usage described in  [User models in Skype for Business Server 2015](user-models-in-skype-for-business-server-2015.md).
...
The following table shows the average bandwidth for IM and presence, given the user model, as defined in  [User models in Skype for Business Server 2015](user-models-in-skype-for-business-server-2015.md).
...
To provide high availability of your Back End Server, we recommend deploying AlwaysOn Availability Groups or server mirroring. For more information, see  [Back End Server high availability in Skype for Business Server 2015](back-end-server-high-availability-in-skype-for-business-server-2015.md).
