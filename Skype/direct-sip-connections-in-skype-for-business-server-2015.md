...
![Departmental Migration Option diagram](images/Fig28_Departmental_migration_option.jpg)
...
![Greenfidle deployment option](images/Fig29_Greenfield_deployment_option.jpg)
...
For details about planning for multiple gateways, see  [M:N trunk in Skype for Business Server 2015](m-n-trunk-in-skype-for-business-server-2015.md).
