...
The Conference Diagnostic Report is accessed from the Monitoring Reports home page. You can access the  [Failure Distribution Report in Skype for Business Server 2015](failure-distribution-report-in-skype-for-business-server-2015.md) by clicking either of the following metrics:
