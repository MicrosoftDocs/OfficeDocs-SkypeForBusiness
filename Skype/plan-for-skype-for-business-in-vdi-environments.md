...
-  [Supported virtualization technologies and known limitations](plan-for-skype-for-business-in-vdi-environments.md#Supported_virt)
    
  
-  [Lync VDI plug-in prerequisites](plan-for-skype-for-business-in-vdi-environments.md#VDI_prereq)
    
  
-  [Deploy the Lync VDI plug-in with Skype for Business Server 2015](deploy-the-lync-vdi-plug-in-with-skype-for-business-server-2015.md)
