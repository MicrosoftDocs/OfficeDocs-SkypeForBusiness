---
title: Ports and protocols for internal servers
...
Skype for Business Server requires that specific ports on the firewall be open. Additionally, if Internet Protocol security (IPsec) is deployed in your organization, IPsec must be disabled over the range of ports used for the delivery of audio, video, and panorama video. 
...
For details about firewall configuration for edge components, see  [Determine External A/V Firewall and Port Requirements](http://technet.microsoft.com/library/3b849dc7-175d-40d1-820d-80e6ade6d332.aspx). 
...
Port summaries are provided in the following topics:
  
    
    

-  [Ports and protocols for internal servers](ports-and-protocols-for-internal-servers.md)
    
  
-  [IPSec Exceptions](http://technet.microsoft.com/library/241f1eca-6f2f-44de-90b1-2cb659cbe27c.aspx)
    
  
-  [Port Summary - Single Consolidated Edge with Private IP Addresses Using NAT](http://technet.microsoft.com/library/3c1a389f-5f42-4719-a05b-e0b84aa3eb9e.aspx)
    
  
-  [Port Summary - Single Consolidated Edge with Public IP Addresses](http://technet.microsoft.com/library/28407acc-8b92-4f78-875c-fd6b4323b602.aspx)
    
  
-  [Port Summary - Scaled Consolidated Edge, DNS Load Balancing with Private IP Addresses Using NAT](http://technet.microsoft.com/library/a296c2af-54d4-4b4f-9795-9191baf688cb.aspx)
    
  
-  [Port Summary - Scaled Consolidated Edge, DNS Load Balancing with Public IP Addresses](http://technet.microsoft.com/library/f7cbd0f1-841d-4116-8d17-e9d991daa4a8.aspx)
    
  
-  [Port Summary - Scaled Consolidated Edge with Hardware Load Balancers](http://technet.microsoft.com/library/91213b1e-f875-464b-83e8-fe3a351595a4.aspx)
    
  
-  [Port Summary for Reverse Proxy](http://technet.microsoft.com/library/59b9ac3c-3e6f-4776-b366-174f0dd1f2eb.aspx)
    
  
-  [Port Summary - SIP, XMPP Federation and Public Instant Messaging](http://technet.microsoft.com/library/ab05bdd6-e9b0-4b1b-9dd9-29ab88e8befe.aspx)
