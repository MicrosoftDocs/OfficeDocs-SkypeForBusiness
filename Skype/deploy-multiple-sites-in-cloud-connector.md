...
1. The following table shows an example configuration to deploy Skype for Business Cloud Connector Edition for different PSTN sites. Make sure your configuration settings are correct before you start a deployment.
...
2. Follow the steps in  [Deploy a single site in Cloud Connector](deploy-a-single-site-in-cloud-connector.md) for each PSTN site that you want to add.
...
|SIPDomains  <br/> |Domain names and order should be the **same** across appliances <br/> |Domain names and order should be the **same** across PSTN sites <br/> |
|Site name  <br/> |**Same** Site Name across appliances <br/> |**Different** Site Name across PSTN sites <br/> |
|Server names  <br/> |**Different** across appliances <br/> |**Different** across PSTN sites <br/> |
|Internal pool FQDNs  <br/> |**Same** across appliances <br/> |**Same** across PSTN sites <br/> |
|Internal IPs  <br/> |**Different** across appliances <br/> |**Different** across PSTN sites <br/> |
|External FQDN  <br/> |**Same** across appliances <br/> |**Different** across PSTN sites <br/> |
|External IPs  <br/> |**Different** across appliances <br/> |**Different** across PSTN sites <br/> |
|PSTN GW settings  <br/> |**Same** across appliances <br/> |**Different** across PSTN sites <br/> |
...
|Setup hybrid tenant  <br/> |Set HybridPSTNSite  <br/> Set PeerDestination for fallback  <br/> |Set HybridPSTNSite  <br/> Set PeerDestination for fallback  <br/> |
...
|Setup user  <br/> |Set UserPSTNSettings  <br/> |Set UserPSTNSettings  <br/> |
