...
However, if you open the Call List Report from the  [Location Report in Skype for Business Server 2015](location-report-in-skype-for-business-server-2015.md), you won't see any of those metrics; instead, you'll see metrics like these:
...
- The  [Location Report in Skype for Business Server 2015](location-report-in-skype-for-business-server-2015.md) (by clicking the Call volume or Poor call percentage metric)
    
  
- The  [Device Report in Skype for Business Server 2015](device-report-in-skype-for-business-server-2015.md) (by clicking the Call volume or Poor call percentage metric)
    
  
- The  [Media Quality Summary Report in Skype for Business Server 2015](media-quality-summary-report-in-skype-for-business-server-2015.md) (by clicking the Call volume or Poor call percentage metric)
    
  
- The  [Server Performance Report in Skype for Business Server 2015](server-performance-report-in-skype-for-business-server-2015.md) (by clicking the Call volume or Poor call percentage metric)
    
  
From within the Call List Report you can access the  [Call Detail Report in Skype for Business Server 2015](call-detail-report-in-skype-for-business-server-2015.md) by clicking the Detail metric.
