...
What is an environmental requirement for Skype for Business Server 2015? Well, we've put everything that's not directly server related into this topic, so you don't have to do as much clicking around. If you're looking for Server Prerequisites, you can check out the  [Server requirements for Skype for Business Server 2015](server-requirements-for-skype-for-business-server-2015.md) doc. [Networking Planning](plan-network-requirements-for-skype-for-business-2015.md) is also documented separately. Otherwise, this is what we've got in this article:
  
    
    

 [Active Directory](environmental-requirements-for-skype-for-business-server-2015.md#AD)
 [Domain Name System (DNS)](environmental-requirements-for-skype-for-business-server-2015.md#DNS)
  
    
    

 [Certificates](environmental-requirements-for-skype-for-business-server-2015.md#Certs) [File Share](environmental-requirements-for-skype-for-business-server-2015.md#Fileshare)
## Active Directory
<a name="AD"> </a>
...
![The is a key to the icons used for Skype for Business topology diagrams](images/cc0dbc17-cf81-4b79-bf99-4614cc6828a0.png)
...
![Diagram of Active Directory single forest with a single domain](images/24921a0b-3a3e-4bad-8427-49300e2e3f7a.png)
...
![A single forest, single tree and mutiple domains diagram](images/63b9f0dd-6bac-4ba9-ae68-8be032d09dcb.png)
...
![A single forest, multiple  trees and disjoint namespaces diagram](images/5ede77a1-f5d2-499c-a2c8-d02f3c2f7cd7.png)
...
![Multiple forests in a central forest topology diagram](images/fec40746-4254-4c84-86b9-aad4a616ea2f.png)
...
![Multiple forests in a resource forest topology diagram](images/41efa3b6-d9e6-47df-992b-fefcfc39a80d.png)
...
This topology is similar to the topology described in  [Multiple forests in a Skype for Business resource forest topology](environmental-requirements-for-skype-for-business-server-2015.md#BKMK_multipleforestopology).
...
![Shows two AD forests, one user forest and one resource forest. The two forests have a trust relationship. They are synchronized with Office 365 using Azure AD Connect. All users are enabled for Skype for Business via Office 365.](images/6d54558d-8786-4ebf-90f6-55ae3fdb5ae7.jpg)
...
For more information, see  [Configure a multi-forest environment for hybrid Skype for Business](configure-a-multi-forest-environment-for-hybrid-skype-for-business.md).
...
For further reading on DNS requirements for Networking, check out the  [Networking](plan-network-requirements-for-skype-for-business-2015.md) section of our Planning documentation.
