---
title: Dial-in conferencing supported languages
ms.prod: OFFICE365
ms.assetid: 572ca0c8-b9f0-4948-9409-e12ee0b94aa0
---


# Dial-in conferencing supported languages

When you are setting up and configuring dial-in conferencing in Office 365, you can select the primary and secondary (up to 4) languages that are used when callers dial in to a meeting. Here is the list of supported languages for dial-in conferencing: 
...
> [!IMPORTANT]
> Primary and secondary languages can be changed only on dedicated dial-in conferencing phone numbers. 
...
If you are looking for countries or regions where you can purchase PSTN Conferencing, see  [Is PSTN Conferencing with phone numbers available in my country or region?](http://technet.microsoft.com/library/1096d81e-7e14-488c-95d8-b8322e39c059%28Office.14%29.aspx).
  
    
    
If you are looking for specific countries or regions that have phone numbers for dial-in conferencing, see  [Phone numbers for dial-in conferencing](phone-numbers-for-dial-in-conferencing.md).
