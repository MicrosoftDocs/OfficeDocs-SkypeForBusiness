...
3. Click the **Skype for Business activity** widget on the dashboard then select **Skype for Business peer-to peer activity** or select it from the **Select a report** list on the reports **Usage** page.
...
|**10** <br/> |![Skype for Business Online Reporting Manage Button.](images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)Click or tap **Columns** to add or remove columns from the report.           <br/> |
