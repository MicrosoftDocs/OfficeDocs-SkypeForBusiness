...
If you want a Excel spreadsheet with all countries and regions, see [All countries and regions spreedsheet](https://review.docs.microsoft.com/en-us/SkypeForBusiness/downloads/country-region-availabilty/country-and-region-availability-(v.1.0)-(en.us).xlsx?raw=true)
