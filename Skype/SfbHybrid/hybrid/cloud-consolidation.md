...
You can consolidate all on-premises users from multple Skype for Business deployments into a single online Microsoft 365 organization, provided that the following key requirements are met:
