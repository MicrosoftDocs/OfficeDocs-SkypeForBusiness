...
2. Via a [Session Border Controller](MicrosoftTeams/direct-routing-border-controllers) and [Direct Routing](https://docs.microsoft.com/microsoftteams/direct-routing-plan-media-bypass)
