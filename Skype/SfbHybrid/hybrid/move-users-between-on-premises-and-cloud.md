...
- In the on-premises environment, the user performing the move must have the CSServerAdministrator and CsUserAdministrator roles in Skype for Business Server.
