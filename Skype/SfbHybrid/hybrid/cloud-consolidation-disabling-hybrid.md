...
2. Disable shared sip address space (aka "split domain") in the Microsoft 365 or Office 365 organization.
...
11. Confirm that all users have been processed successfully by running the following two PowerShells commands.
