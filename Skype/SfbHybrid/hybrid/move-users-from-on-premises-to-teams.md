...
- If you do not have one account with sufficient permissions in both on premises and Microsoft 365/Office 365, use the `-credential` parameter to supply an account with sufficient permissions in Office 365.
