---
title: Create and manage PSTN Calling dial plans
...
After you have planned out dial plans for your organization and figured out all of the normalization rules that need created for call routing, you will need to use Windows PowerShell to create the dial plans and make any setting changes.
...
#### Other Resources
 ...
 [Skype Operations Framework](https://www.skypeoperationsframework.com/)
