...
| Service | Feature level | Feature | Description  | Azure  | ExUM |
|---------|-------|--------|----|--------|------|
...
| VM | User Features | PSTN Dial-in Access  |  | N | Y    |
| VM | User Features | PSTN Outlook Voice Access   |  | N | Y    |
...
| VM | User Features | Call back to record personal greeting (authenticated device) |  | Y | Y    |
| VM | User Features | Call back to record personal greeting (PSTN) - play on phone |  | N | Y    |
...
| VM | User Features | Sending a voice message to a group of users  |  | H1CY19 | ?    |
| VM | User Features | Voicemail notification using SMS    | Users can receive an SMS when they have a new voicemail    | N | Y    |
| VM | User Features | Supported greeting languages |  | Y | Y    |
| VM | User Features | Call answering rules | Add details  | Q1CY19 | Y    |
...
| VM | Tenant-Admin Features | Change recording duration time limit  | For storage space considerations  | N | Y    |
...
| VM | Tenant-Admin Features | Voicemail policy    | details  | Y | Y    |
...
|Experience  |Change in UX for Wave 2  |
|---------|---------|
|Email notification | No change<br>No email is sent to users notifying them about voicemail account activation/migration. |
|Email notification | No change<br>Users will have access to their previous voicemail messages in all supported endpoints. |
