...
### [Phase 1: Plan your migration](../migration/phase-1-plan-your-migration-from-lync-server-2010.md)
...
#### [Apply updates to legacy installation](../migration/apply-lync-server-2010-updates.md)
...
#### [Verify legacy environment you are migration from](../migration/verify-lync-server-2010-environment.md)
### [Phase 3: Deploy pilot pool](../migration/phase-3-deploy-lync-server-2013-pilot-pool.md)
#### [Prepare Active Directory for pilot pool](../migration/prepare-active-directory-for-lync-server.md)
#### [Download topology from existing deployment](../migration/download-topology-from-existing-deployment.md)
#### [Deploy pilot pool](../migration/deploy-lync-server-2013-pilot-pool.md)
...
#### [View current users in legacy pool](../migration/view-current-users-in-lync-server-2010-pool.md)
...
### [Phase 5: Add Edge Server to pilot pool](../migration/phase-5-add-lync-server-2013-edge-server-to-pilot-pool.md)
...
#### [Move remaining users](../migration/move-remaining-users-to-lync-server-2013.md)
#### [Configure XMPP gateway](../migration/configure-xmpp-gateway-on-lync-server-2013.md)
...
#### [Deploy Skype for Business clients](../migration/deploy-lync-server-2013-clients.md)
...
#### [Move the legacy Central Management Server](../migration/move-the-lync-server-2010-central-management-server-to-lync-server-2013w14-to-w1.md)
...
#### [Remove the Enterprise Edition Front End Server or Standard Edition Front End Server](../migration/remove-the-enterprise-edition-front-end-server-or-standard-edition-front-end-ser.md)
...
##### [Stop legacy services](../migration/stop-lync-server-2010-services.md)
