            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p> [Infrastructure requirements](plan/environmental-requirements.md) <br>[Network requirements](../SfbServer/plan-your-deployment/network-requirements/network-requirements.md)</p>
                    </div>
                </div>
            </div>
        </div>
