...
For additional information on enabling users for Lync Server 2013, see the Deploying Lync Server 2013 documentation. 
  
  <!-- the topic [Disable or re-enable user account for Lync Server 2013](../../operations/managing-users-in-lync-server-2013/disable-or-re-enable-user-account-for-lync-server.md) in  -->
