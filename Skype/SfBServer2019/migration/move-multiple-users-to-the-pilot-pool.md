...
description: "In this articleTo move multiple users by using the Skype for Business Server 2019 Control PanelTo move multiple users by using the Skype for Business Server 2019 Management ShellTo move all users at the same time by using the Skype for Business Server 2019 Management Shell"
---
