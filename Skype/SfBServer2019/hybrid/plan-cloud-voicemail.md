...
**THE GOAL OF THIS TOPIC SHOULD BE HIGH-LEVEL WITH POINTERS TO OTHER DOCS FOR DETAILS ABOUT HYBRID CONNECTIVITY, CONFIGURING VOICEMAIL, EXCHANGE UM MIGRATION, ETC.  HOWEVER, ARE WE MISSING IMPORTANT CONCEPTS PREREQUISITES SPECIFIC TO THIS FEATURE/SCENARIO THAT SHOULD BE DESCRIBED IN THIS DOCUMENT?**

**HOW MUCH DO WE NEED TO SAY ABOUT EXCHANGE UM IN THIS TOPIC?  ARE THERE SCENARIOS WHERE A CUSTOMER HAS SOME USERS STILL GOING THROUGH EXCHANGE UM ON PREM/ONLINE AND OTHERS USING CLOUD VOICEMAIL?  I'M ASSUMING THE LATTER IS THE CASE WHILE CUSTOMERS MIGRATE.**

**DO WE NEED SPECIFIC GUIDANCE ON EXCHANGE UM MIGRATION TO VOICEMAIL?**

**WHEN IS EXCHANGE UM BEING DEPRECATED?**
