...
| Configure Skype for Business hybrid | There are three basic steps:  <br>1. Configure your on-premises environment to federate with Office 365. <br> 2. Configure your on-premises environment to trust Office 365 and for shared SIP address space with Office 365. <br> 3. Enable Office 365 for shared SIP address space with your on-premises environment. <br><br> In addition, if you have Exchange on-premises, then you may want to configure OAuth between your Exchange on-premises and Skype for Business Online environments.   <br><br>For more information, see [Configure Skype for Business hybrid](configure-federation-with-skype-for-business-online.md).
