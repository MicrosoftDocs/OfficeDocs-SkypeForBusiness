...
In this topic:
-  [Configure your environment for the SRS v1 Administrative Web Portal](deploy-srs-v1-administrative-web-portal-in-skype-for-business-server-2015.md#Config_Env)
    
  
-  [Install the SRS v1 Administrative Web Portal](deploy-srs-v1-administrative-web-portal-in-skype-for-business-server-2015.md#Install_SRS)
    
  
-  [Use the SRS Administrative Web Portal](deploy-srs-v1-administrative-web-portal-in-skype-for-business-server-2015.md#Use_Portal)
...
4. Create an Active Directory security group with name LRSFullAccessAdminGroup. 
    ...
    Create the group with Group Scope as Global and Group Type as Security.SIP enabled users who are added to this group are authorized to use all admin portal functionality on a single Skype room. To include support for bulk management of Skype rooms, refer to step 5. 
     ...
     ![List of Admin Groups with security group role](images/LRS_LRSFullAccessAdminGroup.png)
...
6. Add SRSFullAccessAdminGroup as a member of LRSSupportAdminGroup.
     ...
     ![LRSSupportAdminGroup Properties Members page](images/LRS_Add_LRSSupportAdminGroup.png)
...
7. Create a SIP enabled Active Directory user with name LRSSupport. Add this user to LRSSupportAdminGroup.
     ...
     ![LRSSupportAdminGroup Properties Members page](images/LRS_Add_LRS_SIP_SupportUser.png)
  

  

  
8. Install  [ASP.NET MVC 4 for Visual Studio 2010 SP1 and Visual Web Developer 2010 SP1](http://go.microsoft.com/fwlink/p/?LinkId=323967).
...
4. In the Web.Config file, change the PortalUserName to the username created in Step 2 under the section " [Configure your environment for the SRS v1 Administrative Web Portal](deploy-srs-v1-administrative-web-portal-in-skype-for-business-server-2015.md#Config_Env)" (the recommended name in the step is LRSApp): 
...
1. On a Front End server, browse to the following URL:
    ...
    You should not see any errors, as shown in the following image:
     ...
     ![Lync Room System Admin Portal Sign In screen](images/LRS_AdminPortalSignIn.png)
...
![Lync Room System Admin Portal Summary View](images/LRS_AdminPortal_Summary_view.png)
...
![Lync Room System Admin Portal Room Settings](images/LRS_AdminPortal_RoomInfoSettings.png)
...
![Lync Room System Admin Portal Detail View](images/LRS_AdminPortal_Detail_view.png)
...
![Lync Room System Admin Portal Room Health](images/LRS_AdminPortal_RoomInfoHealth.png)
