---
title: Modify SIP trunk configuration settings in Skype for Business Server 2015
...
> [!NOTE]
> The Lync Server CsTrunkConfiguration cmdlets support additional properties not shown in Lync Server Control Panel. For more information, see the help topic for the  [Set-CsTrunkConfiguration](set-cstrunkconfiguration.md) cmdlet.
