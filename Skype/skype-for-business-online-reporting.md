...
| [Skype for Business clients used report](skype-for-business-clients-used-report.md) <br/> | Windows users <br/>  Windows Phone users <br/>  Android users <br/>  iPhone users <br/>  iPad users <br/> |
...
| [Skype for Business blocked users report](skype-for-business-blocked-users-report.md) <br/> > [!TIP]> Use the ** Skype for Business admin center** > **Reports** to see this report.          | Action Date <br/>  User Name <br/>  Action Type <br/>  Telephone Number <br/>  Reason <br/> |
