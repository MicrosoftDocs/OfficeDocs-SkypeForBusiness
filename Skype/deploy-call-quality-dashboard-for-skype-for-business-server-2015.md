...
![CQD components](images/ef3359b1-c98b-4cc5-a549-c84c6e03c011.png)
...
![Deploy Call Quality - Authorization Rules in IIS](images/0da80c28-58fe-4aca-94b4-db684389468c.png)
...
![Deploy CQD](images/fa17ad19-d303-40f8-8324-d13fd67936ab.png)
...
![Deploy Call Quality Dashboard](images/8cfdc141-ec89-4552-921b-53196f497cbf.png)
...
1. Open the Configuration Editor for CQD.
     ...
     ![Deploy Call Quality Dashboard](images/544056eb-3090-434e-bae6-321c984029fa.png)
...
2. Under Section, choose **system.webServer/serverRuntime**.
     ...
     ![Deploy Call Quality Dashboard](images/b0af0e56-21b0-45dd-b610-5381b39319d3.png)
...
3. Change authenticatedUserOverride to **UseWorkerProcessUser**.
     ...
     ![Deploy Call Quality Dashboard - Configuration Editor](images/a7c127f5-9a90-4710-afba-1d1e588efb37.png)
...
1. Open up IIS Manager, and navigate to Default Web Site.
     ...
     ![Deploy Call Quality Dashboard](images/dc6007aa-870b-4d70-867d-32ffd937063b.png)
...
2. Click on "Authentication". If the "Anonymous Authentication", "ASP.NET Impersonation", "Form Authentication", and "Windows Authentication" do not match the settings shown below, manually change them to match the settings below. All other authentication mechanisms should be disabled.
     ...
     ![Deploy Call Quality Dashboard](images/5d9e38fb-8a50-41a2-a423-3ce983a83d0c.png)
...
3. For "Windows Authentication", click on Advanced Settings on the right-hand side.
     ...
     ![Deploy Call Quality Dashboard](images/cad29486-df40-4cc9-82f3-bbdaca52d9ca.png)
...
4. Set "Extended Protection" to Accept and check the "Enable Kernel-mode authentication" box.
     ...
     ![Deploy Call Quality Dashboard](images/0ab2dda1-0001-4747-8cfc-072e9368b6cb.png)
