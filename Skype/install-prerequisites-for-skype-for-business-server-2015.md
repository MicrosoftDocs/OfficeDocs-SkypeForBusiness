...
![Overview diagram - install prerequisites.](images/0a85349b-b398-4e04-8901-8f4bd25d8afe.png)
...
Skype for Business Server 2015 requires the Windows Server operating system and a number of prerequisites before it can be installed. For details on planning for prerequisites, see  [Server requirements for Skype for Business Server 2015](server-requirements-for-skype-for-business-server-2015.md). 
...
6. Select the following features, which are required by Skype for Business Server 2015.
