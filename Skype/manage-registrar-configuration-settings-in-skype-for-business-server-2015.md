...
You can use the Registrar to configure proxy server authentication protocols. For information about the available protocols, see  [Manage Registrar configuration settings in Skype for Business Server 2015](manage-registrar-configuration-settings-in-skype-for-business-server-2015.md).
