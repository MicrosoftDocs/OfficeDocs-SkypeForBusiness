...
| _VoiceRoutingPolicy_ <br/> |Optional  <br/> |System.String  <br/> |Per-user voice routing policy to be assigned to the site. For example:  <br/>  `-VoiceRoutingPolicy "RedmondVoiceRouting"` <br/> Note that you must specify a per-user policy; global and/or site policies cannot be assigned to a site using the VoiceRoutingPolicy parameter.  <br/> This parameter was introduced in the February, 2013 release of Lync Server 2013.  <br/> |
