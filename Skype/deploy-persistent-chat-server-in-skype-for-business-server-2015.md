...
|**Create a Persistent Chat administrator** <br/> |Add users to the CsPersistentChatAdministrator security group.  <br/> |Any user who is a member of domain administrators.  <br/> | [Create a Persistent Chat administrator in Skype for Business Server 2015](create-a-persistent-chat-administrator-in-skype-for-business-server-2015.md) <br/> |
