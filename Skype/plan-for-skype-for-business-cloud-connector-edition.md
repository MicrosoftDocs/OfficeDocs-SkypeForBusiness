...
Cloud Connector Edition 2.0.1 is now available. If you have not yet upgraded to 2.0.1, see  [Upgrade to a new version of Cloud Connector](upgrade-to-a-new-version-of-cloud-connector.md). You can find the installation file at  [https://aka.ms/CloudConnectorInstaller](https://aka.ms/CloudConnectorInstaller). 
...
> [!NOTE]
> Microsoft supports the previous version of Cloud Connector Edition for 60 days after the release of a new version. Microsoft will support version 1.4.2 for 60 days after the release of 2.0.1 to allow you time to upgrade. All versions previous to 1.4.2 are no longer supported. 
...
Because Cloud Connector enables you to integrate Microsoft Cloud PBX services with your existing telephony environment—for example, PBX, analog devices, and Call Centers—you can implement a phased migration from your existing telephony solution to Microsoft Cloud PBX. For example, assume your company has a sophisticated Call Center with specific functionality that Microsoft Cloud PBX does not provide. You can choose to leave Call Center users with the existing solution, but move other users to Cloud PBX. Cloud Connector will provide routing between the users homed on premises and online, and you can choose to use your own PSTN provider with Cloud PBX.Consider the following when planning your Cloud Connector Edition deployment: 
...
-  [Cloud Connector Edition components](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Components)
    
  
-  [Cloud Connector Edition topologies](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Topologies)
    
  
-  [Requirements for deployment](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Requirements)
    
  
-  [Information you need to gather before deployment](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_PlanDeployment)
    
  
-  [Dial plan considerations](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_DailPlan)
    
  
-  [High availability considerations](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_HA)
    
  
-  [Cloud Connector media flow](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_MediaFlow)
    
  
-  [Monitoring and troubleshooting](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Monitor)
    
  
-  [What's new in release 1.4.2](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_WhatsNew)
    
  
-  [What's new in release 2.0](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_New2.0)
    
  
-  [For more information](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_MoreInfo)
...
![Cloud Connector Edition components](images/f2d4b8a7-c2f4-4cfc-8137-f187399c1298.png)
...
![One Cloud Connector with One PSTN Site](images/7ffe6953-8c66-4323-940e-cd2e6c3c2a66.png)
...
![Two Cloud Connectors within 1 PSTN Site](images/fc0dc47f-5595-42cb-9432-9c8ff3e134e9.png)
...
![Cloud Connector Edition Within 2 PSTN Sites](images/16ead6d3-67da-4e71-b4d5-d895b4c9384e.png)
...
- Create names for all the components in each Cloud Connector appliance (see  [Determine deployment parameters](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_SiteParams)).
    
  
- Define port ranges (see  [Ports and protocols](plan-for-skype-for-business-cloud-connector-edition.md#BKMB_Ports)). 
    
  
- Create external DNS records for the Edge component (see  [Requirements for deployment](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Requirements)).
    
  
- Determine your certificate requirements for Edge component (see  [Certificate requirements](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Certs)).
...
For security purposes, you can limit the port range for the Mediation component by using the  [Set-CsMediationServer](set-csmediationserver.md) cmdlet.
...
To retrieve the name of the Mediation component and see default ports, you can use the  [Get-CsService](get-csservice.md) cmdlet as follows:
...
|Cloud Connector Edge External Interface  <br/> |Any  <br/> |Any  <br/> |TCP(MTLS) 506  <br/> |
...
![Outbound Media flow for Cloud Connector](images/c495a2bb-305c-46ef-b16d-b8f9f2b937a8.png)
...
![Inbound Media Flow for Cloud Connector](images/ba5da6f6-e357-43c6-9e8f-4bfdde97c176.png)
...
- In addition to changes to the Set-CcExternalFilePath cmdlet, several new cmdlets are provided in release 1.4.2: 
  ...
  - The Reset-CcCACertificate cmdlet resets the Cloud Connector Root CA Certificate which will remove the old certificate and replace with a new certificate.
    ...
    For more information, see  [Cloud Connector cmdlet reference](cloud-connector-cmdlet-reference.md).
...
<a name="BKMK_New2.0"> </a>

Cloud Connector Edition 2.0 and later includes the following new features and updates:
  
    
    

- **Media bypass.** Allows a client to send media directly to the Public Switched Telephone Network (PSTN) next hop—a gateway or Session Border Controller (SBC)—and eliminate the Cloud Connector Edition component from the media path. Media bypass can improve voice quality, and might also reduce the amount of hardware an infrastructure requires. For more information, see Plan for media bypass.
    
  
- **Support for increased number of Cloud Connecter appliances.** Cloud Connector Edition now supports up to 16 Cloud Connector appliances within a single PSTN site. For more information, see [Cloud Connector Edition topologies](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Topologies).
    
  
- **Ability to manipulate SIP headers.** Useful for billing or interoperability purposes.
    
  
- **Access requirements for management tasks.** Based on customer feedback, any account with a Skype for Business administrator role can perform Cloud Connector management tasks. This allows larger organizations with several administrators to easily administer the system while keeping strict rules on access rights. Previously, a Global Administrator account was required.
    
  
- **Increased ability to identify Cloud Connector calls in Call Quality Dashboard.** A hybrid voice flag in the Mediation Service User Agent enables easier identification of Cloud Connector calls in Call Quality Dashboard.
    
  
- **SSL 3.0 disabled by default.** SSL 3.0 is disabled by default for all services used by Cloud Connector Edition per the following security advisory: [Microsoft Security Advisory 3009008](https://technet.microsoft.com/library/security/3009008).
    
  
- **Monitoring and troubleshooting improvements**. Cloud Connector now monitors and reports on several additional events. For more information, see [Monitoring and troubleshooting](plan-for-skype-for-business-cloud-connector-edition.md#BKMK_Monitor).
...
-  [Plan your Cloud PBX solution in Skype for Business](plan-your-cloud-pbx-solution-in-skype-for-business.md)
    
  
-  [Configure Skype for Business Cloud Connector Edition](configure-skype-for-business-cloud-connector-edition.md)
    
  
-  [Plan for media bypass in Cloud Connector Edition](plan-for-media-bypass-in-cloud-connector-edition.md)
    
  
-  [Deploy media bypass in Cloud Connector Edition](deploy-media-bypass-in-cloud-connector-edition.md)
