...
Introduced in  [Centralized Logging Service in Skype for Business 2015](centralized-logging-service-in-skype-for-business-2015.md), the key elements of defining a provider for use in a scenario are:
