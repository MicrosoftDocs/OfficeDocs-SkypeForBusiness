...
Identify and  [Configure the Primary Management Server](configure-the-primary-management-server.md). To do this, you must install System Center Operations Manager 2012 SP1 or R2. 
  
    
    
 Identify and [Configure the Skype for Business Server computers that will be monitored](configure-the-skype-for-business-server-computers-that-will-be-monitored.md). To monitor a Skype for Business Server computer by using System Center Operations Manager, you must install the System Center Operations Manager agent files, and configure each server to act as a proxy. 
  
    
    
 Identify and [Install and configure watcher nodes](install-and-configure-watcher-nodes.md). Watcher nodes are computers that periodically run Skype for Business Server synthetic transactions—Windows PowerShell cmdlets that verify that key Skype for Business Server components, such as the ability to log on to the system or the ability to exchange instant messages, are working as expected. 
...
|**Supported Synthetic Transactions for Peer-to-Peer Services** <br/> |
...
|**Supported Synthetic Transactions for Conferencing and Persistent Chat** <br/> |
...
|**Supported Synthetic Transactions for Network and Partner Dependencies** <br/> |
...
![SCOM Rollup](images/de16195d-3aed-412e-9def-07a481d2ff0f.png)
...
![SCOM Rollup consecutive polling](images/655de542-cca7-4eda-8052-9a7703ecd0e9.png)
...
#### 
 ...
 [Skype for Business Server 2015 Management Tools](skype-for-business-server-2015-management-tools.md)
