...
|:-----|:-----|
|You need to get user numbers that aren't listed in the Skype for Business admin center.  <br/> |Download the [New phone number request for the U.S.](../../downloads/new-number-request-forms/new-phone-number-request-for-the-u.s.-(user-numbers)-(v.3)-(en.us).pdf) form, fill it out and [send it to us](mailto:gcstnmsd@microsoft.com).  <br/> |
