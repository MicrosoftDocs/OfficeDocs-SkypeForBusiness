...
|User (subscriber) number  <br/> |The number of phone numbers is equal to the total number of **Domestic Calling Plan** and/or **International Calling Plan** licenses multiplied by 1.1 + 10 additional phone numbers. <br/> |If I have 50 users in total with either a Domestic Calling Plan and/or International Calling Plan, you can acquire **65** phone number **(50 x 1.1 + 10)**. <br/> |
