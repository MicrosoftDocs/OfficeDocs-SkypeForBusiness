...
For details about moving the Central Management Server store, see  [Move-CsManagementServer](move-csmanagementserver.md) in the Windows PowerShell cmdlet reference.
