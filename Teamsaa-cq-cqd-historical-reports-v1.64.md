...
> [!IMPORTANT]
> Public cloud support for the V1.6x templates ended on November 25, 2022.
>
...
3. Navigate to the AACQ sub-directory.

4. Open the `CQD Teams Auto Attendant & Call Queue Historical Report V1.63.pbit` template file. Power BI Desktop should launch.
...
8. Update the template to use one of the following connectors:
