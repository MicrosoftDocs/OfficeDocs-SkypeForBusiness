...
ms:mtpsurl: https://technet.microsoft.com/library/JJ205323(v=OCS.15)
...
_**Topic Last Modified:** 2019-01-17_
...
The meeting moderator can use the following presenter functionalities of Lync Server 2013 clients to manage the large meeting:

- Change meeting access types.

- Invite additional participants during the meeting using Lync drag and drop functionality, phone dial out, or email.

- Manage meeting content, including uploading content, deleting content, and switching active content.
