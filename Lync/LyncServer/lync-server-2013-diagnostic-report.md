...
description: "Lync Server 2013: Diagnostic Report."
ms.reviewer: 
ms.author: v-lanac
author: lanachin
f1.keywords:
...
A list of diagnostic errors can be found on the [Ms-Diagnostics Header page](https://msdn.microsoft.com/library/gg132446\(v=office.12\).aspx).
