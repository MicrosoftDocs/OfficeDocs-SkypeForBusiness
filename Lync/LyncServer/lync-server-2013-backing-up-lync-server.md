---
title: 'Lync Server 2013: Backing up Lync Server'
ms.reviewer: 
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms:mtpsurl: https://technet.microsoft.com/library/Hh202182(v=OCS.15)
...
## In This Section
  ...
  - [Verifying backup prerequisites in Lync Server 2013](lync-server-2013-verifying-backup-prerequisites.md)
